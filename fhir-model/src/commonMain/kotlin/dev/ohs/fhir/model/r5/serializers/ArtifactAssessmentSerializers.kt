...
internal object ArtifactAssessmentCiteAsSerializer : KSerializer<ArtifactAssessment.CiteAs> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ArtifactAssessment.CiteAs") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ArtifactAssessment.CiteAs {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ArtifactAssessment.CiteAs: " + __i
          )
      }
    }
    return ArtifactAssessment.CiteAs.from(
      citeAsReference,
...
internal object ArtifactAssessmentArtifactSerializer : KSerializer<ArtifactAssessment.Artifact> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ArtifactAssessment.Artifact") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is ArtifactAssessment.Artifact.Reference -> {
          encodeSerializableElement(__desc, 0, Hoisted.artifactReferenceSer, __d.value)
        }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ArtifactAssessment.Artifact {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          artifactReference =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.artifactReferenceSer, null)
        1 -> artifactCanonical = decoder.decodeStringElement(__desc, 1)
        2 ->
          _artifactCanonical =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.elementSer, null)
        3 -> artifactUri = decoder.decodeStringElement(__desc, 3)
        4 ->
          _artifactUri =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ArtifactAssessment.Artifact: " + __i
          )
      }
    }
    return ArtifactAssessment.Artifact.from(
      artifactReference,
  ...
  private object Hoisted {
    public val artifactReferenceSer: KSerializer<Reference> = Reference.serializer()
