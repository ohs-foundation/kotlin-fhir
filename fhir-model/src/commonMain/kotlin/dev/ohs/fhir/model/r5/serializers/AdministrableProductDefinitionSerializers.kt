  ...
  private fun deserializeJson(decoder: CompositeDecoder): AdministrableProductDefinition.Property {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        14 -> status = decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.typeSer, null)
...
internal object AdministrableProductDefinitionPropertyValueSerializer :
  KSerializer<AdministrableProductDefinition.Property.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("AdministrableProductDefinition.Property.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("valueDate", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueDate", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: AdministrableProductDefinition.Property.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is AdministrableProductDefinition.Property.Value.Attachment -> {
          encodeSerializableElement(__desc, 8, Hoisted.valueAttachmentSer, __d.value)
        }
        is AdministrableProductDefinition.Property.Value.Reference -> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        6 -> valueMarkdown = decoder.decodeStringElement(__desc, 6)
        7 ->
          _valueMarkdown =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.elementSer, null)
        8 ->
          valueAttachment =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.valueAttachmentSer, null)
        9 ->
          valueReference =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding AdministrableProductDefinition.Property.Value: " + __i
          )
      }
    }
    return AdministrableProductDefinition.Property.Value.from(
      valueCodeableConcept,
      valueQuantity,
      Date.of(FhirDate.fromString(valueDate), _valueDate),
      R5Boolean.of(valueBoolean, _valueBoolean),
...
internal object AdministrableProductDefinitionSerializer :
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): AdministrableProductDefinition {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        22 ->
          `property` =
            decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.propertySer, null)
        23 ->
          routeOfAdministration =
            decoder.decodeNullableSerializableElement(
              __desc,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: AdministrableProductDefinition) {
    ...
    if (value.`property`.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 22, Hoisted.propertySer, value.`property`)
