...
internal object ExplanationOfBenefitEventWhenSerializer :
  KSerializer<ExplanationOfBenefit.Event.When> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.Event.When") {
      element("whenDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_whenDateTime", Element.serializer().descriptor, isOptional = true)
      element("whenPeriod", Period.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ExplanationOfBenefit.Event.When {
    val __desc = descriptor
    var whenDateTime: KotlinString? = null
    var _whenDateTime: Element? = null
    var whenPeriod: Period? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.Event.When: " + __i
          )
      }
    }
    return ExplanationOfBenefit.Event.When.from(
      DateTime.of(FhirDateTime.fromString(whenDateTime), _whenDateTime),
      whenPeriod,
    )!!
  }
...
internal object ExplanationOfBenefitSupportingInfoTimingSerializer :
  KSerializer<ExplanationOfBenefit.SupportingInfo.Timing> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.SupportingInfo.Timing") {
      element("timingDate", KotlinString.serializer().descriptor, isOptional = true)
      element("_timingDate", Element.serializer().descriptor, isOptional = true)
      element("timingPeriod", Period.serializer().descriptor, isOptional = true)
    }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.SupportingInfo.Timing: " + __i
          )
      }
    }
    return ExplanationOfBenefit.SupportingInfo.Timing.from(
      Date.of(FhirDate.fromString(timingDate), _timingDate),
      timingPeriod,
    )!!
  }
...
internal object ExplanationOfBenefitSupportingInfoValueSerializer :
  KSerializer<ExplanationOfBenefit.SupportingInfo.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.SupportingInfo.Value") {
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueString", Element.serializer().descriptor, isOptional = true)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.SupportingInfo.Value: " + __i
          )
      }
    }
    return ExplanationOfBenefit.SupportingInfo.Value.from(
      R5Boolean.of(valueBoolean, _valueBoolean),
      R5String.of(valueString, _valueString),
      valueQuantity,
      valueAttachment,
...
internal object ExplanationOfBenefitDiagnosisDiagnosisSerializer :
  KSerializer<ExplanationOfBenefit.Diagnosis.Diagnosis> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.Diagnosis.Diagnosis") {
      element(
        "diagnosisCodeableConcept",
        CodeableConcept.serializer().descriptor,
        isOptional = true,
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.Diagnosis.Diagnosis: " + __i
          )
      }
    }
    return ExplanationOfBenefit.Diagnosis.Diagnosis.from(
      diagnosisCodeableConcept,
      diagnosisReference,
    )!!
  }
...
internal object ExplanationOfBenefitProcedureProcedureSerializer :
  KSerializer<ExplanationOfBenefit.Procedure.Procedure> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.Procedure.Procedure") {
      element(
        "procedureCodeableConcept",
        CodeableConcept.serializer().descriptor,
        isOptional = true,
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.Procedure.Procedure: " + __i
          )
      }
    }
    return ExplanationOfBenefit.Procedure.Procedure.from(
      procedureCodeableConcept,
      procedureReference,
    )!!
  }
...
internal object ExplanationOfBenefitAccidentLocationSerializer :
  KSerializer<ExplanationOfBenefit.Accident.Location> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.Accident.Location") {
      element("locationAddress", Address.serializer().descriptor, isOptional = true)
      element("locationReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ExplanationOfBenefit.Accident.Location {
    val __desc = descriptor
    var locationAddress: Address? = null
    var locationReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.Accident.Location: " + __i
          )
      }
    }
    return ExplanationOfBenefit.Accident.Location.from(locationAddress, locationReference)!!
  }
...
internal object ExplanationOfBenefitItemServicedSerializer :
  KSerializer<ExplanationOfBenefit.Item.Serviced> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.Item.Serviced") {
      element("servicedDate", KotlinString.serializer().descriptor, isOptional = true)
      element("_servicedDate", Element.serializer().descriptor, isOptional = true)
      element("servicedPeriod", Period.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ExplanationOfBenefit.Item.Serviced {
    val __desc = descriptor
    var servicedDate: KotlinString? = null
    var _servicedDate: Element? = null
    var servicedPeriod: Period? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.Item.Serviced: " + __i
          )
      }
    }
    return ExplanationOfBenefit.Item.Serviced.from(
      Date.of(FhirDate.fromString(servicedDate), _servicedDate),
      servicedPeriod,
    )!!
  }
...
internal object ExplanationOfBenefitItemLocationSerializer :
  KSerializer<ExplanationOfBenefit.Item.Location> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.Item.Location") {
      element("locationCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("locationAddress", Address.serializer().descriptor, isOptional = true)
      element("locationReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ExplanationOfBenefit.Item.Location {
    val __desc = descriptor
    var locationCodeableConcept: CodeableConcept? = null
    var locationAddress: Address? = null
    var locationReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.Item.Location: " + __i
          )
      }
    }
    return ExplanationOfBenefit.Item.Location.from(
      locationCodeableConcept,
      locationAddress,
      locationReference,
    )!!
...
internal object ExplanationOfBenefitAddItemServicedSerializer :
  KSerializer<ExplanationOfBenefit.AddItem.Serviced> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.AddItem.Serviced") {
      element("servicedDate", KotlinString.serializer().descriptor, isOptional = true)
      element("_servicedDate", Element.serializer().descriptor, isOptional = true)
      element("servicedPeriod", Period.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ExplanationOfBenefit.AddItem.Serviced {
    val __desc = descriptor
    var servicedDate: KotlinString? = null
    var _servicedDate: Element? = null
    var servicedPeriod: Period? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.AddItem.Serviced: " + __i
          )
      }
    }
    return ExplanationOfBenefit.AddItem.Serviced.from(
      Date.of(FhirDate.fromString(servicedDate), _servicedDate),
      servicedPeriod,
    )!!
  }
...
internal object ExplanationOfBenefitAddItemLocationSerializer :
  KSerializer<ExplanationOfBenefit.AddItem.Location> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.AddItem.Location") {
      element("locationCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("locationAddress", Address.serializer().descriptor, isOptional = true)
      element("locationReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ExplanationOfBenefit.AddItem.Location {
    val __desc = descriptor
    var locationCodeableConcept: CodeableConcept? = null
    var locationAddress: Address? = null
    var locationReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.AddItem.Location: " + __i
          )
      }
    }
    return ExplanationOfBenefit.AddItem.Location.from(
      locationCodeableConcept,
      locationAddress,
      locationReference,
    )!!
...
internal object ExplanationOfBenefitBenefitBalanceFinancialAllowedSerializer :
  KSerializer<ExplanationOfBenefit.BenefitBalance.Financial.Allowed> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.BenefitBalance.Financial.Allowed") {
      element("allowedUnsignedInt", Int.serializer().descriptor, isOptional = true)
      element("_allowedUnsignedInt", Element.serializer().descriptor, isOptional = true)
      element("allowedString", KotlinString.serializer().descriptor, isOptional = true)
      element("_allowedString", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ExplanationOfBenefit.BenefitBalance.Financial.Allowed.Money -> {
          encodeSerializableElement(__desc, 4, Hoisted.allowedMoneySer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> allowedUnsignedInt = decoder.decodeIntElement(__desc, 0)
        1 ->
          _allowedUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> allowedString = decoder.decodeStringElement(__desc, 2)
        3 ->
          _allowedString =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        4 ->
          allowedMoney =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.allowedMoneySer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.BenefitBalance.Financial.Allowed: " +
              __i
          )
      }
    }
    return ExplanationOfBenefit.BenefitBalance.Financial.Allowed.from(
      UnsignedInt.of(allowedUnsignedInt, _allowedUnsignedInt),
      R5String.of(allowedString, _allowedString),
      allowedMoney,
    )!!
...
internal object ExplanationOfBenefitBenefitBalanceFinancialUsedSerializer :
  KSerializer<ExplanationOfBenefit.BenefitBalance.Financial.Used> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExplanationOfBenefit.BenefitBalance.Financial.Used") {
      element("usedUnsignedInt", Int.serializer().descriptor, isOptional = true)
      element("_usedUnsignedInt", Element.serializer().descriptor, isOptional = true)
      element("usedMoney", Money.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ExplanationOfBenefit.BenefitBalance.Financial.Used.Money -> {
          encodeSerializableElement(__desc, 2, Hoisted.usedMoneySer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> usedUnsignedInt = decoder.decodeIntElement(__desc, 0)
        1 ->
          _usedUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
          usedMoney =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.usedMoneySer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding ExplanationOfBenefit.BenefitBalance.Financial.Used: " + __i
          )
      }
    }
    return ExplanationOfBenefit.BenefitBalance.Financial.Used.from(
      UnsignedInt.of(usedUnsignedInt, _usedUnsignedInt),
      usedMoney,
    )!!
  }
  ...
  private object Hoisted {
    ...
    public val usedMoneySer: KSerializer<Money> = Money.serializer()
  }
}
