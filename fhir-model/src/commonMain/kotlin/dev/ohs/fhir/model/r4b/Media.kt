...
public data class Media(
  ...
  public sealed interface Created {
    ...
    @JvmInline
    public value class DateTime(public val `value`: dev.ohs.fhir.model.r4b.DateTime) : Created

    @JvmInline
    public value class Period(public val `value`: dev.ohs.fhir.model.r4b.Period) : Created
