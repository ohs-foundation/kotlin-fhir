...
public sealed class HealthcareServiceSearchParam<T> : SearchParam {
  ...
  public data object Communication : HealthcareServiceSearchParam<Any>() {
    public override val paramName: String = "communication"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "HealthcareService.communication"
  ...
  public data object Eligibility : HealthcareServiceSearchParam<Any>() {
    public override val paramName: String = "eligibility"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "HealthcareService.eligibility.code"
  ...
  public data object OfferedIn : HealthcareServiceSearchParam<Any>() {
    public override val paramName: String = "offered-in"

    public override val type: SearchParamType = SearchParamType.fromCode("reference")

    public override val expression: String = "HealthcareService.offeredIn"
