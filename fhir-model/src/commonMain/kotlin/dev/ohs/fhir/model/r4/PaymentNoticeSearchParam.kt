...
public sealed class PaymentNoticeSearchParam<T> : SearchParam {
  ...
  public data object Identifier : PaymentNoticeSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
    ...
    public override fun extract(resource: PaymentNotice): List<dev.ohs.fhir.model.r4.Identifier> =
      resource.identifier
  }
