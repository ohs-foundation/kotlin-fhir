...
internal object NutritionProductCharacteristicValueSerializer :
  KSerializer<NutritionProduct.Characteristic.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("NutritionProduct.Characteristic.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueString", Element.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): NutritionProduct.Characteristic.Value {
    val __desc = descriptor
    var valueCodeableConcept: CodeableConcept? = null
    var valueString: KotlinString? = null
    var _valueString: Element? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding NutritionProduct.Characteristic.Value: " + __i
          )
      }
    }
    return NutritionProduct.Characteristic.Value.from(
      valueCodeableConcept,
      R5String.of(valueString, _valueString),
      valueQuantity,
      Base64Binary.of(valueBase64Binary, _valueBase64Binary),
...
internal object NutritionProductSerializer : KSerializer<NutritionProduct> {
    ...
    buildClassSerialDescriptor("NutritionProduct") {
      ...
      element(
        ...
        listSerialDescriptor(
          lazyDescriptor { NutritionProduct.Ingredient.serializer().descriptor }
        ),
        isOptional = true,
      )
      element(
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: NutritionProduct) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "NutritionProduct")
