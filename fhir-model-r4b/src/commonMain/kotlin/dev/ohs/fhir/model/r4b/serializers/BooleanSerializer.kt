...
internal object BooleanSerializer : KSerializer<R4bBoolean> {
  ...
  override fun serialize(encoder: Encoder, `value`: R4bBoolean) {
  ...
  override fun deserialize(decoder: Decoder): R4bBoolean =
    decoder.decodeStructure(descriptor) {
      ...
      R4bBoolean(id = id, extension = extension, `value` = `value`)
    }
}
