...
internal object BasicSerializer : KSerializer<Basic> {
  ...
  internal fun serializeJson(
    ...
    (value.subject)?.let {
      encoder.encodeSerializableElement(__desc, 12 + __off, Hoisted.subjectSer, it)
    }
...
internal object BasicPolymorphicSerializer : KSerializer<Basic> {
  ...
  override fun serialize(encoder: Encoder, `value`: Basic) {
    encoder.encodeStructure(descriptor) {
      BasicSerializer.serializeJson(this, descriptor, 0, value)
    }
  }

  override fun deserialize(decoder: Decoder): Basic =
    decoder.decodeStructure(descriptor) { BasicSerializer.deserializeJson(this, descriptor, 0) }
}
