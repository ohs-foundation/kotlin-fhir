  ...
  private fun deserializeJson(decoder: CompositeDecoder): Ingredient.Substance.Strength {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        7 -> textPresentation = decoder.decodeStringElement(__desc, 7)
        8 ->
          _textPresentation =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.textPresentationSer, null)
        9 ->
          concentrationRatio =
            decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.presentationRatioSer, null)
        10 ->
        ...
        13 -> textConcentration = decoder.decodeStringElement(__desc, 13)
        14 ->
          _textConcentration =
            decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.textPresentationSer, null)
        15 ->
          basis =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        16 -> measurementPoint = decoder.decodeStringElement(__desc, 16)
        17 ->
          _measurementPoint =
            decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.textPresentationSer, null)
        18 ->
          country = decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.countrySer, null)
        19 ->
          referenceStrength =
            decoder.decodeNullableSerializableElement(
              __desc,
  ...
  private fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        6 ->
          strengthQuantity =
            decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.strengthQuantitySer, null)
...
internal object IngredientSubstanceStrengthPresentationSerializer :
  KSerializer<Ingredient.Substance.Strength.Presentation> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Ingredient.Substance.Strength.Presentation") {
      element("presentationRatio", Ratio.serializer().descriptor, isOptional = true)
      element("presentationRatioRange", RatioRange.serializer().descriptor, isOptional = true)
      element(
        "presentationCodeableConcept",
  ...
  override fun serialize(encoder: Encoder, `value`: Ingredient.Substance.Strength.Presentation) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is Ingredient.Substance.Strength.Presentation.Ratio -> {
          encodeSerializableElement(__desc, 0, Hoisted.presentationRatioSer, __d.value)
        }
        is Ingredient.Substance.Strength.Presentation.RatioRange -> {
          encodeSerializableElement(__desc, 1, Hoisted.presentationRatioRangeSer, __d.value)
        }
        is Ingredient.Substance.Strength.Presentation.CodeableConcept -> {
          encodeSerializableElement(__desc, 2, Hoisted.presentationCodeableConceptSer, __d.value)
        }
        is Ingredient.Substance.Strength.Presentation.Quantity -> {
          encodeSerializableElement(__desc, 3, Hoisted.presentationQuantitySer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          presentationRatio =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.presentationRatioSer, null)
        1 ->
          presentationRatioRange =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Ingredient.Substance.Strength.Presentation: " + __i
          )
      }
    }
    return Ingredient.Substance.Strength.Presentation.from(
      presentationRatio,
      presentationRatioRange,
      presentationCodeableConcept,
      presentationQuantity,
...
internal object IngredientSubstanceStrengthConcentrationSerializer :
  KSerializer<Ingredient.Substance.Strength.Concentration> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Ingredient.Substance.Strength.Concentration") {
      element("concentrationRatio", Ratio.serializer().descriptor, isOptional = true)
      element("concentrationRatioRange", RatioRange.serializer().descriptor, isOptional = true)
      element(
        "concentrationCodeableConcept",
  ...
  override fun serialize(encoder: Encoder, `value`: Ingredient.Substance.Strength.Concentration) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is Ingredient.Substance.Strength.Concentration.Ratio -> {
          encodeSerializableElement(__desc, 0, Hoisted.concentrationRatioSer, __d.value)
        }
        is Ingredient.Substance.Strength.Concentration.RatioRange -> {
          encodeSerializableElement(__desc, 1, Hoisted.concentrationRatioRangeSer, __d.value)
        }
        is Ingredient.Substance.Strength.Concentration.CodeableConcept -> {
          encodeSerializableElement(__desc, 2, Hoisted.concentrationCodeableConceptSer, __d.value)
        }
        is Ingredient.Substance.Strength.Concentration.Quantity -> {
          encodeSerializableElement(__desc, 3, Hoisted.concentrationQuantitySer, __d.value)
        }
      }
    }
  }
        ...
        1 ->
          concentrationRatioRange =
            decoder.decodeNullableSerializableElement(
              __desc,
              1,
              Hoisted.concentrationRatioRangeSer,
              null,
            )
        2 ->
          concentrationCodeableConcept =
            decoder.decodeNullableSerializableElement(
              __desc,
              2,
              Hoisted.concentrationCodeableConceptSer,
              null,
            )
        3 ->
          concentrationQuantity =
            decoder.decodeNullableSerializableElement(
              __desc,
              3,
              Hoisted.concentrationQuantitySer,
              null,
            )
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding Ingredient.Substance.Strength.Concentration: " + __i
          )
      }
    }
    return Ingredient.Substance.Strength.Concentration.from(
      concentrationRatio,
      concentrationRatioRange,
      concentrationCodeableConcept,
      concentrationQuantity,
  ...
  private object Hoisted {
    public val concentrationRatioSer: KSerializer<Ratio> = Ratio.serializer()

    public val concentrationRatioRangeSer: KSerializer<RatioRange> = RatioRange.serializer()

    public val concentrationCodeableConceptSer: KSerializer<CodeableConcept> =
      CodeableConcept.serializer()

    public val concentrationQuantitySer: KSerializer<Quantity> = Quantity.serializer()
  }
}

internal object IngredientSubstanceStrengthReferenceStrengthStrengthSerializer :
  KSerializer<Ingredient.Substance.Strength.ReferenceStrength.Strength> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Ingredient.Substance.Strength.ReferenceStrength.Strength") {
      element("strengthRatio", Ratio.serializer().descriptor, isOptional = true)
      element("strengthRatioRange", RatioRange.serializer().descriptor, isOptional = true)
      element("strengthQuantity", Quantity.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is Ingredient.Substance.Strength.ReferenceStrength.Strength.RatioRange -> {
          encodeSerializableElement(__desc, 1, Hoisted.strengthRatioRangeSer, __d.value)
        }
        is Ingredient.Substance.Strength.ReferenceStrength.Strength.Quantity -> {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Ingredient.Substance.Strength.ReferenceStrength.Strength: " +
              __i
          )
      }
    }
    return Ingredient.Substance.Strength.ReferenceStrength.Strength.from(
      strengthRatio,
      strengthRatioRange,
      strengthQuantity,
    )!!
...
internal object IngredientSerializer : KSerializer<Ingredient> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Ingredient {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        17 -> group = decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.roleSer, null)
        18 -> allergenicIndicator = decoder.decodeBooleanElement(__desc, 18)
        19 ->
          _allergenicIndicator =
            decoder.decodeNullableSerializableElement(__desc, 19, Hoisted.implicitRulesSer, null)
        20 -> comment = decoder.decodeStringElement(__desc, 20)
        21 ->
          _comment =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.implicitRulesSer, null)
        22 ->
          manufacturer =
            decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.manufacturerSer, null)
        23 ->
          substance =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.substanceSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Ingredient) {
    ...
    (value.group)?.let { encoder.encodeSerializableElement(__desc, 17, Hoisted.roleSer, it) }
    ((value.allergenicIndicator?.value))?.let { encoder.encodeBooleanElement(__desc, 18, it) }
    (value.allergenicIndicator?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 19, Hoisted.implicitRulesSer, it)
    }
    ((value.comment?.value))?.let { encoder.encodeStringElement(__desc, 20, it) }
    (value.comment?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 21, Hoisted.implicitRulesSer, it)
    }
    if (value.manufacturer.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 22, Hoisted.manufacturerSer, value.manufacturer)
    (value.substance)?.let {
      encoder.encodeSerializableElement(__desc, 23, Hoisted.substanceSer, it)
    }
  }
