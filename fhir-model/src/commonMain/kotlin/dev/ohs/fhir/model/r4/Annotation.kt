...
public data class Annotation(
  ...
  public sealed interface Author {
    ...
    @JvmInline
    public value class Reference(public val `value`: dev.ohs.fhir.model.r4.Reference) : Author

    @JvmInline public value class String(public val `value`: dev.ohs.fhir.model.r4.String) : Author
