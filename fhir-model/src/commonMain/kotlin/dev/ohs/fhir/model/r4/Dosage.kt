...
import dev.ohs.fhir.model.r4.serializers.DosageAsNeededSerializer
import dev.ohs.fhir.model.r4.serializers.DosageDoseAndRateDoseSerializer
import dev.ohs.fhir.model.r4.serializers.DosageDoseAndRateRateSerializer
...
public data class Dosage(
  ...
  public data class DoseAndRate(
    ...
    public sealed interface Dose {
      ...
      public data class Range(public val `value`: dev.ohs.fhir.model.r4.Range) : Dose

      public data class Quantity(public val `value`: dev.ohs.fhir.model.r4.Quantity) : Dose
    ...
    public sealed interface Rate {
      ...
      public data class Range(public val `value`: dev.ohs.fhir.model.r4.Range) : Rate
