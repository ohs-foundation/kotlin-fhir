...
internal object QuestionnaireItemSerializer : KSerializer<Questionnaire.Item> {
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Questionnaire.Item {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        17 -> disabledDisplay = decoder.decodeStringElement(__desc, 17)
        18 ->
          _disabledDisplay =
            decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.linkIdSer, null)
        19 -> required = decoder.decodeBooleanElement(__desc, 19)
        20 ->
          _required = decoder.decodeNullableSerializableElement(__desc, 20, Hoisted.linkIdSer, null)
        21 -> repeats = decoder.decodeBooleanElement(__desc, 21)
        22 ->
          _repeats = decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.linkIdSer, null)
        23 -> readOnly = decoder.decodeBooleanElement(__desc, 23)
        24 ->
          _readOnly = decoder.decodeNullableSerializableElement(__desc, 24, Hoisted.linkIdSer, null)
        25 -> maxLength = decoder.decodeIntElement(__desc, 25)
        26 ->
          _maxLength =
            decoder.decodeNullableSerializableElement(__desc, 26, Hoisted.linkIdSer, null)
        27 -> answerConstraint = decoder.decodeStringElement(__desc, 27)
        28 ->
          _answerConstraint =
            decoder.decodeNullableSerializableElement(__desc, 28, Hoisted.linkIdSer, null)
        29 -> answerValueSet = decoder.decodeStringElement(__desc, 29)
        30 ->
          _answerValueSet =
            decoder.decodeNullableSerializableElement(__desc, 30, Hoisted.linkIdSer, null)
        31 ->
          answerOption =
            decoder.decodeNullableSerializableElement(__desc, 31, Hoisted.answerOptionSer, null)
        32 ->
          initial = decoder.decodeNullableSerializableElement(__desc, 32, Hoisted.initialSer, null)
        33 -> item = decoder.decodeNullableSerializableElement(__desc, 33, Hoisted.itemSer, null)
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Questionnaire.Item) {
    ...
    ((value.answerConstraint?.value?.getCode()))?.let {
      encoder.encodeStringElement(__desc, 27, it)
    }
    (value.answerConstraint?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 28, Hoisted.linkIdSer, it)
    }
    ((value.answerValueSet?.value))?.let { encoder.encodeStringElement(__desc, 29, it) }
    ...
    if (value.answerOption.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 31, Hoisted.answerOptionSer, value.answerOption)
    if (value.initial.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 32, Hoisted.initialSer, value.initial)
    if (value.item.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 33, Hoisted.itemSer, value.item)
  }
...
internal object QuestionnaireVersionAlgorithmSerializer :
  KSerializer<Questionnaire.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Questionnaire.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Questionnaire.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Questionnaire.VersionAlgorithm: " + __i
          )
      }
    }
    return Questionnaire.VersionAlgorithm.from(
...
internal object QuestionnaireSerializer : KSerializer<Questionnaire> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Questionnaire {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        23 ->
          derivedFrom =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.derivedFromSer, null)
        24 ->
          _derivedFrom =
            decoder.decodeNullableSerializableElement(__desc, 24, Hoisted.derivedFromSer2, null)
        ...
        29 ->
          subjectType =
            decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.derivedFromSer, null)
        30 ->
          _subjectType =
            decoder.decodeNullableSerializableElement(__desc, 30, Hoisted.derivedFromSer2, null)
        31 -> date = decoder.decodeStringElement(__desc, 31)
        32 ->
          _date =
            decoder.decodeNullableSerializableElement(__desc, 32, Hoisted.implicitRulesSer, null)
        33 -> publisher = decoder.decodeStringElement(__desc, 33)
        34 ->
          _publisher =
            decoder.decodeNullableSerializableElement(__desc, 34, Hoisted.implicitRulesSer, null)
        35 ->
          contact = decoder.decodeNullableSerializableElement(__desc, 35, Hoisted.contactSer, null)
        36 -> description = decoder.decodeStringElement(__desc, 36)
        37 ->
          _description =
            decoder.decodeNullableSerializableElement(__desc, 37, Hoisted.implicitRulesSer, null)
        38 ->
          useContext =
            decoder.decodeNullableSerializableElement(__desc, 38, Hoisted.useContextSer, null)
        39 ->
          jurisdiction =
            decoder.decodeNullableSerializableElement(__desc, 39, Hoisted.jurisdictionSer, null)
        40 -> purpose = decoder.decodeStringElement(__desc, 40)
        41 ->
          _purpose =
        ...
        44 -> copyrightLabel = decoder.decodeStringElement(__desc, 44)
        45 ->
          _copyrightLabel =
            decoder.decodeNullableSerializableElement(__desc, 45, Hoisted.implicitRulesSer, null)
        46 -> approvalDate = decoder.decodeStringElement(__desc, 46)
        47 ->
          _approvalDate =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.implicitRulesSer, null)
        48 -> lastReviewDate = decoder.decodeStringElement(__desc, 48)
        49 ->
          _lastReviewDate =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.implicitRulesSer, null)
        50 ->
          effectivePeriod =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.effectivePeriodSer, null)
        51 -> code = decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.codeSer, null)
        52 -> item = decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.itemSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Questionnaire) {
    ...
    (value.derivedFrom.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 23, Hoisted.derivedFromSer, it)
    }
    (value.derivedFrom.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 24, Hoisted.derivedFromSer2, it)
    }
    ...
    (value.subjectType.map { it.value?.getCode() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 29, Hoisted.derivedFromSer, it)
    }
    (value.subjectType.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 30, Hoisted.derivedFromSer2, it)
    }
    ((value.date?.value?.toString()))?.let { encoder.encodeStringElement(__desc, 31, it) }
    (value.date?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 32, Hoisted.implicitRulesSer, it)
    }
    ((value.publisher?.value))?.let { encoder.encodeStringElement(__desc, 33, it) }
    (value.publisher?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 34, Hoisted.implicitRulesSer, it)
    }
    if (value.contact.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 35, Hoisted.contactSer, value.contact)
    ((value.description?.value))?.let { encoder.encodeStringElement(__desc, 36, it) }
    (value.description?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 37, Hoisted.implicitRulesSer, it)
    }
    if (value.useContext.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 38, Hoisted.useContextSer, value.useContext)
    if (value.jurisdiction.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 39, Hoisted.jurisdictionSer, value.jurisdiction)
    ((value.purpose?.value))?.let { encoder.encodeStringElement(__desc, 40, it) }
    ...
    ((value.copyrightLabel?.value))?.let { encoder.encodeStringElement(__desc, 44, it) }
    (value.copyrightLabel?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 45, Hoisted.implicitRulesSer, it)
    }
    ((value.approvalDate?.value?.toString()))?.let { encoder.encodeStringElement(__desc, 46, it) }
    (value.approvalDate?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 47, Hoisted.implicitRulesSer, it)
    }
    ((value.lastReviewDate?.value?.toString()))?.let { encoder.encodeStringElement(__desc, 48, it) }
    (value.lastReviewDate?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 49, Hoisted.implicitRulesSer, it)
    }
    (value.effectivePeriod)?.let {
      encoder.encodeSerializableElement(__desc, 50, Hoisted.effectivePeriodSer, it)
    }
    if (value.code.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 51, Hoisted.codeSer, value.code)
    if (value.item.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 52, Hoisted.itemSer, value.item)
  }
