...
internal object ExampleScenarioVersionAlgorithmSerializer :
  KSerializer<ExampleScenario.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExampleScenario.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ExampleScenario.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExampleScenario.VersionAlgorithm: " + __i
          )
      }
    }
    return ExampleScenario.VersionAlgorithm.from(
...
internal object ExampleScenarioInstanceStructureProfileSerializer :
  KSerializer<ExampleScenario.Instance.StructureProfile> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ExampleScenario.Instance.StructureProfile") {
      element("structureProfileCanonical", KotlinString.serializer().descriptor, isOptional = true)
      element("_structureProfileCanonical", Element.serializer().descriptor, isOptional = true)
      element("structureProfileUri", KotlinString.serializer().descriptor, isOptional = true)
      element("_structureProfileUri", Element.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> structureProfileCanonical = decoder.decodeStringElement(__desc, 0)
        1 ->
          _structureProfileCanonical =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> structureProfileUri = decoder.decodeStringElement(__desc, 2)
        3 ->
          _structureProfileUri =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ExampleScenario.Instance.StructureProfile: " + __i
          )
      }
    }
    return ExampleScenario.Instance.StructureProfile.from(
      Canonical.of(structureProfileCanonical, _structureProfileCanonical),
      Uri.of(structureProfileUri, _structureProfileUri),
    )!!
  }
