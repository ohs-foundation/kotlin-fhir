...
public data class Annotation(
  ...
  public sealed interface Author {
    ...
    @JvmInline
    public value class Reference(public val `value`: dev.ohs.fhir.model.r4b.Reference) : Author

    @JvmInline
    public value class String(public val `value`: dev.ohs.fhir.model.r4b.String) : Author
