...
public object PractitionerSearchParam {
  ...
  public data object Address : SearchParam<Practitioner, dev.ohs.fhir.model.r4b.Address> {
    ...
    public override fun extract(resource: Practitioner): List<dev.ohs.fhir.model.r4b.Address> =
      resource.address
  }

  public data object AddressCity : SearchParam<Practitioner, R4bString> {
    ...
    public override fun extract(resource: Practitioner): List<R4bString> =
      resource.address.mapNotNull { it.city }
  }

  public data object AddressCountry : SearchParam<Practitioner, R4bString> {
  ...
  public data object AddressPostalcode : SearchParam<Practitioner, R4bString> {
  ...
  public data object AddressState : SearchParam<Practitioner, R4bString> {
  ...
  public data object Family : SearchParam<Practitioner, R4bString> {
  ...
  public data object Given : SearchParam<Practitioner, R4bString> {
  ...
  public data object Identifier : SearchParam<Practitioner, dev.ohs.fhir.model.r4b.Identifier> {
    ...
    public override fun extract(resource: Practitioner): List<dev.ohs.fhir.model.r4b.Identifier> =
      resource.identifier
  }
