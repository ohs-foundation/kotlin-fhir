  ...
  private fun deserializeJson(decoder: CompositeDecoder): ValueSet.Compose {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        9 ->
          `property` =
            decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.propertySer, null)
        10 ->
          _property =
            decoder.decodeNullableSerializableElement(__desc, 10, Hoisted.propertySer2, null)
  ...
  private fun deserializeJson(decoder: CompositeDecoder): ValueSet.Compose.Include {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        11 -> copyright = decoder.decodeStringElement(__desc, 11)
        12 ->
          _copyright =
            decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.systemSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun deserializeJson(decoder: CompositeDecoder): ValueSet.Expansion {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        5 -> next = decoder.decodeStringElement(__desc, 5)
        6 ->
          _next = decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.identifierSer, null)
        7 -> timestamp = decoder.decodeStringElement(__desc, 7)
        8 ->
          _timestamp =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.identifierSer, null)
        9 -> total = decoder.decodeIntElement(__desc, 9)
        10 ->
          _total =
            decoder.decodeNullableSerializableElement(__desc, 10, Hoisted.identifierSer, null)
        11 -> offset = decoder.decodeIntElement(__desc, 11)
        12 ->
          _offset =
            decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.identifierSer, null)
        13 ->
          parameter =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.parameterSer, null)
        14 ->
          `property` =
            decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.propertySer, null)
        15 ->
          contains =
            decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.containsSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun deserializeJson(decoder: CompositeDecoder): ValueSet.Expansion.Contains {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        16 ->
          `property` =
            decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.propertySer, null)
        17 ->
          contains =
            decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.containsSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun deserializeJson(decoder: CompositeDecoder): ValueSet.Expansion.Contains.Property {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        18 ->
          subProperty =
            decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.subPropertySer, null)
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Property: " + __i)
      }
    }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          modifierExtension =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.extensionSer, null)
        3 -> inclusionCriteria = decoder.decodeStringElement(__desc, 3)
        4 ->
          _inclusionCriteria =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.inclusionCriteriaSer, null)
        5 -> exclusionCriteria = decoder.decodeStringElement(__desc, 5)
        6 ->
          _exclusionCriteria =
            decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.inclusionCriteriaSer, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object ValueSetVersionAlgorithmSerializer : KSerializer<ValueSet.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ValueSet.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ValueSet.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ValueSet.VersionAlgorithm: " + __i
          )
      }
    }
    return ValueSet.VersionAlgorithm.from(
...
internal object ValueSetExpansionParameterValueSerializer :
  KSerializer<ValueSet.Expansion.Parameter.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ValueSet.Expansion.Parameter.Value") {
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueString", Element.serializer().descriptor, isOptional = true)
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: ValueSet.Expansion.Parameter.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ValueSet.Expansion.Parameter.Value.Decimal -> {
          ((__d.value.value))?.let {
            encodeSerializableElement(__desc, 6, BigDecimalSerializer, it)
          }
          (__d.value.toElement())?.let {
        ...
        is ValueSet.Expansion.Parameter.Value.Uri -> {
          ((__d.value.value))?.let { encodeStringElement(__desc, 8, it) }
          (__d.value.toElement())?.let {
            encodeSerializableElement(__desc, 9, Hoisted.elementSer, it)
          }
        }
        is ValueSet.Expansion.Parameter.Value.Code -> {
          ((__d.value.value))?.let { encodeStringElement(__desc, 10, it) }
          (__d.value.toElement())?.let {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ValueSet.Expansion.Parameter.Value {
    val __desc = descriptor
    var valueString: KotlinString? = null
    var _valueString: Element? = null
    var valueBoolean: KotlinBoolean? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        6 ->
          valueDecimal =
            decoder.decodeNullableSerializableElement(__desc, 6, BigDecimalSerializer, null)
        7 ->
          _valueDecimal =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.elementSer, null)
        8 -> valueUri = decoder.decodeStringElement(__desc, 8)
        9 ->
          _valueUri = decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.elementSer, null)
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ValueSet.Expansion.Parameter.Value: " + __i
          )
      }
    }
    return ValueSet.Expansion.Parameter.Value.from(
      R5String.of(valueString, _valueString),
      R5Boolean.of(valueBoolean, _valueBoolean),
      Integer.of(valueInteger, _valueInteger),
      Decimal.of(valueDecimal, _valueDecimal),
...
internal object ValueSetExpansionContainsPropertyValueSerializer :
  KSerializer<ValueSet.Expansion.Contains.Property.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ValueSet.Expansion.Contains.Property.Value") {
      element("valueCode", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueCode", Element.serializer().descriptor, isOptional = true)
      element("valueCoding", Coding.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: ValueSet.Expansion.Contains.Property.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ValueSet.Expansion.Contains.Property.Value.Coding -> {
          encodeSerializableElement(__desc, 2, Hoisted.valueCodingSer, __d.value)
        }
        is ValueSet.Expansion.Contains.Property.Value.String -> {
        ...
        is ValueSet.Expansion.Contains.Property.Value.Integer -> {
          ((__d.value.value))?.let { encodeIntElement(__desc, 5, it) }
          (__d.value.toElement())?.let {
            encodeSerializableElement(__desc, 6, Hoisted.elementSer, it)
          }
        }
        is ValueSet.Expansion.Contains.Property.Value.Boolean -> {
          ((__d.value.value))?.let { encodeBooleanElement(__desc, 7, it) }
          (__d.value.toElement())?.let {
            encodeSerializableElement(__desc, 8, Hoisted.elementSer, it)
          }
        }
        is ValueSet.Expansion.Contains.Property.Value.DateTime -> {
          ((__d.value.value?.toString()))?.let { encodeStringElement(__desc, 9, it) }
          (__d.value.toElement())?.let {
        ...
        is ValueSet.Expansion.Contains.Property.Value.Decimal -> {
          ((__d.value.value))?.let {
            encodeSerializableElement(__desc, 11, BigDecimalSerializer, it)
          }
          (__d.value.toElement())?.let {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> valueCode = decoder.decodeStringElement(__desc, 0)
        1 ->
          _valueCode =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
          valueCoding =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.valueCodingSer, null)
        3 -> valueString = decoder.decodeStringElement(__desc, 3)
        4 ->
          _valueString =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.elementSer, null)
        5 -> valueInteger = decoder.decodeIntElement(__desc, 5)
        6 ->
          _valueInteger =
        ...
        9 -> valueDateTime = decoder.decodeStringElement(__desc, 9)
        10 ->
          _valueDateTime =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ValueSet.Expansion.Contains.Property.Value: " + __i
          )
      }
    }
    return ValueSet.Expansion.Contains.Property.Value.from(
      Code.of(valueCode, _valueCode),
      valueCoding,
      R5String.of(valueString, _valueString),
      Integer.of(valueInteger, _valueInteger),
...
internal object ValueSetExpansionContainsPropertySubPropertyValueSerializer :
  KSerializer<ValueSet.Expansion.Contains.Property.SubProperty.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ValueSet.Expansion.Contains.Property.SubProperty.Value") {
      element("valueCode", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueCode", Element.serializer().descriptor, isOptional = true)
      element("valueCoding", Coding.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ValueSet.Expansion.Contains.Property.SubProperty.Value: " +
              __i
          )
      }
    }
    return ValueSet.Expansion.Contains.Property.SubProperty.Value.from(
      Code.of(valueCode, _valueCode),
      valueCoding,
      R5String.of(valueString, _valueString),
      Integer.of(valueInteger, _valueInteger),
...
internal object ValueSetSerializer : KSerializer<ValueSet> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ValueSet") {
      ...
      element("scope", lazyDescriptor { ValueSet.Scope.serializer().descriptor }, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ValueSet {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        36 -> immutable = decoder.decodeBooleanElement(__desc, 36)
        37 ->
          _immutable =
        ...
        55 ->
          compose = decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.composeSer, null)
        56 ->
          expansion =
            decoder.decodeNullableSerializableElement(__desc, 56, Hoisted.expansionSer, null)
        57 -> scope = decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.scopeSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: ValueSet) {
    ...
    ((value.immutable?.value))?.let { encoder.encodeBooleanElement(__desc, 36, it) }
    ...
    (value.compose)?.let { encoder.encodeSerializableElement(__desc, 55, Hoisted.composeSer, it) }
    (value.expansion)?.let {
      encoder.encodeSerializableElement(__desc, 56, Hoisted.expansionSer, it)
    }
    (value.scope)?.let { encoder.encodeSerializableElement(__desc, 57, Hoisted.scopeSer, it) }
  }
