...
internal object TestPlanVersionAlgorithmSerializer : KSerializer<TestPlan.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("TestPlan.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): TestPlan.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding TestPlan.VersionAlgorithm: " + __i
          )
      }
    }
    return TestPlan.VersionAlgorithm.from(
...
internal object TestPlanTestCaseTestRunScriptSourceSerializer :
  KSerializer<TestPlan.TestCase.TestRun.Script.Source> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("TestPlan.TestCase.TestRun.Script.Source") {
      element("sourceString", KotlinString.serializer().descriptor, isOptional = true)
      element("_sourceString", Element.serializer().descriptor, isOptional = true)
      element("sourceReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: TestPlan.TestCase.TestRun.Script.Source) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is TestPlan.TestCase.TestRun.Script.Source.Reference -> {
          encodeSerializableElement(__desc, 2, Hoisted.sourceReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): TestPlan.TestCase.TestRun.Script.Source {
    val __desc = descriptor
    var sourceString: KotlinString? = null
    var _sourceString: Element? = null
    var sourceReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          sourceReference =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.sourceReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding TestPlan.TestCase.TestRun.Script.Source: " + __i
          )
      }
    }
    return TestPlan.TestCase.TestRun.Script.Source.from(
      R5String.of(sourceString, _sourceString),
      sourceReference,
    )!!
  }
...
internal object TestPlanTestCaseTestDataSourceSerializer :
  KSerializer<TestPlan.TestCase.TestData.Source> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("TestPlan.TestCase.TestData.Source") {
      element("sourceString", KotlinString.serializer().descriptor, isOptional = true)
      element("_sourceString", Element.serializer().descriptor, isOptional = true)
      element("sourceReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): TestPlan.TestCase.TestData.Source {
    val __desc = descriptor
    var sourceString: KotlinString? = null
    var _sourceString: Element? = null
    var sourceReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding TestPlan.TestCase.TestData.Source: " + __i
          )
      }
    }
    return TestPlan.TestCase.TestData.Source.from(
      R5String.of(sourceString, _sourceString),
      sourceReference,
    )!!
  }
