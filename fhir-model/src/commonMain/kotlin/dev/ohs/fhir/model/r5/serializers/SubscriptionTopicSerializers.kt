  ...
  private fun deserializeJson(decoder: CompositeDecoder): SubscriptionTopic.CanFilterBy {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        11 ->
          comparator =
            decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.comparatorSer, null)
        12 ->
          _comparator =
            decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.comparatorSer2, null)
        13 ->
          modifier =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.comparatorSer, null)
        14 ->
          _modifier =
            decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.comparatorSer2, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object SubscriptionTopicVersionAlgorithmSerializer :
  KSerializer<SubscriptionTopic.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubscriptionTopic.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubscriptionTopic.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubscriptionTopic.VersionAlgorithm: " + __i
          )
      }
    }
    return SubscriptionTopic.VersionAlgorithm.from(
...
internal object SubscriptionTopicSerializer : KSerializer<SubscriptionTopic> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubscriptionTopic {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        49 ->
          resourceTrigger =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.resourceTriggerSer, null)
        50 ->
          eventTrigger =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.eventTriggerSer, null)
        51 ->
          canFilterBy =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.canFilterBySer, null)
        52 ->
          notificationShape =
            decoder.decodeNullableSerializableElement(
              __desc,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: SubscriptionTopic) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "SubscriptionTopic")
    ...
    if (value.eventTrigger.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 50, Hoisted.eventTriggerSer, value.eventTrigger)
    if (value.canFilterBy.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 51, Hoisted.canFilterBySer, value.canFilterBy)
