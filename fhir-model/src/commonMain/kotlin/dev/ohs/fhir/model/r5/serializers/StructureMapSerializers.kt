...
internal object StructureMapVersionAlgorithmSerializer :
  KSerializer<StructureMap.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("StructureMap.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): StructureMap.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding StructureMap.VersionAlgorithm: " + __i
          )
      }
    }
    return StructureMap.VersionAlgorithm.from(
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is StructureMap.Group.Rule.Target.Parameter.Value.Time -> {
          ((__d.value.value))?.let {
            encodeSerializableElement(__desc, 12, LocalTimeSerializer, it)
          }
          (__d.value.toElement())?.let {
        ...
        is StructureMap.Group.Rule.Target.Parameter.Value.DateTime -> {
          ((__d.value.value?.toString()))?.let { encodeStringElement(__desc, 14, it) }
          (__d.value.toElement())?.let {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        12 ->
          valueTime =
            decoder.decodeNullableSerializableElement(__desc, 12, LocalTimeSerializer, null)
        13 ->
          _valueTime =
