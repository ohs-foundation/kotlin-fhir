...
internal object CitationRelatesToTargetSerializer : KSerializer<Citation.RelatesTo.Target> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Citation.RelatesTo.Target") {
      element("targetUri", KotlinString.serializer().descriptor, isOptional = true)
      element("_targetUri", Element.serializer().descriptor, isOptional = true)
      element("targetIdentifier", Identifier.serializer().descriptor, isOptional = true)
      element("targetReference", Reference.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: Citation.RelatesTo.Target) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is Citation.RelatesTo.Target.Identifier -> {
          encodeSerializableElement(__desc, 2, Hoisted.targetIdentifierSer, __d.value)
        }
        is Citation.RelatesTo.Target.Reference -> {
          encodeSerializableElement(__desc, 3, Hoisted.targetReferenceSer, __d.value)
        }
        is Citation.RelatesTo.Target.Attachment -> {
          encodeSerializableElement(__desc, 4, Hoisted.targetAttachmentSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Citation.RelatesTo.Target {
    val __desc = descriptor
    var targetUri: KotlinString? = null
    var _targetUri: Element? = null
    var targetIdentifier: Identifier? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> targetUri = decoder.decodeStringElement(__desc, 0)
        1 ->
          _targetUri =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
          targetIdentifier =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.targetIdentifierSer, null)
        3 ->
          targetReference =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.targetReferenceSer, null)
        4 ->
          targetAttachment =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.targetAttachmentSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding Citation.RelatesTo.Target: " + __i
          )
      }
    }
    return Citation.RelatesTo.Target.from(
      Uri.of(targetUri, _targetUri),
      targetIdentifier,
      targetReference,
      targetAttachment,
...
internal object CitationCitedArtifactRelatesToTargetSerializer :
  KSerializer<Citation.CitedArtifact.RelatesTo.Target> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Citation.CitedArtifact.RelatesTo.Target") {
      element("targetUri", KotlinString.serializer().descriptor, isOptional = true)
      element("_targetUri", Element.serializer().descriptor, isOptional = true)
      element("targetIdentifier", Identifier.serializer().descriptor, isOptional = true)
      element("targetReference", Reference.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Citation.CitedArtifact.RelatesTo.Target {
    val __desc = descriptor
    var targetUri: KotlinString? = null
    var _targetUri: Element? = null
    var targetIdentifier: Identifier? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Citation.CitedArtifact.RelatesTo.Target: " + __i
          )
      }
    }
    return Citation.CitedArtifact.RelatesTo.Target.from(
      Uri.of(targetUri, _targetUri),
      targetIdentifier,
      targetReference,
      targetAttachment,
