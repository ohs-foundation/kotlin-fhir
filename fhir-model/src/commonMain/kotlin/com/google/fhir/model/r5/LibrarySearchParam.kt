...
public sealed class LibrarySearchParam<T> : SearchParam {
  ...
  public data object Context : LibrarySearchParam<Any>() {
    ...
    public override val expression: String = "(Library.useContext.value.ofType(CodeableConcept))"
  ...
  public data object ContextQuantity : LibrarySearchParam<Any>() {
    ...
    public override val expression: String = "(Library.useContext.value.ofType(Quantity))"
