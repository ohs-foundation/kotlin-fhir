...
internal object GenomicStudyAnalysisInputGeneratedBySerializer :
  KSerializer<GenomicStudy.Analysis.Input.GeneratedBy> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("GenomicStudy.Analysis.Input.GeneratedBy") {
      element("generatedByIdentifier", Identifier.serializer().descriptor, isOptional = true)
      element("generatedByReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: GenomicStudy.Analysis.Input.GeneratedBy) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is GenomicStudy.Analysis.Input.GeneratedBy.Identifier -> {
          encodeSerializableElement(__desc, 0, Hoisted.generatedByIdentifierSer, __d.value)
        }
        is GenomicStudy.Analysis.Input.GeneratedBy.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.generatedByReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): GenomicStudy.Analysis.Input.GeneratedBy {
    val __desc = descriptor
    var generatedByIdentifier: Identifier? = null
    var generatedByReference: Reference? = null
    while (true) {
        ...
        1 ->
          generatedByReference =
            decoder.decodeNullableSerializableElement(
              __desc,
              1,
              Hoisted.generatedByReferenceSer,
              null,
            )
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding GenomicStudy.Analysis.Input.GeneratedBy: " + __i
          )
      }
    }
    return GenomicStudy.Analysis.Input.GeneratedBy.from(
      generatedByIdentifier,
      generatedByReference,
    )!!
  }
  ...
  private object Hoisted {
    ...
    public val generatedByReferenceSer: KSerializer<Reference> = Reference.serializer()
  }
}
