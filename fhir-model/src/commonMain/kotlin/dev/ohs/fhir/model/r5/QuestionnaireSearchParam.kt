...
public sealed class QuestionnaireSearchParam<T> : SearchParam {
  ...
  public data object ComboCode : QuestionnaireSearchParam<Any>() {
    public override val paramName: String = "combo-code"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "Questionnaire.code"
  ...
  public data object ContextQuantity : QuestionnaireSearchParam<Any>() {
    ...
    public override val expression: String = "(Questionnaire.useContext.value.ofType(Quantity))"
  ...
  public data object ItemCode : QuestionnaireSearchParam<Any>() {
    public override val paramName: String = "item-code"
  ...
  public data object QuestionnaireCode : QuestionnaireSearchParam<Any>() {
    public override val paramName: String = "questionnaire-code"
