...
public object NamingSystemSearchParam {
  ...
  public data object Contact : SearchParam<NamingSystem, R4bString> {
  ...
  public data object Name : SearchParam<NamingSystem, R4bString> {
  ...
  public data object Period : SearchParam<NamingSystem, dev.ohs.fhir.model.r4b.Period> {
  ...
  public data object Publisher : SearchParam<NamingSystem, R4bString> {
  ...
  public data object Responsible : SearchParam<NamingSystem, R4bString> {
  ...
  public data object Value : SearchParam<NamingSystem, R4bString> {
