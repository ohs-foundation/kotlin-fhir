  ...
  private fun deserializeJson(decoder: CompositeDecoder): Medication.Ingredient {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 -> isActive = decoder.decodeBooleanElement(__desc, 4)
        5 ->
          _isActive =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.isActiveSer, null)
        6 ->
          strengthRatio =
            decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.strengthRatioSer, null)
        7 ->
        ...
        8 ->
          strengthQuantity =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.strengthQuantitySer, null)
...
internal object MedicationIngredientStrengthSerializer :
  KSerializer<Medication.Ingredient.Strength> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Medication.Ingredient.Strength") {
      element("strengthRatio", Ratio.serializer().descriptor, isOptional = true)
      element("strengthCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("strengthQuantity", Quantity.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Medication.Ingredient.Strength {
    val __desc = descriptor
    var strengthRatio: Ratio? = null
    var strengthCodeableConcept: CodeableConcept? = null
    var strengthQuantity: Quantity? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Medication.Ingredient.Strength: " + __i
          )
      }
    }
    return Medication.Ingredient.Strength.from(
      strengthRatio,
      strengthCodeableConcept,
      strengthQuantity,
    )!!
...
internal object MedicationSerializer : KSerializer<Medication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Medication") {
      ...
      element("marketingAuthorizationHolder", Reference.serializer().descriptor, isOptional = true)
      element("doseForm", CodeableConcept.serializer().descriptor, isOptional = true)
      element("totalVolume", Quantity.serializer().descriptor, isOptional = true)
      element(
        "ingredient",
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Medication {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        16 ->
          doseForm = decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.codeSer, null)
        17 ->
          totalVolume =
            decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.totalVolumeSer, null)
        18 ->
          ingredient =
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Medication) {
    ...
    (value.marketingAuthorizationHolder)?.let {
      encoder.encodeSerializableElement(__desc, 15, Hoisted.marketingAuthorizationHolderSer, it)
    }
    (value.doseForm)?.let { encoder.encodeSerializableElement(__desc, 16, Hoisted.codeSer, it) }
    (value.totalVolume)?.let {
      encoder.encodeSerializableElement(__desc, 17, Hoisted.totalVolumeSer, it)
    }
    ...
    (value.definition)?.let {
      encoder.encodeSerializableElement(__desc, 20, Hoisted.marketingAuthorizationHolderSer, it)
    }
  }
