...
public sealed class AccountSearchParam<T> : SearchParam {
  ...
  public data object Identifier : AccountSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
  ...
  public data object Name : AccountSearchParam<R4String>() {
  ...
  public data object Period : AccountSearchParam<dev.ohs.fhir.model.r4.Period>() {
