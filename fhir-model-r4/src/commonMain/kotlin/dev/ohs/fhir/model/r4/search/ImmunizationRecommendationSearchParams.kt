...
public object ImmunizationRecommendationSearchParams {
  ...
  public val support: SearchParam<ImmunizationRecommendation, Reference> =
    SearchParam(
      ...
      target = listOf(Immunization::class, ImmunizationEvaluation::class),
  ...
  /**
   * Supported search parameters for the ImmunizationRecommendation resource type. Iterating `all`
