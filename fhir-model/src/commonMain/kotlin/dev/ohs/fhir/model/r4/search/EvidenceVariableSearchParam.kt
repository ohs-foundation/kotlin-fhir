...
public object EvidenceVariableSearchParam {
  ...
  public data object ComposedOf : SearchParam<EvidenceVariable, Canonical> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<Canonical> =
  ...
  public data object Context : SearchParam<EvidenceVariable, CodeableConcept> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<CodeableConcept> =
  ...
  public data object ContextQuantity : SearchParam<EvidenceVariable, Quantity> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<Quantity> =
  ...
  public data object ContextType : SearchParam<EvidenceVariable, Coding> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<Coding> =
  ...
  public data object ContextTypeQuantity : SearchParam<EvidenceVariable, UsageContext> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<UsageContext> =
      resource.useContext
  }
  ...
  public data object Date : SearchParam<EvidenceVariable, DateTime> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<DateTime> =
  ...
  public data object Description : SearchParam<EvidenceVariable, Markdown> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<Markdown> =
  ...
  public data object Effective : SearchParam<EvidenceVariable, Period> {
    ...
    public override val expression: KotlinString = "EvidenceVariable.effectivePeriod"

    public override val target: CollectionsList<KClass<out Resource>> = emptyList()

    public override fun extract(resource: EvidenceVariable): CollectionsList<Period> =
  ...
  public data object Jurisdiction : SearchParam<EvidenceVariable, CodeableConcept> {
    ...
    public override val expression: KotlinString = "EvidenceVariable.jurisdiction"
  ...
  public data object Name : SearchParam<EvidenceVariable, R4String> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<R4String> =
  ...
  public data object Status : SearchParam<EvidenceVariable, Any> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<Any> =
  ...
  public data object Topic : SearchParam<EvidenceVariable, CodeableConcept> {
    ...
    public override val expression: KotlinString = "EvidenceVariable.topic"
  ...
  public data object Url : SearchParam<EvidenceVariable, Uri> {
    ...
    public override fun extract(resource: EvidenceVariable): CollectionsList<Uri> =
