...
public sealed class PersonSearchParam<T> : SearchParam {
  ...
  public data object Address : PersonSearchParam<dev.ohs.fhir.model.r4.Address>() {
  ...
  public data object AddressCity : PersonSearchParam<R4String>() {
  ...
  public data object AddressCountry : PersonSearchParam<R4String>() {
  ...
  public data object AddressPostalcode : PersonSearchParam<R4String>() {
  ...
  public data object AddressState : PersonSearchParam<R4String>() {
  ...
  public data object Identifier : PersonSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
