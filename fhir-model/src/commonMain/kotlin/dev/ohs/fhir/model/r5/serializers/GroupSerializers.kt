...
internal object GroupSerializer : KSerializer<Group> {
  ...
  internal fun serializeJson(encoder: CompositeEncoder, `value`: Group) {
    val __desc = descriptor
...
internal object GroupPolymorphicSerializer : KSerializer<Group> {
  ...
  override fun serialize(encoder: Encoder, `value`: Group) {
    encoder.encodeStructure(descriptor) { GroupSerializer.serializeJson(this, value) }
  }

  override fun deserialize(decoder: Decoder): Group =
    decoder.decodeStructure(descriptor) { GroupSerializer.deserializeJson(this) }
}
