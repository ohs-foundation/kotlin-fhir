...
internal object ListEntrySerializer : KSerializer<R4bList.Entry> {
  ...
  private fun deserializeJson(decoder: CompositeDecoder): R4bList.Entry {
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: R4bList.Entry) {
    val __desc = descriptor
...
internal object ListSerializer : KSerializer<R4bList> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): R4bList {
    val __desc = descriptor
    var id: KotlinString? = null
    var meta: Meta? = null
    ...
    return R4bList(
      ...
      status = Enumeration.of(R4bList.ListStatus.fromCode(status!!), _status),
      mode = Enumeration.of(R4bList.ListMode.fromCode(mode!!), _mode),
  ...
  internal fun serializeJson(encoder: CompositeEncoder, `value`: R4bList) {
    val __desc = descriptor
