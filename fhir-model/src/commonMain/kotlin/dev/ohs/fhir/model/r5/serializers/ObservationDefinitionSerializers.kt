...
internal object ObservationDefinitionVersionAlgorithmSerializer :
  KSerializer<ObservationDefinition.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ObservationDefinition.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ObservationDefinition.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ObservationDefinition.VersionAlgorithm: " + __i
          )
      }
    }
    return ObservationDefinition.VersionAlgorithm.from(
