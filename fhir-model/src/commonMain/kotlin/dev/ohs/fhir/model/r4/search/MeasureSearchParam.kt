...
public object MeasureSearchParam {
  ...
  public data object Name : SearchParam<Measure, R4String> {
    ...
    public override fun extract(resource: Measure): List<R4String> = listOfNotNull(resource.name)
  }
  ...
  public data object Publisher : SearchParam<Measure, R4String> {
    ...
    public override fun extract(resource: Measure): List<R4String> =
  ...
  public data object Title : SearchParam<Measure, R4String> {
    ...
    public override fun extract(resource: Measure): List<R4String> = listOfNotNull(resource.title)
  }
  ...
  public data object Version : SearchParam<Measure, R4String> {
    ...
    public override fun extract(resource: Measure): List<R4String> = listOfNotNull(resource.version)
  }
}
