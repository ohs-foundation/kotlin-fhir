...
public sealed class ConditionSearchParam<T> : SearchParam {
  ...
  public data object AbatementString : ConditionSearchParam<R4bString>() {
    ...
    public override fun extract(resource: Condition): List<R4bString> =
  ...
  public data object OnsetInfo : ConditionSearchParam<R4bString>() {
