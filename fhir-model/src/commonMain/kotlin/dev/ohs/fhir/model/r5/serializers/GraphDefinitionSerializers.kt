    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          modifierExtension =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.extensionSer, null)
        3 -> nodeId = decoder.decodeStringElement(__desc, __i)
        4 ->
          _nodeId = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.nodeIdSer, null)
        5 -> description = decoder.decodeStringElement(__desc, __i)
        6 ->
          _description =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.nodeIdSer, null)
        7 -> type = decoder.decodeStringElement(__desc, __i)
        8 -> _type = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.nodeIdSer, null)
        9 -> profile = decoder.decodeStringElement(__desc, __i)
        10 ->
          _profile = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.nodeIdSer, null)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        8 ->
          _max =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.descriptionSer, null)
        9 -> sourceId = decoder.decodeStringElement(__desc, __i)
        10 ->
          _sourceId =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.descriptionSer, null)
        11 -> path = decoder.decodeStringElement(__desc, __i)
        12 ->
          _path =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.descriptionSer, null)
        13 -> sliceName = decoder.decodeStringElement(__desc, __i)
        14 ->
          _sliceName =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.descriptionSer, null)
        15 -> targetId = decoder.decodeStringElement(__desc, __i)
        16 ->
          _targetId =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.descriptionSer, null)
        17 -> params = decoder.decodeStringElement(__desc, __i)
        18 ->
          _params =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.descriptionSer, null)
        19 ->
  ...
  private fun deserializeJson(decoder: CompositeDecoder): GraphDefinition.Link.Compartment {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        5 -> rule = decoder.decodeStringElement(__desc, __i)
        6 -> _rule = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.useSer, null)
        7 -> code = decoder.decodeStringElement(__desc, __i)
        8 -> _code = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.useSer, null)
...
internal object GraphDefinitionSerializer : KSerializer<GraphDefinition> {
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        40 ->
          _copyrightLabel =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        41 -> start = decoder.decodeStringElement(__desc, __i)
        42 ->
          _start =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        43 -> node = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.nodeSer, null)
        44 -> link = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.linkSer, null)
  ...
  internal fun serializeJson(
    ...
    ((value.start?.value))?.let { encoder.encodeStringElement(__desc, 41 + __off, it) }
    ...
    if (value.node.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 43 + __off, Hoisted.nodeSer, value.node)
    if (value.link.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 44 + __off, Hoisted.linkSer, value.link)
  }
