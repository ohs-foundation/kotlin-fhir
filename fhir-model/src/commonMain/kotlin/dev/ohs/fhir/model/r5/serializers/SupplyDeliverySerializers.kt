...
internal object SupplyDeliverySuppliedItemItemSerializer :
  KSerializer<SupplyDelivery.SuppliedItem.Item> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SupplyDelivery.SuppliedItem.Item") {
      element("itemCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("itemReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SupplyDelivery.SuppliedItem.Item {
    val __desc = descriptor
    var itemCodeableConcept: CodeableConcept? = null
    var itemReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SupplyDelivery.SuppliedItem.Item: " + __i
          )
      }
    }
    return SupplyDelivery.SuppliedItem.Item.from(itemCodeableConcept, itemReference)!!
  }
...
internal object SupplyDeliveryOccurrenceSerializer : KSerializer<SupplyDelivery.Occurrence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SupplyDelivery.Occurrence") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SupplyDelivery.Occurrence {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SupplyDelivery.Occurrence: " + __i
          )
      }
    }
    return SupplyDelivery.Occurrence.from(
...
internal object SupplyDeliverySerializer : KSerializer<SupplyDelivery> {
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: SupplyDelivery) {
    ...
    if (value.suppliedItem.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 18, Hoisted.suppliedItemSer, value.suppliedItem)
