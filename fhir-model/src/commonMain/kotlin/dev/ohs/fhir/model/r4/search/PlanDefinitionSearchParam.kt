...
public object PlanDefinitionSearchParam {
  ...
  public data object Identifier : SearchParam<PlanDefinition, dev.ohs.fhir.model.r4.Identifier> {
  ...
  public data object Name : SearchParam<PlanDefinition, R4String> {
    ...
    public override fun extract(resource: PlanDefinition): CollectionsList<R4String> =
  ...
  public data object Publisher : SearchParam<PlanDefinition, R4String> {
  ...
  public data object Title : SearchParam<PlanDefinition, R4String> {
  ...
  public data object Version : SearchParam<PlanDefinition, R4String> {
