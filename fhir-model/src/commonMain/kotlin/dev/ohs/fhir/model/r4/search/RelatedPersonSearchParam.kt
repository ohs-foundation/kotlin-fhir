...
public sealed class RelatedPersonSearchParam<T> : SearchParam {
  ...
  public data object Address : RelatedPersonSearchParam<dev.ohs.fhir.model.r4.Address>() {
  ...
  public data object AddressCity : RelatedPersonSearchParam<R4String>() {
  ...
  public data object AddressCountry : RelatedPersonSearchParam<R4String>() {
  ...
  public data object AddressPostalcode : RelatedPersonSearchParam<R4String>() {
  ...
  public data object AddressState : RelatedPersonSearchParam<R4String>() {
  ...
  public data object Identifier : RelatedPersonSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
