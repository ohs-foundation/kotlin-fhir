...
internal object BooleanSerializer : KSerializer<R4Boolean> {
  ...
  override fun serialize(encoder: Encoder, `value`: R4Boolean) {
  ...
  override fun deserialize(decoder: Decoder): R4Boolean =
    decoder.decodeStructure(descriptor) {
      ...
      R4Boolean(id = id, extension = extension, `value` = `value`)
    }
}
