...
internal object SubstanceAmountAmountSerializer : KSerializer<SubstanceAmount.Amount> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceAmount.Amount") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubstanceAmount.Amount {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding SubstanceAmount.Amount: " + __i)
      }
    }
    return SubstanceAmount.Amount.from(
      amountQuantity,
      amountRange,
