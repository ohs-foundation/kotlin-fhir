...
internal object ResearchStudySerializer : KSerializer<ResearchStudy> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ResearchStudy") {
      ...
      element("descriptionSummary", KotlinString.serializer().descriptor, isOptional = true)
      element("_descriptionSummary", Element.serializer().descriptor, isOptional = true)
      element("description", KotlinString.serializer().descriptor, isOptional = true)
      element("_description", Element.serializer().descriptor, isOptional = true)
      element("period", Period.serializer().descriptor, isOptional = true)
      ...
      element(
        "progressStatus",
        listSerialDescriptor(
          lazyDescriptor { ResearchStudy.ProgressStatus.serializer().descriptor }
        ),
        isOptional = true,
      )
      element("whyStopped", CodeableConcept.serializer().descriptor, isOptional = true)
      element(
        "recruitment",
      ...
      element(
        "outcomeMeasure",
        listSerialDescriptor(
          lazyDescriptor { ResearchStudy.OutcomeMeasure.serializer().descriptor }
        ),
        isOptional = true,
      )
