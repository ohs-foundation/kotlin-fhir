  ...
  private fun deserializeJson(decoder: CompositeDecoder): CapabilityStatement.Rest.Resource {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        24 -> conditionalDelete = decoder.decodeStringElement(__desc, 24)
        25 ->
          _conditionalDelete =
            decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.typeSer, null)
        26 ->
          referencePolicy =
            decoder.decodeNullableSerializableElement(__desc, 26, Hoisted.supportedProfileSer, null)
        27 ->
          _referencePolicy =
        ...
        32 ->
          searchParam =
            decoder.decodeNullableSerializableElement(__desc, 32, Hoisted.searchParamSer, null)
        33 ->
          operation =
            decoder.decodeNullableSerializableElement(__desc, 33, Hoisted.operationSer, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object CapabilityStatementSerializer : KSerializer<CapabilityStatement> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CapabilityStatement") {
      ...
      element("_imports", listSerialDescriptor(Element.serializer().descriptor), isOptional = true)
      element(
        "software",
      ...
      element("_format", listSerialDescriptor(Element.serializer().descriptor), isOptional = true)
      element(
        "patchFormat",
        listSerialDescriptor(KotlinString.serializer().descriptor),
        isOptional = true,
      ...
      element(
        "document",
        listSerialDescriptor(
          lazyDescriptor { CapabilityStatement.Document.serializer().descriptor }
        ),
        isOptional = true,
      )
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CapabilityStatement {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        38 ->
          instantiates =
            decoder.decodeNullableSerializableElement(__desc, 38, Hoisted.instantiatesSer, null)
        39 ->
          _instantiates =
            decoder.decodeNullableSerializableElement(__desc, 39, Hoisted.instantiatesSer2, null)
        40 ->
          imports =
            decoder.decodeNullableSerializableElement(__desc, 40, Hoisted.instantiatesSer, null)
        41 ->
          _imports =
            decoder.decodeNullableSerializableElement(__desc, 41, Hoisted.instantiatesSer2, null)
        42 ->
          software =
            decoder.decodeNullableSerializableElement(__desc, 42, Hoisted.softwareSer, null)
        43 ->
          implementation =
            decoder.decodeNullableSerializableElement(__desc, 43, Hoisted.implementationSer, null)
        44 -> fhirVersion = decoder.decodeStringElement(__desc, 44)
        45 ->
          _fhirVersion =
        ...
        48 ->
          patchFormat =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.instantiatesSer, null)
        49 ->
          _patchFormat =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.instantiatesSer2, null)
        50 ->
          implementationGuide =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.instantiatesSer, null)
        51 ->
          _implementationGuide =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.instantiatesSer2, null)
        52 -> rest = decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.restSer, null)
        53 ->
          messaging =
            decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.messagingSer, null)
        54 ->
          document =
            decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.documentSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: CapabilityStatement) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "CapabilityStatement")
    ...
    (value.instantiates.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 38, Hoisted.instantiatesSer, it)
    }
    (value.instantiates.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 39, Hoisted.instantiatesSer2, it)
    }
    (value.imports.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 40, Hoisted.instantiatesSer, it)
    }
    (value.imports.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 41, Hoisted.instantiatesSer2, it)
    }
    (value.software)?.let { encoder.encodeSerializableElement(__desc, 42, Hoisted.softwareSer, it) }
    (value.implementation)?.let {
      encoder.encodeSerializableElement(__desc, 43, Hoisted.implementationSer, it)
    }
    ((value.fhirVersion.value?.getCode()))?.let { encoder.encodeStringElement(__desc, 44, it) }
    ...
    (value.patchFormat.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 48, Hoisted.instantiatesSer, it)
    }
    (value.patchFormat.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 49, Hoisted.instantiatesSer2, it)
    }
    (value.implementationGuide.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 50, Hoisted.instantiatesSer, it)
    }
    (value.implementationGuide.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 51, Hoisted.instantiatesSer2, it)
    }
    if (value.rest.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 52, Hoisted.restSer, value.rest)
    if (value.messaging.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 53, Hoisted.messagingSer, value.messaging)
    if (value.document.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 54, Hoisted.documentSer, value.document)
  }
