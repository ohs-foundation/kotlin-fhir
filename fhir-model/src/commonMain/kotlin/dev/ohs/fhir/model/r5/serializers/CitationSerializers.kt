...
internal object CitationCitedArtifactRelatesToSerializer :
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Citation.CitedArtifact.RelatesTo {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        5 ->
          classifier =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.classifierSer, null)
        6 -> label = decoder.decodeStringElement(__desc, 6)
        7 -> _label = decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.typeSer, null)
        8 -> display = decoder.decodeStringElement(__desc, 8)
        9 -> _display = decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.typeSer, null)
        10 -> citation = decoder.decodeStringElement(__desc, 10)
        11 ->
          _citation = decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.typeSer, null)
        12 ->
          document =
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Citation.CitedArtifact.RelatesTo) {
    ...
    if (value.classifier.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 5, Hoisted.classifierSer, value.classifier)
    ...
    ((value.citation?.value))?.let { encoder.encodeStringElement(__desc, 10, it) }
    ...
    (value.resourceReference)?.let {
      encoder.encodeSerializableElement(__desc, 15, Hoisted.resourceReferenceSer, it)
    }
  }
...
internal object CitationCitedArtifactPublicationFormSerializer :
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Citation.CitedArtifact.PublicationForm {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 ->
          citedMedium =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.citedMediumSer, null)
        5 -> volume = decoder.decodeStringElement(__desc, 5)
        6 -> _volume = decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.volumeSer, null)
        7 -> issue = decoder.decodeStringElement(__desc, 7)
        8 -> _issue = decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.volumeSer, null)
        9 -> articleDate = decoder.decodeStringElement(__desc, 9)
        10 ->
          _articleDate =
            decoder.decodeNullableSerializableElement(__desc, 10, Hoisted.volumeSer, null)
        11 -> publicationDateText = decoder.decodeStringElement(__desc, 11)
        12 ->
          _publicationDateText =
            decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.volumeSer, null)
        13 -> publicationDateSeason = decoder.decodeStringElement(__desc, 13)
        14 ->
          _publicationDateSeason =
            decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.volumeSer, null)
        15 -> lastRevisionDate = decoder.decodeStringElement(__desc, 15)
        16 ->
          _lastRevisionDate =
            decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.volumeSer, null)
        17 ->
          language =
            decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.languageSer, null)
        18 -> accessionNumber = decoder.decodeStringElement(__desc, 18)
        19 ->
          _accessionNumber =
            decoder.decodeNullableSerializableElement(__desc, 19, Hoisted.volumeSer, null)
        20 -> pageString = decoder.decodeStringElement(__desc, 20)
        21 ->
          _pageString =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.volumeSer, null)
        22 -> firstPage = decoder.decodeStringElement(__desc, 22)
        23 ->
          _firstPage =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.volumeSer, null)
        24 -> lastPage = decoder.decodeStringElement(__desc, 24)
        25 ->
          _lastPage = decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.volumeSer, null)
        26 -> pageCount = decoder.decodeStringElement(__desc, 26)
        27 ->
          _pageCount =
            decoder.decodeNullableSerializableElement(__desc, 27, Hoisted.volumeSer, null)
        28 -> copyright = decoder.decodeStringElement(__desc, 28)
        29 ->
          _copyright =
            decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.volumeSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(
    ...
    (value.citedMedium)?.let {
      encoder.encodeSerializableElement(__desc, 4, Hoisted.citedMediumSer, it)
    }
    ((value.volume?.value))?.let { encoder.encodeStringElement(__desc, 5, it) }
    (value.volume?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 6, Hoisted.volumeSer, it)
    }
    ((value.issue?.value))?.let { encoder.encodeStringElement(__desc, 7, it) }
    (value.issue?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 8, Hoisted.volumeSer, it)
    }
    ((value.articleDate?.value?.toString()))?.let { encoder.encodeStringElement(__desc, 9, it) }
    (value.articleDate?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 10, Hoisted.volumeSer, it)
    }
    ((value.publicationDateText?.value))?.let { encoder.encodeStringElement(__desc, 11, it) }
    (value.publicationDateText?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 12, Hoisted.volumeSer, it)
    }
    ((value.publicationDateSeason?.value))?.let { encoder.encodeStringElement(__desc, 13, it) }
    (value.publicationDateSeason?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 14, Hoisted.volumeSer, it)
    }
    ((value.lastRevisionDate?.value?.toString()))?.let {
      encoder.encodeStringElement(__desc, 15, it)
    }
    (value.lastRevisionDate?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 16, Hoisted.volumeSer, it)
    }
    if (value.language.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 17, Hoisted.languageSer, value.language)
    ((value.accessionNumber?.value))?.let { encoder.encodeStringElement(__desc, 18, it) }
    (value.accessionNumber?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 19, Hoisted.volumeSer, it)
    }
    ((value.pageString?.value))?.let { encoder.encodeStringElement(__desc, 20, it) }
    (value.pageString?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 21, Hoisted.volumeSer, it)
    }
    ((value.firstPage?.value))?.let { encoder.encodeStringElement(__desc, 22, it) }
    (value.firstPage?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 23, Hoisted.volumeSer, it)
    }
    ((value.lastPage?.value))?.let { encoder.encodeStringElement(__desc, 24, it) }
    (value.lastPage?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 25, Hoisted.volumeSer, it)
    }
    ((value.pageCount?.value))?.let { encoder.encodeStringElement(__desc, 26, it) }
    (value.pageCount?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 27, Hoisted.volumeSer, it)
    }
    ((value.copyright?.value))?.let { encoder.encodeStringElement(__desc, 28, it) }
    (value.copyright?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 29, Hoisted.volumeSer, it)
    }
  }
...
internal object CitationCitedArtifactWebLocationSerializer :
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Citation.CitedArtifact.WebLocation {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        3 ->
          classifier =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.classifierSer, null)
  ...
  private fun serializeJson(
    ...
    if (value.modifierExtension.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 2, Hoisted.extensionSer, value.modifierExtension)
    if (value.classifier.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 3, Hoisted.classifierSer, value.classifier)
...
internal object CitationCitedArtifactContributorshipEntrySerializer :
  ...
  private fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        3 ->
          contributor =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.contributorSer, null)
        4 -> forenameInitials = decoder.decodeStringElement(__desc, 4)
        5 ->
          _forenameInitials =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.forenameInitialsSer, null)
        6 ->
          affiliation =
            decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.affiliationSer, null)
        7 ->
          contributionType =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.contributionTypeSer, null)
        8 ->
          role =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        10 -> correspondingContact = decoder.decodeBooleanElement(__desc, 10)
        11 ->
          _correspondingContact =
            decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.forenameInitialsSer, null)
        12 -> rankingOrder = decoder.decodeIntElement(__desc, 12)
        13 ->
          _rankingOrder =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.forenameInitialsSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(
    ...
    (value.contributor)?.let {
      encoder.encodeSerializableElement(__desc, 3, Hoisted.contributorSer, it)
    }
    ((value.forenameInitials?.value))?.let { encoder.encodeStringElement(__desc, 4, it) }
    (value.forenameInitials?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 5, Hoisted.forenameInitialsSer, it)
    }
    if (value.affiliation.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 6, Hoisted.affiliationSer, value.affiliation)
    ...
    (value.role)?.let {
      encoder.encodeSerializableElement(__desc, 8, Hoisted.contributionTypeSerInner, it)
    }
    ...
    ((value.correspondingContact?.value))?.let { encoder.encodeBooleanElement(__desc, 10, it) }
    (value.correspondingContact?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 11, Hoisted.forenameInitialsSer, it)
    }
    ((value.rankingOrder?.value))?.let { encoder.encodeIntElement(__desc, 12, it) }
    (value.rankingOrder?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 13, Hoisted.forenameInitialsSer, it)
    }
  }
...
internal object CitationVersionAlgorithmSerializer : KSerializer<Citation.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Citation.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Citation.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Citation.VersionAlgorithm: " + __i
          )
      }
    }
    return Citation.VersionAlgorithm.from(
...
internal object CitationSerializer : KSerializer<Citation> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Citation {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        47 ->
          author = decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.contactSer, null)
        48 ->
          editor = decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.contactSer, null)
        49 ->
          reviewer = decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.contactSer, null)
        50 ->
          endorser = decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.contactSer, null)
        51 ->
          summary = decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.summarySer, null)
        52 ->
          classification =
            decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.classificationSer, null)
        53 -> note = decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.noteSer, null)
        54 ->
          currentState =
            decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.jurisdictionSer, null)
        55 ->
          statusDate =
            decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.statusDateSer, null)
        56 ->
          relatedArtifact =
            decoder.decodeNullableSerializableElement(__desc, 56, Hoisted.relatedArtifactSer, null)
        57 ->
          citedArtifact =
            decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.citedArtifactSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Citation) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "Citation")
    ...
    if (value.author.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 47, Hoisted.contactSer, value.author)
    if (value.editor.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 48, Hoisted.contactSer, value.editor)
    if (value.reviewer.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 49, Hoisted.contactSer, value.reviewer)
    if (value.endorser.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 50, Hoisted.contactSer, value.endorser)
    if (value.summary.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 51, Hoisted.summarySer, value.summary)
    if (value.classification.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 52, Hoisted.classificationSer, value.classification)
    if (value.note.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 53, Hoisted.noteSer, value.note)
    if (value.currentState.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 54, Hoisted.jurisdictionSer, value.currentState)
    if (value.statusDate.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 55, Hoisted.statusDateSer, value.statusDate)
    ...
    (value.citedArtifact)?.let {
      encoder.encodeSerializableElement(__desc, 57, Hoisted.citedArtifactSer, it)
    }
  }
