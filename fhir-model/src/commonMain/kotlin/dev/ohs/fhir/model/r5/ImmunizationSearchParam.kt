...
public sealed class ImmunizationSearchParam<T> : SearchParam {
  ...
  public data object Date : ImmunizationSearchParam<Any>() {
    ...
    public override val expression: String = "(Immunization.occurrence.ofType(dateTime))"
  ...
  public data object Manufacturer : ImmunizationSearchParam<Any>() {
    ...
    public override val expression: String = "Immunization.manufacturer.reference"
  ...
  public data object Reaction : ImmunizationSearchParam<Any>() {
    ...
    public override val expression: String = "Immunization.reaction.manifestation.reference"
  ...
  public data object ReasonCode : ImmunizationSearchParam<Any>() {
    ...
    public override val expression: String = "Immunization.reason.concept"
  ...
  public data object ReasonReference : ImmunizationSearchParam<Any>() {
    ...
    public override val expression: String = "Immunization.reason.reference"
