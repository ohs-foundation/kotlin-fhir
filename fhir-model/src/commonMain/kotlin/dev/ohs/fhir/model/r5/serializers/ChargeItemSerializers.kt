...
internal object ChargeItemSerializer : KSerializer<ChargeItem> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ChargeItem") {
      ...
      element("unitPriceComponent", MonetaryComponent.serializer().descriptor, isOptional = true)
      element("totalPriceComponent", MonetaryComponent.serializer().descriptor, isOptional = true)
      element("overrideReason", CodeableConcept.serializer().descriptor, isOptional = true)
      element("enterer", Reference.serializer().descriptor, isOptional = true)
      element("enteredDate", String.serializer().descriptor, isOptional = true)
