  ...
  private fun deserializeJson(decoder: CompositeDecoder): PlanDefinition.Action {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        22 -> input = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.inputSer, null)
        23 ->
        ...
        25 -> timingDateTime = decoder.decodeStringElement(__desc, __i)
        26 ->
          _timingDateTime =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        27 ->
        ...
        34 -> groupingBehavior = decoder.decodeStringElement(__desc, __i)
        35 ->
          _groupingBehavior =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        36 -> selectionBehavior = decoder.decodeStringElement(__desc, __i)
        37 ->
          _selectionBehavior =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        38 -> requiredBehavior = decoder.decodeStringElement(__desc, __i)
        39 ->
          _requiredBehavior =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        40 -> precheckBehavior = decoder.decodeStringElement(__desc, __i)
        41 ->
          _precheckBehavior =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        42 -> cardinalityBehavior = decoder.decodeStringElement(__desc, __i)
        43 ->
          _cardinalityBehavior =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        44 -> definitionCanonical = decoder.decodeStringElement(__desc, __i)
        45 ->
          _definitionCanonical =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        46 -> definitionUri = decoder.decodeStringElement(__desc, __i)
        47 ->
          _definitionUri =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        48 -> transform = decoder.decodeStringElement(__desc, __i)
        49 ->
          _transform =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.prefixSer, null)
        50 ->
...
internal object PlanDefinitionSerializer : KSerializer<PlanDefinition> {
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        38 ->
          _purpose =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        39 -> usage = decoder.decodeStringElement(__desc, __i)
        40 ->
          _usage =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        ...
        56 -> goal = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.goalSer, null)
        57 ->
          action = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.actionSer, null)
  ...
  internal fun serializeJson(
    ...
    ((value.usage?.value))?.let { encoder.encodeStringElement(__desc, 39 + __off, it) }
    ...
    (value.library.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 54 + __off, Hoisted.librarySer, it)
    }
    (value.library.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 55 + __off, Hoisted.librarySer2, it)
    }
    if (value.goal.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 56 + __off, Hoisted.goalSer, value.goal)
    if (value.action.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 57 + __off, Hoisted.actionSer, value.action)
  }
