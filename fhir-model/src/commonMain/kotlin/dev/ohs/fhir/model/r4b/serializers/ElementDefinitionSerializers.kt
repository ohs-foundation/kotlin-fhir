  ...
  private fun deserializeJson(decoder: CompositeDecoder): ElementDefinition.Example {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        60 ->
          valueRatioRange =
            decoder.decodeNullableSerializableElement(__desc, 60, Hoisted.valueRatioRangeSer, null)
        61 ->
          valueReference =
            decoder.decodeNullableSerializableElement(__desc, 61, Hoisted.valueReferenceSer, null)
        62 ->
          valueSampledData =
            decoder.decodeNullableSerializableElement(__desc, 62, Hoisted.valueSampledDataSer, null)
        63 ->
          valueSignature =
            decoder.decodeNullableSerializableElement(__desc, 63, Hoisted.valueSignatureSer, null)
        64 ->
          valueTiming =
            decoder.decodeNullableSerializableElement(__desc, 64, Hoisted.valueTimingSer, null)
        65 ->
          valueContactDetail =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        66 ->
          valueContributor =
            decoder.decodeNullableSerializableElement(__desc, 66, Hoisted.valueContributorSer, null)
        67 ->
        ...
        73 ->
          valueDosage =
            decoder.decodeNullableSerializableElement(__desc, 73, Hoisted.valueDosageSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: ElementDefinition.Example) {
    ...
    when (val __d = value.`value`) {
      ...
      is ElementDefinition.Example.Value.CodeableReference -> {
        encoder.encodeSerializableElement(__desc, 47, Hoisted.valueCodeableReferenceSer, __d.value)
      }
      ...
      is ElementDefinition.Example.Value.RatioRange -> {
        encoder.encodeSerializableElement(__desc, 60, Hoisted.valueRatioRangeSer, __d.value)
      }
      is ElementDefinition.Example.Value.Reference -> {
        encoder.encodeSerializableElement(__desc, 61, Hoisted.valueReferenceSer, __d.value)
      }
      is ElementDefinition.Example.Value.SampledData -> {
        encoder.encodeSerializableElement(__desc, 62, Hoisted.valueSampledDataSer, __d.value)
      }
      is ElementDefinition.Example.Value.Signature -> {
        encoder.encodeSerializableElement(__desc, 63, Hoisted.valueSignatureSer, __d.value)
      }
      is ElementDefinition.Example.Value.Timing -> {
        encoder.encodeSerializableElement(__desc, 64, Hoisted.valueTimingSer, __d.value)
      }
      is ElementDefinition.Example.Value.ContactDetail -> {
        encoder.encodeSerializableElement(__desc, 65, Hoisted.valueContactDetailSer, __d.value)
      }
      is ElementDefinition.Example.Value.Contributor -> {
        encoder.encodeSerializableElement(__desc, 66, Hoisted.valueContributorSer, __d.value)
      }
      ...
      is ElementDefinition.Example.Value.Dosage -> {
        encoder.encodeSerializableElement(__desc, 73, Hoisted.valueDosageSer, __d.value)
      }
    }
  }
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.DefaultValue.Address -> {
          encodeSerializableElement(__desc, 38, Hoisted.defaultValueAddressSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Age -> {
          encodeSerializableElement(__desc, 39, Hoisted.defaultValueAgeSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Annotation -> {
          encodeSerializableElement(__desc, 40, Hoisted.defaultValueAnnotationSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Attachment -> {
          encodeSerializableElement(__desc, 41, Hoisted.defaultValueAttachmentSer, __d.value)
        }
        is ElementDefinition.DefaultValue.CodeableConcept -> {
          encodeSerializableElement(__desc, 42, Hoisted.defaultValueCodeableConceptSer, __d.value)
        }
        is ElementDefinition.DefaultValue.CodeableReference -> {
          encodeSerializableElement(__desc, 43, Hoisted.defaultValueCodeableReferenceSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Coding -> {
          encodeSerializableElement(__desc, 44, Hoisted.defaultValueCodingSer, __d.value)
        }
        is ElementDefinition.DefaultValue.ContactPoint -> {
          encodeSerializableElement(__desc, 45, Hoisted.defaultValueContactPointSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Count -> {
          encodeSerializableElement(__desc, 46, Hoisted.defaultValueCountSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Distance -> {
          encodeSerializableElement(__desc, 47, Hoisted.defaultValueDistanceSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Duration -> {
          encodeSerializableElement(__desc, 48, Hoisted.defaultValueDurationSer, __d.value)
        }
        is ElementDefinition.DefaultValue.HumanName -> {
          encodeSerializableElement(__desc, 49, Hoisted.defaultValueHumanNameSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Identifier -> {
          encodeSerializableElement(__desc, 50, Hoisted.defaultValueIdentifierSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Money -> {
          encodeSerializableElement(__desc, 51, Hoisted.defaultValueMoneySer, __d.value)
        }
        is ElementDefinition.DefaultValue.Period -> {
          encodeSerializableElement(__desc, 52, Hoisted.defaultValuePeriodSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Quantity -> {
          encodeSerializableElement(__desc, 53, Hoisted.defaultValueQuantitySer, __d.value)
        }
        is ElementDefinition.DefaultValue.Range -> {
          encodeSerializableElement(__desc, 54, Hoisted.defaultValueRangeSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Ratio -> {
          encodeSerializableElement(__desc, 55, Hoisted.defaultValueRatioSer, __d.value)
        }
        is ElementDefinition.DefaultValue.RatioRange -> {
          encodeSerializableElement(__desc, 56, Hoisted.defaultValueRatioRangeSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Reference -> {
          encodeSerializableElement(__desc, 57, Hoisted.defaultValueReferenceSer, __d.value)
        }
        is ElementDefinition.DefaultValue.SampledData -> {
          encodeSerializableElement(__desc, 58, Hoisted.defaultValueSampledDataSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Signature -> {
          encodeSerializableElement(__desc, 59, Hoisted.defaultValueSignatureSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Timing -> {
          encodeSerializableElement(__desc, 60, Hoisted.defaultValueTimingSer, __d.value)
        }
        is ElementDefinition.DefaultValue.ContactDetail -> {
          encodeSerializableElement(__desc, 61, Hoisted.defaultValueContactDetailSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Contributor -> {
          encodeSerializableElement(__desc, 62, Hoisted.defaultValueContributorSer, __d.value)
        }
        is ElementDefinition.DefaultValue.DataRequirement -> {
          encodeSerializableElement(__desc, 63, Hoisted.defaultValueDataRequirementSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Expression -> {
          encodeSerializableElement(__desc, 64, Hoisted.defaultValueExpressionSer, __d.value)
        }
        ...
        is ElementDefinition.DefaultValue.RelatedArtifact -> {
          encodeSerializableElement(__desc, 66, Hoisted.defaultValueRelatedArtifactSer, __d.value)
        }
        is ElementDefinition.DefaultValue.TriggerDefinition -> {
          encodeSerializableElement(__desc, 67, Hoisted.defaultValueTriggerDefinitionSer, __d.value)
        }
        is ElementDefinition.DefaultValue.UsageContext -> {
          encodeSerializableElement(__desc, 68, Hoisted.defaultValueUsageContextSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Dosage -> {
          encodeSerializableElement(__desc, 69, Hoisted.defaultValueDosageSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ElementDefinition.DefaultValue {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        20 -> defaultValueMarkdown = decoder.decodeStringElement(__desc, 20)
        21 ->
          _defaultValueMarkdown =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.elementSer, null)
        22 -> defaultValueOid = decoder.decodeStringElement(__desc, 22)
        23 ->
          _defaultValueOid =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.elementSer, null)
        24 -> defaultValuePositiveInt = decoder.decodeIntElement(__desc, 24)
        25 ->
          _defaultValuePositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.elementSer, null)
        26 -> defaultValueString = decoder.decodeStringElement(__desc, 26)
        27 ->
          _defaultValueString =
        ...
        30 -> defaultValueUnsignedInt = decoder.decodeIntElement(__desc, 30)
        31 ->
          _defaultValueUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 31, Hoisted.elementSer, null)
        32 -> defaultValueUri = decoder.decodeStringElement(__desc, 32)
        33 ->
          _defaultValueUri =
            decoder.decodeNullableSerializableElement(__desc, 33, Hoisted.elementSer, null)
        34 -> defaultValueUrl = decoder.decodeStringElement(__desc, 34)
        35 ->
          _defaultValueUrl =
            decoder.decodeNullableSerializableElement(__desc, 35, Hoisted.elementSer, null)
        36 -> defaultValueUuid = decoder.decodeStringElement(__desc, 36)
        37 ->
          _defaultValueUuid =
        ...
        39 ->
          defaultValueAge =
            decoder.decodeNullableSerializableElement(__desc, 39, Hoisted.defaultValueAgeSer, null)
        40 ->
...
internal object ElementDefinitionFixedSerializer : KSerializer<ElementDefinition.Fixed> {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.Fixed.Address -> {
          encodeSerializableElement(__desc, 38, Hoisted.fixedAddressSer, __d.value)
        }
        is ElementDefinition.Fixed.Age -> {
          encodeSerializableElement(__desc, 39, Hoisted.fixedAgeSer, __d.value)
        }
        is ElementDefinition.Fixed.Annotation -> {
          encodeSerializableElement(__desc, 40, Hoisted.fixedAnnotationSer, __d.value)
        }
        is ElementDefinition.Fixed.Attachment -> {
          encodeSerializableElement(__desc, 41, Hoisted.fixedAttachmentSer, __d.value)
        }
        is ElementDefinition.Fixed.CodeableConcept -> {
          encodeSerializableElement(__desc, 42, Hoisted.fixedCodeableConceptSer, __d.value)
        }
        is ElementDefinition.Fixed.CodeableReference -> {
          encodeSerializableElement(__desc, 43, Hoisted.fixedCodeableReferenceSer, __d.value)
        }
        is ElementDefinition.Fixed.Coding -> {
          encodeSerializableElement(__desc, 44, Hoisted.fixedCodingSer, __d.value)
        }
        is ElementDefinition.Fixed.ContactPoint -> {
          encodeSerializableElement(__desc, 45, Hoisted.fixedContactPointSer, __d.value)
        }
        is ElementDefinition.Fixed.Count -> {
          encodeSerializableElement(__desc, 46, Hoisted.fixedCountSer, __d.value)
        }
        is ElementDefinition.Fixed.Distance -> {
          encodeSerializableElement(__desc, 47, Hoisted.fixedDistanceSer, __d.value)
        }
        is ElementDefinition.Fixed.Duration -> {
          encodeSerializableElement(__desc, 48, Hoisted.fixedDurationSer, __d.value)
        }
        is ElementDefinition.Fixed.HumanName -> {
          encodeSerializableElement(__desc, 49, Hoisted.fixedHumanNameSer, __d.value)
        }
        is ElementDefinition.Fixed.Identifier -> {
          encodeSerializableElement(__desc, 50, Hoisted.fixedIdentifierSer, __d.value)
        }
        is ElementDefinition.Fixed.Money -> {
          encodeSerializableElement(__desc, 51, Hoisted.fixedMoneySer, __d.value)
        }
        is ElementDefinition.Fixed.Period -> {
          encodeSerializableElement(__desc, 52, Hoisted.fixedPeriodSer, __d.value)
        }
        is ElementDefinition.Fixed.Quantity -> {
          encodeSerializableElement(__desc, 53, Hoisted.fixedQuantitySer, __d.value)
        }
        is ElementDefinition.Fixed.Range -> {
          encodeSerializableElement(__desc, 54, Hoisted.fixedRangeSer, __d.value)
        }
        is ElementDefinition.Fixed.Ratio -> {
          encodeSerializableElement(__desc, 55, Hoisted.fixedRatioSer, __d.value)
        }
        is ElementDefinition.Fixed.RatioRange -> {
          encodeSerializableElement(__desc, 56, Hoisted.fixedRatioRangeSer, __d.value)
        }
        is ElementDefinition.Fixed.Reference -> {
          encodeSerializableElement(__desc, 57, Hoisted.fixedReferenceSer, __d.value)
        }
        is ElementDefinition.Fixed.SampledData -> {
          encodeSerializableElement(__desc, 58, Hoisted.fixedSampledDataSer, __d.value)
        }
        is ElementDefinition.Fixed.Signature -> {
          encodeSerializableElement(__desc, 59, Hoisted.fixedSignatureSer, __d.value)
        }
        is ElementDefinition.Fixed.Timing -> {
          encodeSerializableElement(__desc, 60, Hoisted.fixedTimingSer, __d.value)
        }
        is ElementDefinition.Fixed.ContactDetail -> {
          encodeSerializableElement(__desc, 61, Hoisted.fixedContactDetailSer, __d.value)
        }
        is ElementDefinition.Fixed.Contributor -> {
          encodeSerializableElement(__desc, 62, Hoisted.fixedContributorSer, __d.value)
        }
        is ElementDefinition.Fixed.DataRequirement -> {
          encodeSerializableElement(__desc, 63, Hoisted.fixedDataRequirementSer, __d.value)
        }
        is ElementDefinition.Fixed.Expression -> {
          encodeSerializableElement(__desc, 64, Hoisted.fixedExpressionSer, __d.value)
        }
        is ElementDefinition.Fixed.ParameterDefinition -> {
          encodeSerializableElement(__desc, 65, Hoisted.fixedParameterDefinitionSer, __d.value)
        }
        is ElementDefinition.Fixed.RelatedArtifact -> {
          encodeSerializableElement(__desc, 66, Hoisted.fixedRelatedArtifactSer, __d.value)
        }
        is ElementDefinition.Fixed.TriggerDefinition -> {
          encodeSerializableElement(__desc, 67, Hoisted.fixedTriggerDefinitionSer, __d.value)
        }
        is ElementDefinition.Fixed.UsageContext -> {
          encodeSerializableElement(__desc, 68, Hoisted.fixedUsageContextSer, __d.value)
        }
        is ElementDefinition.Fixed.Dosage -> {
          encodeSerializableElement(__desc, 69, Hoisted.fixedDosageSer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        19 ->
          _fixedInteger =
            decoder.decodeNullableSerializableElement(__desc, 19, Hoisted.elementSer, null)
        20 -> fixedMarkdown = decoder.decodeStringElement(__desc, 20)
        21 ->
          _fixedMarkdown =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.elementSer, null)
        22 -> fixedOid = decoder.decodeStringElement(__desc, 22)
        23 ->
          _fixedOid =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.elementSer, null)
        24 -> fixedPositiveInt = decoder.decodeIntElement(__desc, 24)
        25 ->
          _fixedPositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.elementSer, null)
        26 -> fixedString = decoder.decodeStringElement(__desc, 26)
        27 ->
          _fixedString =
            decoder.decodeNullableSerializableElement(__desc, 27, Hoisted.elementSer, null)
        28 ->
        ...
        29 ->
          _fixedTime =
            decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.elementSer, null)
        30 -> fixedUnsignedInt = decoder.decodeIntElement(__desc, 30)
        31 ->
          _fixedUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 31, Hoisted.elementSer, null)
        32 -> fixedUri = decoder.decodeStringElement(__desc, 32)
        33 ->
          _fixedUri =
            decoder.decodeNullableSerializableElement(__desc, 33, Hoisted.elementSer, null)
        34 -> fixedUrl = decoder.decodeStringElement(__desc, 34)
        35 ->
          _fixedUrl =
            decoder.decodeNullableSerializableElement(__desc, 35, Hoisted.elementSer, null)
        36 -> fixedUuid = decoder.decodeStringElement(__desc, 36)
        37 ->
          _fixedUuid =
            decoder.decodeNullableSerializableElement(__desc, 37, Hoisted.elementSer, null)
        38 ->
          fixedAddress =
            decoder.decodeNullableSerializableElement(__desc, 38, Hoisted.fixedAddressSer, null)
        39 ->
          fixedAge =
            decoder.decodeNullableSerializableElement(__desc, 39, Hoisted.fixedAgeSer, null)
        40 ->
          fixedAnnotation =
            decoder.decodeNullableSerializableElement(__desc, 40, Hoisted.fixedAnnotationSer, null)
        41 ->
          fixedAttachment =
            decoder.decodeNullableSerializableElement(__desc, 41, Hoisted.fixedAttachmentSer, null)
        42 ->
        ...
        44 ->
          fixedCoding =
            decoder.decodeNullableSerializableElement(__desc, 44, Hoisted.fixedCodingSer, null)
        45 ->
          fixedContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        46 ->
          fixedCount =
            decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.fixedCountSer, null)
        47 ->
          fixedDistance =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.fixedDistanceSer, null)
        48 ->
          fixedDuration =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.fixedDurationSer, null)
        49 ->
          fixedHumanName =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.fixedHumanNameSer, null)
        50 ->
          fixedIdentifier =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.fixedIdentifierSer, null)
        51 ->
          fixedMoney =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.fixedMoneySer, null)
        52 ->
          fixedPeriod =
            decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.fixedPeriodSer, null)
        53 ->
          fixedQuantity =
            decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.fixedQuantitySer, null)
        54 ->
          fixedRange =
            decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.fixedRangeSer, null)
        55 ->
          fixedRatio =
            decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.fixedRatioSer, null)
        56 ->
          fixedRatioRange =
            decoder.decodeNullableSerializableElement(__desc, 56, Hoisted.fixedRatioRangeSer, null)
        57 ->
          fixedReference =
            decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.fixedReferenceSer, null)
        58 ->
          fixedSampledData =
            decoder.decodeNullableSerializableElement(__desc, 58, Hoisted.fixedSampledDataSer, null)
        59 ->
          fixedSignature =
            decoder.decodeNullableSerializableElement(__desc, 59, Hoisted.fixedSignatureSer, null)
        60 ->
          fixedTiming =
            decoder.decodeNullableSerializableElement(__desc, 60, Hoisted.fixedTimingSer, null)
        61 ->
          fixedContactDetail =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        62 ->
          fixedContributor =
            decoder.decodeNullableSerializableElement(__desc, 62, Hoisted.fixedContributorSer, null)
        63 ->
        ...
        64 ->
          fixedExpression =
            decoder.decodeNullableSerializableElement(__desc, 64, Hoisted.fixedExpressionSer, null)
        65 ->
          fixedParameterDefinition =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        69 ->
          fixedDosage =
            decoder.decodeNullableSerializableElement(__desc, 69, Hoisted.fixedDosageSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
  ...
  private object Hoisted {
    ...
    public val fixedContributorSer: KSerializer<Contributor> = Contributor.serializer()
...
internal object ElementDefinitionPatternSerializer : KSerializer<ElementDefinition.Pattern> {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.Pattern.Address -> {
          encodeSerializableElement(__desc, 38, Hoisted.patternAddressSer, __d.value)
        }
        is ElementDefinition.Pattern.Age -> {
          encodeSerializableElement(__desc, 39, Hoisted.patternAgeSer, __d.value)
        }
        is ElementDefinition.Pattern.Annotation -> {
          encodeSerializableElement(__desc, 40, Hoisted.patternAnnotationSer, __d.value)
        }
        is ElementDefinition.Pattern.Attachment -> {
          encodeSerializableElement(__desc, 41, Hoisted.patternAttachmentSer, __d.value)
        }
        is ElementDefinition.Pattern.CodeableConcept -> {
          encodeSerializableElement(__desc, 42, Hoisted.patternCodeableConceptSer, __d.value)
        }
        is ElementDefinition.Pattern.CodeableReference -> {
          encodeSerializableElement(__desc, 43, Hoisted.patternCodeableReferenceSer, __d.value)
        }
        is ElementDefinition.Pattern.Coding -> {
          encodeSerializableElement(__desc, 44, Hoisted.patternCodingSer, __d.value)
        }
        is ElementDefinition.Pattern.ContactPoint -> {
          encodeSerializableElement(__desc, 45, Hoisted.patternContactPointSer, __d.value)
        }
        is ElementDefinition.Pattern.Count -> {
          encodeSerializableElement(__desc, 46, Hoisted.patternCountSer, __d.value)
        }
        is ElementDefinition.Pattern.Distance -> {
          encodeSerializableElement(__desc, 47, Hoisted.patternDistanceSer, __d.value)
        }
        is ElementDefinition.Pattern.Duration -> {
          encodeSerializableElement(__desc, 48, Hoisted.patternDurationSer, __d.value)
        }
        is ElementDefinition.Pattern.HumanName -> {
          encodeSerializableElement(__desc, 49, Hoisted.patternHumanNameSer, __d.value)
        }
        is ElementDefinition.Pattern.Identifier -> {
          encodeSerializableElement(__desc, 50, Hoisted.patternIdentifierSer, __d.value)
        }
        is ElementDefinition.Pattern.Money -> {
          encodeSerializableElement(__desc, 51, Hoisted.patternMoneySer, __d.value)
        }
        is ElementDefinition.Pattern.Period -> {
          encodeSerializableElement(__desc, 52, Hoisted.patternPeriodSer, __d.value)
        }
        is ElementDefinition.Pattern.Quantity -> {
          encodeSerializableElement(__desc, 53, Hoisted.patternQuantitySer, __d.value)
        }
        is ElementDefinition.Pattern.Range -> {
          encodeSerializableElement(__desc, 54, Hoisted.patternRangeSer, __d.value)
        }
        is ElementDefinition.Pattern.Ratio -> {
          encodeSerializableElement(__desc, 55, Hoisted.patternRatioSer, __d.value)
        }
        is ElementDefinition.Pattern.RatioRange -> {
          encodeSerializableElement(__desc, 56, Hoisted.patternRatioRangeSer, __d.value)
        }
        is ElementDefinition.Pattern.Reference -> {
          encodeSerializableElement(__desc, 57, Hoisted.patternReferenceSer, __d.value)
        }
        is ElementDefinition.Pattern.SampledData -> {
          encodeSerializableElement(__desc, 58, Hoisted.patternSampledDataSer, __d.value)
        }
        is ElementDefinition.Pattern.Signature -> {
          encodeSerializableElement(__desc, 59, Hoisted.patternSignatureSer, __d.value)
        }
        is ElementDefinition.Pattern.Timing -> {
          encodeSerializableElement(__desc, 60, Hoisted.patternTimingSer, __d.value)
        }
        is ElementDefinition.Pattern.ContactDetail -> {
          encodeSerializableElement(__desc, 61, Hoisted.patternContactDetailSer, __d.value)
        }
        is ElementDefinition.Pattern.Contributor -> {
          encodeSerializableElement(__desc, 62, Hoisted.patternContributorSer, __d.value)
        }
        is ElementDefinition.Pattern.DataRequirement -> {
          encodeSerializableElement(__desc, 63, Hoisted.patternDataRequirementSer, __d.value)
        }
        is ElementDefinition.Pattern.Expression -> {
          encodeSerializableElement(__desc, 64, Hoisted.patternExpressionSer, __d.value)
        }
        is ElementDefinition.Pattern.ParameterDefinition -> {
          encodeSerializableElement(__desc, 65, Hoisted.patternParameterDefinitionSer, __d.value)
        }
        is ElementDefinition.Pattern.RelatedArtifact -> {
          encodeSerializableElement(__desc, 66, Hoisted.patternRelatedArtifactSer, __d.value)
        }
        is ElementDefinition.Pattern.TriggerDefinition -> {
          encodeSerializableElement(__desc, 67, Hoisted.patternTriggerDefinitionSer, __d.value)
        }
        is ElementDefinition.Pattern.UsageContext -> {
          encodeSerializableElement(__desc, 68, Hoisted.patternUsageContextSer, __d.value)
        }
        is ElementDefinition.Pattern.Dosage -> {
          encodeSerializableElement(__desc, 69, Hoisted.patternDosageSer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        19 ->
          _patternInteger =
            decoder.decodeNullableSerializableElement(__desc, 19, Hoisted.elementSer, null)
        20 -> patternMarkdown = decoder.decodeStringElement(__desc, 20)
        21 ->
          _patternMarkdown =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.elementSer, null)
        22 -> patternOid = decoder.decodeStringElement(__desc, 22)
        23 ->
          _patternOid =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.elementSer, null)
        24 -> patternPositiveInt = decoder.decodeIntElement(__desc, 24)
        25 ->
          _patternPositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.elementSer, null)
        26 -> patternString = decoder.decodeStringElement(__desc, 26)
        27 ->
          _patternString =
            decoder.decodeNullableSerializableElement(__desc, 27, Hoisted.elementSer, null)
        28 ->
        ...
        29 ->
          _patternTime =
            decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.elementSer, null)
        30 -> patternUnsignedInt = decoder.decodeIntElement(__desc, 30)
        31 ->
          _patternUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 31, Hoisted.elementSer, null)
        32 -> patternUri = decoder.decodeStringElement(__desc, 32)
        33 ->
          _patternUri =
            decoder.decodeNullableSerializableElement(__desc, 33, Hoisted.elementSer, null)
        34 -> patternUrl = decoder.decodeStringElement(__desc, 34)
        35 ->
          _patternUrl =
            decoder.decodeNullableSerializableElement(__desc, 35, Hoisted.elementSer, null)
        36 -> patternUuid = decoder.decodeStringElement(__desc, 36)
        37 ->
          _patternUuid =
            decoder.decodeNullableSerializableElement(__desc, 37, Hoisted.elementSer, null)
        38 ->
          patternAddress =
            decoder.decodeNullableSerializableElement(__desc, 38, Hoisted.patternAddressSer, null)
        39 ->
          patternAge =
            decoder.decodeNullableSerializableElement(__desc, 39, Hoisted.patternAgeSer, null)
        40 ->
          patternAnnotation =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        44 ->
          patternCoding =
            decoder.decodeNullableSerializableElement(__desc, 44, Hoisted.patternCodingSer, null)
        45 ->
          patternContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        46 ->
          patternCount =
            decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.patternCountSer, null)
        47 ->
          patternDistance =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.patternDistanceSer, null)
        48 ->
          patternDuration =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.patternDurationSer, null)
        49 ->
          patternHumanName =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.patternHumanNameSer, null)
        50 ->
          patternIdentifier =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        51 ->
          patternMoney =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.patternMoneySer, null)
        52 ->
          patternPeriod =
            decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.patternPeriodSer, null)
        53 ->
          patternQuantity =
            decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.patternQuantitySer, null)
        54 ->
          patternRange =
            decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.patternRangeSer, null)
        55 ->
          patternRatio =
            decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.patternRatioSer, null)
        56 ->
          patternRatioRange =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        57 ->
          patternReference =
            decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.patternReferenceSer, null)
        58 ->
          patternSampledData =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        59 ->
          patternSignature =
            decoder.decodeNullableSerializableElement(__desc, 59, Hoisted.patternSignatureSer, null)
        60 ->
          patternTiming =
            decoder.decodeNullableSerializableElement(__desc, 60, Hoisted.patternTimingSer, null)
        61 ->
        ...
        69 ->
          patternDosage =
            decoder.decodeNullableSerializableElement(__desc, 69, Hoisted.patternDosageSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
  ...
  private object Hoisted {
    ...
    public val patternContributorSer: KSerializer<Contributor> = Contributor.serializer()
  ...
  override fun serialize(encoder: Encoder, `value`: ElementDefinition.Example.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.Example.Value.CodeableReference -> {
          encodeSerializableElement(__desc, 43, Hoisted.valueCodeableReferenceSer, __d.value)
        }
        is ElementDefinition.Example.Value.Coding -> {
          encodeSerializableElement(__desc, 44, Hoisted.valueCodingSer, __d.value)
        }
        is ElementDefinition.Example.Value.ContactPoint -> {
          encodeSerializableElement(__desc, 45, Hoisted.valueContactPointSer, __d.value)
        }
        is ElementDefinition.Example.Value.Count -> {
          encodeSerializableElement(__desc, 46, Hoisted.valueCountSer, __d.value)
        }
        is ElementDefinition.Example.Value.Distance -> {
          encodeSerializableElement(__desc, 47, Hoisted.valueDistanceSer, __d.value)
        }
        is ElementDefinition.Example.Value.Duration -> {
          encodeSerializableElement(__desc, 48, Hoisted.valueDurationSer, __d.value)
        }
        is ElementDefinition.Example.Value.HumanName -> {
          encodeSerializableElement(__desc, 49, Hoisted.valueHumanNameSer, __d.value)
        }
        is ElementDefinition.Example.Value.Identifier -> {
          encodeSerializableElement(__desc, 50, Hoisted.valueIdentifierSer, __d.value)
        }
        is ElementDefinition.Example.Value.Money -> {
          encodeSerializableElement(__desc, 51, Hoisted.valueMoneySer, __d.value)
        }
        is ElementDefinition.Example.Value.Period -> {
          encodeSerializableElement(__desc, 52, Hoisted.valuePeriodSer, __d.value)
        }
        is ElementDefinition.Example.Value.Quantity -> {
          encodeSerializableElement(__desc, 53, Hoisted.valueQuantitySer, __d.value)
        }
        is ElementDefinition.Example.Value.Range -> {
          encodeSerializableElement(__desc, 54, Hoisted.valueRangeSer, __d.value)
        }
        is ElementDefinition.Example.Value.Ratio -> {
          encodeSerializableElement(__desc, 55, Hoisted.valueRatioSer, __d.value)
        }
        is ElementDefinition.Example.Value.RatioRange -> {
          encodeSerializableElement(__desc, 56, Hoisted.valueRatioRangeSer, __d.value)
        }
        is ElementDefinition.Example.Value.Reference -> {
          encodeSerializableElement(__desc, 57, Hoisted.valueReferenceSer, __d.value)
        }
        is ElementDefinition.Example.Value.SampledData -> {
          encodeSerializableElement(__desc, 58, Hoisted.valueSampledDataSer, __d.value)
        }
        is ElementDefinition.Example.Value.Signature -> {
          encodeSerializableElement(__desc, 59, Hoisted.valueSignatureSer, __d.value)
        }
        is ElementDefinition.Example.Value.Timing -> {
          encodeSerializableElement(__desc, 60, Hoisted.valueTimingSer, __d.value)
        }
        is ElementDefinition.Example.Value.ContactDetail -> {
          encodeSerializableElement(__desc, 61, Hoisted.valueContactDetailSer, __d.value)
        }
        is ElementDefinition.Example.Value.Contributor -> {
          encodeSerializableElement(__desc, 62, Hoisted.valueContributorSer, __d.value)
        }
        is ElementDefinition.Example.Value.DataRequirement -> {
          encodeSerializableElement(__desc, 63, Hoisted.valueDataRequirementSer, __d.value)
        }
        is ElementDefinition.Example.Value.Expression -> {
          encodeSerializableElement(__desc, 64, Hoisted.valueExpressionSer, __d.value)
        }
        is ElementDefinition.Example.Value.ParameterDefinition -> {
          encodeSerializableElement(__desc, 65, Hoisted.valueParameterDefinitionSer, __d.value)
        }
        is ElementDefinition.Example.Value.RelatedArtifact -> {
          encodeSerializableElement(__desc, 66, Hoisted.valueRelatedArtifactSer, __d.value)
        }
        is ElementDefinition.Example.Value.TriggerDefinition -> {
          encodeSerializableElement(__desc, 67, Hoisted.valueTriggerDefinitionSer, __d.value)
        }
        is ElementDefinition.Example.Value.UsageContext -> {
          encodeSerializableElement(__desc, 68, Hoisted.valueUsageContextSer, __d.value)
        }
        is ElementDefinition.Example.Value.Dosage -> {
          encodeSerializableElement(__desc, 69, Hoisted.valueDosageSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ElementDefinition.Example.Value {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        44 ->
          valueCoding =
            decoder.decodeNullableSerializableElement(__desc, 44, Hoisted.valueCodingSer, null)
        45 ->
          valueContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        46 ->
          valueCount =
            decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.valueCountSer, null)
        47 ->
          valueDistance =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.valueDistanceSer, null)
        48 ->
          valueDuration =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.valueDurationSer, null)
        49 ->
          valueHumanName =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.valueHumanNameSer, null)
        50 ->
          valueIdentifier =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.valueIdentifierSer, null)
        51 ->
          valueMoney =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.valueMoneySer, null)
        52 ->
          valuePeriod =
            decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.valuePeriodSer, null)
        53 ->
          valueQuantity =
            decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.valueQuantitySer, null)
        54 ->
          valueRange =
            decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.valueRangeSer, null)
        55 ->
          valueRatio =
            decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.valueRatioSer, null)
        56 ->
          valueRatioRange =
            decoder.decodeNullableSerializableElement(__desc, 56, Hoisted.valueRatioRangeSer, null)
        57 ->
          valueReference =
            decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.valueReferenceSer, null)
        58 ->
          valueSampledData =
            decoder.decodeNullableSerializableElement(__desc, 58, Hoisted.valueSampledDataSer, null)
        59 ->
          valueSignature =
            decoder.decodeNullableSerializableElement(__desc, 59, Hoisted.valueSignatureSer, null)
        60 ->
          valueTiming =
            decoder.decodeNullableSerializableElement(__desc, 60, Hoisted.valueTimingSer, null)
        61 ->
          valueContactDetail =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        62 ->
          valueContributor =
            decoder.decodeNullableSerializableElement(__desc, 62, Hoisted.valueContributorSer, null)
        63 ->
          valueDataRequirement =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        64 ->
          valueExpression =
            decoder.decodeNullableSerializableElement(__desc, 64, Hoisted.valueExpressionSer, null)
        65 ->
          valueParameterDefinition =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        69 ->
          valueDosage =
            decoder.decodeNullableSerializableElement(__desc, 69, Hoisted.valueDosageSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.MinValue.PositiveInt -> {
          ((__d.value.value))?.let { encodeIntElement(__desc, 12, it) }
          (__d.value.toElement())?.let {
            encodeSerializableElement(__desc, 13, Hoisted.elementSer, it)
          }
        }
        ...
        is ElementDefinition.MinValue.Quantity -> {
          encodeSerializableElement(__desc, 16, Hoisted.minValueQuantitySer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        11 ->
          _minValueInteger =
            decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.elementSer, null)
        12 -> minValuePositiveInt = decoder.decodeIntElement(__desc, 12)
        13 ->
          _minValuePositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.elementSer, null)
        14 -> minValueUnsignedInt = decoder.decodeIntElement(__desc, 14)
        15 ->
          _minValueUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.elementSer, null)
        16 ->
          minValueQuantity =
            decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.minValueQuantitySer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.MaxValue.Quantity -> {
          encodeSerializableElement(__desc, 16, Hoisted.maxValueQuantitySer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        11 ->
          _maxValueInteger =
            decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.elementSer, null)
        12 -> maxValuePositiveInt = decoder.decodeIntElement(__desc, 12)
        13 ->
          _maxValuePositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.elementSer, null)
        14 -> maxValueUnsignedInt = decoder.decodeIntElement(__desc, 14)
        15 ->
          _maxValueUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.elementSer, null)
        16 ->
          maxValueQuantity =
            decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.maxValueQuantitySer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
...
internal object ElementDefinitionSerializer : KSerializer<ElementDefinition> {
  ...
  private fun deserializeJson(decoder: CompositeDecoder): ElementDefinition {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        77 ->
          defaultValueCoding =
            decoder.decodeNullableSerializableElement(__desc, 77, Hoisted.codeSerInner, null)
        78 ->
          defaultValueContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        103 -> meaningWhenMissing = decoder.decodeStringElement(__desc, 103)
        104 ->
          _meaningWhenMissing =
            decoder.decodeNullableSerializableElement(__desc, 104, Hoisted.pathSer, null)
        105 -> orderMeaning = decoder.decodeStringElement(__desc, 105)
        106 ->
          _orderMeaning =
            decoder.decodeNullableSerializableElement(__desc, 106, Hoisted.pathSer, null)
        107 -> fixedBase64Binary = decoder.decodeStringElement(__desc, 107)
        108 ->
          _fixedBase64Binary =
            decoder.decodeNullableSerializableElement(__desc, 108, Hoisted.pathSer, null)
        109 -> fixedBoolean = decoder.decodeBooleanElement(__desc, 109)
        110 ->
          _fixedBoolean =
            decoder.decodeNullableSerializableElement(__desc, 110, Hoisted.pathSer, null)
        111 -> fixedCanonical = decoder.decodeStringElement(__desc, 111)
        112 ->
          _fixedCanonical =
            decoder.decodeNullableSerializableElement(__desc, 112, Hoisted.pathSer, null)
        113 -> fixedCode = decoder.decodeStringElement(__desc, 113)
        114 ->
          _fixedCode = decoder.decodeNullableSerializableElement(__desc, 114, Hoisted.pathSer, null)
        115 -> fixedDate = decoder.decodeStringElement(__desc, 115)
        116 ->
          _fixedDate = decoder.decodeNullableSerializableElement(__desc, 116, Hoisted.pathSer, null)
        117 -> fixedDateTime = decoder.decodeStringElement(__desc, 117)
        118 ->
          _fixedDateTime =
            decoder.decodeNullableSerializableElement(__desc, 118, Hoisted.pathSer, null)
        119 ->
          fixedDecimal =
            decoder.decodeNullableSerializableElement(__desc, 119, BigDecimalSerializer, null)
        120 ->
          _fixedDecimal =
            decoder.decodeNullableSerializableElement(__desc, 120, Hoisted.pathSer, null)
        121 -> fixedId = decoder.decodeStringElement(__desc, 121)
        122 ->
          _fixedId = decoder.decodeNullableSerializableElement(__desc, 122, Hoisted.pathSer, null)
        123 -> fixedInstant = decoder.decodeStringElement(__desc, 123)
        124 ->
          _fixedInstant =
            decoder.decodeNullableSerializableElement(__desc, 124, Hoisted.pathSer, null)
        125 -> fixedInteger = decoder.decodeIntElement(__desc, 125)
        126 ->
          _fixedInteger =
            decoder.decodeNullableSerializableElement(__desc, 126, Hoisted.pathSer, null)
        127 -> fixedMarkdown = decoder.decodeStringElement(__desc, 127)
        128 ->
          _fixedMarkdown =
            decoder.decodeNullableSerializableElement(__desc, 128, Hoisted.pathSer, null)
        129 -> fixedOid = decoder.decodeStringElement(__desc, 129)
        130 ->
          _fixedOid = decoder.decodeNullableSerializableElement(__desc, 130, Hoisted.pathSer, null)
        131 -> fixedPositiveInt = decoder.decodeIntElement(__desc, 131)
        132 ->
          _fixedPositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 132, Hoisted.pathSer, null)
        133 -> fixedString = decoder.decodeStringElement(__desc, 133)
        134 ->
          _fixedString =
            decoder.decodeNullableSerializableElement(__desc, 134, Hoisted.pathSer, null)
        135 ->
          fixedTime =
            decoder.decodeNullableSerializableElement(__desc, 135, LocalTimeSerializer, null)
        136 ->
          _fixedTime = decoder.decodeNullableSerializableElement(__desc, 136, Hoisted.pathSer, null)
        137 -> fixedUnsignedInt = decoder.decodeIntElement(__desc, 137)
        138 ->
          _fixedUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 138, Hoisted.pathSer, null)
        139 -> fixedUri = decoder.decodeStringElement(__desc, 139)
        140 ->
          _fixedUri = decoder.decodeNullableSerializableElement(__desc, 140, Hoisted.pathSer, null)
        141 -> fixedUrl = decoder.decodeStringElement(__desc, 141)
        142 ->
          _fixedUrl = decoder.decodeNullableSerializableElement(__desc, 142, Hoisted.pathSer, null)
        143 -> fixedUuid = decoder.decodeStringElement(__desc, 143)
        144 ->
          _fixedUuid = decoder.decodeNullableSerializableElement(__desc, 144, Hoisted.pathSer, null)
        145 ->
          fixedAddress =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        146 ->
          fixedAge =
            decoder.decodeNullableSerializableElement(__desc, 146, Hoisted.defaultValueAgeSer, null)
        147 ->
          fixedAnnotation =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        151 ->
          fixedCoding =
            decoder.decodeNullableSerializableElement(__desc, 151, Hoisted.codeSerInner, null)
        152 ->
          fixedContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        216 ->
          patternAge =
            decoder.decodeNullableSerializableElement(__desc, 216, Hoisted.defaultValueAgeSer, null)
        217 ->
          patternAnnotation =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        221 ->
          patternCoding =
            decoder.decodeNullableSerializableElement(__desc, 221, Hoisted.codeSerInner, null)
        222 ->
          patternContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        247 ->
          example = decoder.decodeNullableSerializableElement(__desc, 247, Hoisted.exampleSer, null)
        248 -> minValueDate = decoder.decodeStringElement(__desc, 248)
        249 ->
          _minValueDate =
            decoder.decodeNullableSerializableElement(__desc, 249, Hoisted.pathSer, null)
        250 -> minValueDateTime = decoder.decodeStringElement(__desc, 250)
        251 ->
          _minValueDateTime =
            decoder.decodeNullableSerializableElement(__desc, 251, Hoisted.pathSer, null)
        252 -> minValueInstant = decoder.decodeStringElement(__desc, 252)
        253 ->
          _minValueInstant =
            decoder.decodeNullableSerializableElement(__desc, 253, Hoisted.pathSer, null)
        254 ->
          minValueTime =
            decoder.decodeNullableSerializableElement(__desc, 254, LocalTimeSerializer, null)
        255 ->
          _minValueTime =
            decoder.decodeNullableSerializableElement(__desc, 255, Hoisted.pathSer, null)
        256 ->
          minValueDecimal =
            decoder.decodeNullableSerializableElement(__desc, 256, BigDecimalSerializer, null)
        257 ->
          _minValueDecimal =
            decoder.decodeNullableSerializableElement(__desc, 257, Hoisted.pathSer, null)
        258 -> minValueInteger = decoder.decodeIntElement(__desc, 258)
        259 ->
          _minValueInteger =
            decoder.decodeNullableSerializableElement(__desc, 259, Hoisted.pathSer, null)
        260 -> minValuePositiveInt = decoder.decodeIntElement(__desc, 260)
        261 ->
          _minValuePositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 261, Hoisted.pathSer, null)
        262 -> minValueUnsignedInt = decoder.decodeIntElement(__desc, 262)
        263 ->
          _minValueUnsignedInt =
        ...
        265 -> maxValueDate = decoder.decodeStringElement(__desc, 265)
        266 ->
          _maxValueDate =
            decoder.decodeNullableSerializableElement(__desc, 266, Hoisted.pathSer, null)
        267 -> maxValueDateTime = decoder.decodeStringElement(__desc, 267)
        268 ->
          _maxValueDateTime =
            decoder.decodeNullableSerializableElement(__desc, 268, Hoisted.pathSer, null)
        269 -> maxValueInstant = decoder.decodeStringElement(__desc, 269)
        270 ->
          _maxValueInstant =
            decoder.decodeNullableSerializableElement(__desc, 270, Hoisted.pathSer, null)
        271 ->
          maxValueTime =
            decoder.decodeNullableSerializableElement(__desc, 271, LocalTimeSerializer, null)
        272 ->
          _maxValueTime =
            decoder.decodeNullableSerializableElement(__desc, 272, Hoisted.pathSer, null)
        273 ->
          maxValueDecimal =
            decoder.decodeNullableSerializableElement(__desc, 273, BigDecimalSerializer, null)
        274 ->
          _maxValueDecimal =
            decoder.decodeNullableSerializableElement(__desc, 274, Hoisted.pathSer, null)
        275 -> maxValueInteger = decoder.decodeIntElement(__desc, 275)
        276 ->
          _maxValueInteger =
            decoder.decodeNullableSerializableElement(__desc, 276, Hoisted.pathSer, null)
        277 -> maxValuePositiveInt = decoder.decodeIntElement(__desc, 277)
        278 ->
          _maxValuePositiveInt =
            decoder.decodeNullableSerializableElement(__desc, 278, Hoisted.pathSer, null)
        279 -> maxValueUnsignedInt = decoder.decodeIntElement(__desc, 279)
        280 ->
          _maxValueUnsignedInt =
        ...
        282 -> maxLength = decoder.decodeIntElement(__desc, 282)
        283 ->
          _maxLength = decoder.decodeNullableSerializableElement(__desc, 283, Hoisted.pathSer, null)
        284 ->
          condition =
            decoder.decodeNullableSerializableElement(__desc, 284, Hoisted.representationSer, null)
        285 ->
          _condition =
            decoder.decodeNullableSerializableElement(__desc, 285, Hoisted.representationSer2, null)
        286 ->
          constraint =
            decoder.decodeNullableSerializableElement(__desc, 286, Hoisted.constraintSer, null)
        287 -> mustSupport = decoder.decodeBooleanElement(__desc, 287)
        288 ->
          _mustSupport =
            decoder.decodeNullableSerializableElement(__desc, 288, Hoisted.pathSer, null)
        289 -> isModifier = decoder.decodeBooleanElement(__desc, 289)
        290 ->
          _isModifier =
            decoder.decodeNullableSerializableElement(__desc, 290, Hoisted.pathSer, null)
        291 -> isModifierReason = decoder.decodeStringElement(__desc, 291)
        292 ->
          _isModifierReason =
            decoder.decodeNullableSerializableElement(__desc, 292, Hoisted.pathSer, null)
        293 -> isSummary = decoder.decodeBooleanElement(__desc, 293)
        294 ->
          _isSummary = decoder.decodeNullableSerializableElement(__desc, 294, Hoisted.pathSer, null)
        295 ->
          binding = decoder.decodeNullableSerializableElement(__desc, 295, Hoisted.bindingSer, null)
        296 ->
          mapping = decoder.decodeNullableSerializableElement(__desc, 296, Hoisted.mappingSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: ElementDefinition) {
    ...
    when (val __d = value.defaultValue) {
      ...
      is ElementDefinition.DefaultValue.Coding -> {
        encoder.encodeSerializableElement(__desc, 77, Hoisted.codeSerInner, __d.value)
      }
      is ElementDefinition.DefaultValue.ContactPoint -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.DefaultValue.Count -> {
        encoder.encodeSerializableElement(__desc, 79, Hoisted.defaultValueCountSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Distance -> {
        encoder.encodeSerializableElement(__desc, 80, Hoisted.defaultValueDistanceSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Duration -> {
        encoder.encodeSerializableElement(__desc, 81, Hoisted.defaultValueDurationSer, __d.value)
      }
      is ElementDefinition.DefaultValue.HumanName -> {
        encoder.encodeSerializableElement(__desc, 82, Hoisted.defaultValueHumanNameSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Identifier -> {
        encoder.encodeSerializableElement(__desc, 83, Hoisted.defaultValueIdentifierSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Money -> {
        encoder.encodeSerializableElement(__desc, 84, Hoisted.defaultValueMoneySer, __d.value)
      }
      is ElementDefinition.DefaultValue.Period -> {
        encoder.encodeSerializableElement(__desc, 85, Hoisted.defaultValuePeriodSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Quantity -> {
        encoder.encodeSerializableElement(__desc, 86, Hoisted.defaultValueQuantitySer, __d.value)
      }
      is ElementDefinition.DefaultValue.Range -> {
        encoder.encodeSerializableElement(__desc, 87, Hoisted.defaultValueRangeSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Ratio -> {
        encoder.encodeSerializableElement(__desc, 88, Hoisted.defaultValueRatioSer, __d.value)
      }
      is ElementDefinition.DefaultValue.RatioRange -> {
        encoder.encodeSerializableElement(__desc, 89, Hoisted.defaultValueRatioRangeSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Reference -> {
        encoder.encodeSerializableElement(__desc, 90, Hoisted.defaultValueReferenceSer, __d.value)
      }
      is ElementDefinition.DefaultValue.SampledData -> {
        encoder.encodeSerializableElement(__desc, 91, Hoisted.defaultValueSampledDataSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Signature -> {
        encoder.encodeSerializableElement(__desc, 92, Hoisted.defaultValueSignatureSer, __d.value)
      }
      is ElementDefinition.DefaultValue.Timing -> {
        encoder.encodeSerializableElement(__desc, 93, Hoisted.defaultValueTimingSer, __d.value)
      }
      is ElementDefinition.DefaultValue.ContactDetail -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.DefaultValue.Contributor -> {
        encoder.encodeSerializableElement(__desc, 95, Hoisted.defaultValueContributorSer, __d.value)
      }
      is ElementDefinition.DefaultValue.DataRequirement -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.DefaultValue.Expression -> {
        encoder.encodeSerializableElement(__desc, 97, Hoisted.defaultValueExpressionSer, __d.value)
      }
      is ElementDefinition.DefaultValue.ParameterDefinition -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.DefaultValue.Dosage -> {
        encoder.encodeSerializableElement(__desc, 102, Hoisted.defaultValueDosageSer, __d.value)
      }
    }
    ((value.meaningWhenMissing?.value))?.let { encoder.encodeStringElement(__desc, 103, it) }
    (value.meaningWhenMissing?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 104, Hoisted.pathSer, it)
    }
    ((value.orderMeaning?.value))?.let { encoder.encodeStringElement(__desc, 105, it) }
    (value.orderMeaning?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 106, Hoisted.pathSer, it)
    }
    when (val __d = value.fixed) {
      null -> {}
      is ElementDefinition.Fixed.Base64Binary -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 107, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 108, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Boolean -> {
        ((__d.value.value))?.let { encoder.encodeBooleanElement(__desc, 109, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Fixed.Code -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 113, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 114, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Date -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 115, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 116, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.DateTime -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 117, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Fixed.Decimal -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 119, BigDecimalSerializer, it)
        }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Fixed.Id -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 121, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 122, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Instant -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 123, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 124, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Integer -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 125, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 126, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Markdown -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 127, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 128, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Oid -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 129, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 130, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.PositiveInt -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 131, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Fixed.Time -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 135, LocalTimeSerializer, it)
        }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Fixed.Url -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 141, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 142, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Uuid -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 143, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 144, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Fixed.Address -> {
        encoder.encodeSerializableElement(__desc, 145, Hoisted.defaultValueAddressSer, __d.value)
      }
      is ElementDefinition.Fixed.Age -> {
        encoder.encodeSerializableElement(__desc, 146, Hoisted.defaultValueAgeSer, __d.value)
      }
      is ElementDefinition.Fixed.Annotation -> {
        encoder.encodeSerializableElement(__desc, 147, Hoisted.defaultValueAnnotationSer, __d.value)
      }
      is ElementDefinition.Fixed.Attachment -> {
        encoder.encodeSerializableElement(__desc, 148, Hoisted.defaultValueAttachmentSer, __d.value)
      }
      is ElementDefinition.Fixed.CodeableConcept -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Fixed.Coding -> {
        encoder.encodeSerializableElement(__desc, 151, Hoisted.codeSerInner, __d.value)
      }
      is ElementDefinition.Fixed.ContactPoint -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Fixed.Count -> {
        encoder.encodeSerializableElement(__desc, 153, Hoisted.defaultValueCountSer, __d.value)
      }
      is ElementDefinition.Fixed.Distance -> {
        encoder.encodeSerializableElement(__desc, 154, Hoisted.defaultValueDistanceSer, __d.value)
      }
      is ElementDefinition.Fixed.Duration -> {
        encoder.encodeSerializableElement(__desc, 155, Hoisted.defaultValueDurationSer, __d.value)
      }
      is ElementDefinition.Fixed.HumanName -> {
        encoder.encodeSerializableElement(__desc, 156, Hoisted.defaultValueHumanNameSer, __d.value)
      }
      is ElementDefinition.Fixed.Identifier -> {
        encoder.encodeSerializableElement(__desc, 157, Hoisted.defaultValueIdentifierSer, __d.value)
      }
      is ElementDefinition.Fixed.Money -> {
        encoder.encodeSerializableElement(__desc, 158, Hoisted.defaultValueMoneySer, __d.value)
      }
      is ElementDefinition.Fixed.Period -> {
        encoder.encodeSerializableElement(__desc, 159, Hoisted.defaultValuePeriodSer, __d.value)
      }
      is ElementDefinition.Fixed.Quantity -> {
        encoder.encodeSerializableElement(__desc, 160, Hoisted.defaultValueQuantitySer, __d.value)
      }
      is ElementDefinition.Fixed.Range -> {
        encoder.encodeSerializableElement(__desc, 161, Hoisted.defaultValueRangeSer, __d.value)
      }
      is ElementDefinition.Fixed.Ratio -> {
        encoder.encodeSerializableElement(__desc, 162, Hoisted.defaultValueRatioSer, __d.value)
      }
      is ElementDefinition.Fixed.RatioRange -> {
        encoder.encodeSerializableElement(__desc, 163, Hoisted.defaultValueRatioRangeSer, __d.value)
      }
      is ElementDefinition.Fixed.Reference -> {
        encoder.encodeSerializableElement(__desc, 164, Hoisted.defaultValueReferenceSer, __d.value)
      }
      is ElementDefinition.Fixed.SampledData -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Fixed.Signature -> {
        encoder.encodeSerializableElement(__desc, 166, Hoisted.defaultValueSignatureSer, __d.value)
      }
      is ElementDefinition.Fixed.Timing -> {
        encoder.encodeSerializableElement(__desc, 167, Hoisted.defaultValueTimingSer, __d.value)
      }
      is ElementDefinition.Fixed.ContactDetail -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Fixed.Expression -> {
        encoder.encodeSerializableElement(__desc, 171, Hoisted.defaultValueExpressionSer, __d.value)
      }
      is ElementDefinition.Fixed.ParameterDefinition -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Fixed.Dosage -> {
        encoder.encodeSerializableElement(__desc, 176, Hoisted.defaultValueDosageSer, __d.value)
      }
    }
    when (val __d = value.pattern) {
      null -> {}
      is ElementDefinition.Pattern.Base64Binary -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 177, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 178, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Pattern.Boolean -> {
        ((__d.value.value))?.let { encoder.encodeBooleanElement(__desc, 179, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.Code -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 183, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.DateTime -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 187, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.Decimal -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 189, BigDecimalSerializer, it)
        }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.Integer -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 195, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.PositiveInt -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 201, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 202, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.Pattern.String -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 203, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.Time -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 205, LocalTimeSerializer, it)
        }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.UnsignedInt -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 207, it) }
        (__d.value.toElement())?.let {
      ...
      is ElementDefinition.Pattern.Address -> {
        encoder.encodeSerializableElement(__desc, 215, Hoisted.defaultValueAddressSer, __d.value)
      }
      is ElementDefinition.Pattern.Age -> {
        encoder.encodeSerializableElement(__desc, 216, Hoisted.defaultValueAgeSer, __d.value)
      }
      is ElementDefinition.Pattern.Annotation -> {
        encoder.encodeSerializableElement(__desc, 217, Hoisted.defaultValueAnnotationSer, __d.value)
      }
      is ElementDefinition.Pattern.Attachment -> {
        encoder.encodeSerializableElement(__desc, 218, Hoisted.defaultValueAttachmentSer, __d.value)
      }
      is ElementDefinition.Pattern.CodeableConcept -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Pattern.Coding -> {
        encoder.encodeSerializableElement(__desc, 221, Hoisted.codeSerInner, __d.value)
      }
      is ElementDefinition.Pattern.ContactPoint -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Pattern.Count -> {
        encoder.encodeSerializableElement(__desc, 223, Hoisted.defaultValueCountSer, __d.value)
      }
      is ElementDefinition.Pattern.Distance -> {
        encoder.encodeSerializableElement(__desc, 224, Hoisted.defaultValueDistanceSer, __d.value)
      }
      is ElementDefinition.Pattern.Duration -> {
        encoder.encodeSerializableElement(__desc, 225, Hoisted.defaultValueDurationSer, __d.value)
      }
      is ElementDefinition.Pattern.HumanName -> {
        encoder.encodeSerializableElement(__desc, 226, Hoisted.defaultValueHumanNameSer, __d.value)
      }
      is ElementDefinition.Pattern.Identifier -> {
        encoder.encodeSerializableElement(__desc, 227, Hoisted.defaultValueIdentifierSer, __d.value)
      }
      is ElementDefinition.Pattern.Money -> {
        encoder.encodeSerializableElement(__desc, 228, Hoisted.defaultValueMoneySer, __d.value)
      }
      is ElementDefinition.Pattern.Period -> {
        encoder.encodeSerializableElement(__desc, 229, Hoisted.defaultValuePeriodSer, __d.value)
      }
      is ElementDefinition.Pattern.Quantity -> {
        encoder.encodeSerializableElement(__desc, 230, Hoisted.defaultValueQuantitySer, __d.value)
      }
      is ElementDefinition.Pattern.Range -> {
        encoder.encodeSerializableElement(__desc, 231, Hoisted.defaultValueRangeSer, __d.value)
      }
      is ElementDefinition.Pattern.Ratio -> {
        encoder.encodeSerializableElement(__desc, 232, Hoisted.defaultValueRatioSer, __d.value)
      }
      is ElementDefinition.Pattern.RatioRange -> {
        encoder.encodeSerializableElement(__desc, 233, Hoisted.defaultValueRatioRangeSer, __d.value)
      }
      is ElementDefinition.Pattern.Reference -> {
        encoder.encodeSerializableElement(__desc, 234, Hoisted.defaultValueReferenceSer, __d.value)
      }
      is ElementDefinition.Pattern.SampledData -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Pattern.Signature -> {
        encoder.encodeSerializableElement(__desc, 236, Hoisted.defaultValueSignatureSer, __d.value)
      }
      is ElementDefinition.Pattern.Timing -> {
        encoder.encodeSerializableElement(__desc, 237, Hoisted.defaultValueTimingSer, __d.value)
      }
      is ElementDefinition.Pattern.ContactDetail -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Pattern.Expression -> {
        encoder.encodeSerializableElement(__desc, 241, Hoisted.defaultValueExpressionSer, __d.value)
      }
      is ElementDefinition.Pattern.ParameterDefinition -> {
        encoder.encodeSerializableElement(
          __desc,
      ...
      is ElementDefinition.Pattern.Dosage -> {
        encoder.encodeSerializableElement(__desc, 246, Hoisted.defaultValueDosageSer, __d.value)
      }
    }
    if (value.example.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 247, Hoisted.exampleSer, value.example)
    when (val __d = value.minValue) {
      null -> {}
      is ElementDefinition.MinValue.Date -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 248, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 249, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.DateTime -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 250, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 251, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.Instant -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 252, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 253, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.Time -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 254, LocalTimeSerializer, it)
        }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 255, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.Decimal -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 256, BigDecimalSerializer, it)
        }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 257, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.Integer -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 258, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 259, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.PositiveInt -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 260, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 261, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.UnsignedInt -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 262, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 263, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MinValue.Quantity -> {
        encoder.encodeSerializableElement(__desc, 264, Hoisted.defaultValueQuantitySer, __d.value)
      }
    }
    when (val __d = value.maxValue) {
      null -> {}
      is ElementDefinition.MaxValue.Date -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 265, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 266, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.DateTime -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 267, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 268, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.Instant -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 269, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 270, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.Time -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 271, LocalTimeSerializer, it)
        }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 272, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.Decimal -> {
        ((__d.value.value))?.let {
          encoder.encodeSerializableElement(__desc, 273, BigDecimalSerializer, it)
        }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 274, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.Integer -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 275, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 276, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.PositiveInt -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 277, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 278, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.UnsignedInt -> {
        ((__d.value.value))?.let { encoder.encodeIntElement(__desc, 279, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 280, Hoisted.pathSer, it)
        }
      }
      is ElementDefinition.MaxValue.Quantity -> {
        encoder.encodeSerializableElement(__desc, 281, Hoisted.defaultValueQuantitySer, __d.value)
      }
    }
    ((value.maxLength?.value))?.let { encoder.encodeIntElement(__desc, 282, it) }
    (value.maxLength?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 283, Hoisted.pathSer, it)
    }
    (value.condition.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 284, Hoisted.representationSer, it)
    }
    (value.condition.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 285, Hoisted.representationSer2, it)
    }
    if (value.constraint.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 286, Hoisted.constraintSer, value.constraint)
    ((value.mustSupport?.value))?.let { encoder.encodeBooleanElement(__desc, 287, it) }
    (value.mustSupport?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 288, Hoisted.pathSer, it)
    }
    ((value.isModifier?.value))?.let { encoder.encodeBooleanElement(__desc, 289, it) }
    (value.isModifier?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 290, Hoisted.pathSer, it)
    }
    ((value.isModifierReason?.value))?.let { encoder.encodeStringElement(__desc, 291, it) }
    (value.isModifierReason?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 292, Hoisted.pathSer, it)
    }
    ((value.isSummary?.value))?.let { encoder.encodeBooleanElement(__desc, 293, it) }
    (value.isSummary?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 294, Hoisted.pathSer, it)
    }
    (value.binding)?.let { encoder.encodeSerializableElement(__desc, 295, Hoisted.bindingSer, it) }
    if (value.mapping.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 296, Hoisted.mappingSer, value.mapping)
  }
