...
public sealed class RelatedPersonSearchParam<T> : SearchParam {
  ...
  public data object AddressCity : RelatedPersonSearchParam<R5String>() {
  ...
  public data object AddressCountry : RelatedPersonSearchParam<R5String>() {
  ...
  public data object AddressPostalcode : RelatedPersonSearchParam<R5String>() {
  ...
  public data object AddressState : RelatedPersonSearchParam<R5String>() {
  ...
  public data object Family : RelatedPersonSearchParam<R5String>() {
  ...
  public data object Given : RelatedPersonSearchParam<R5String>() {
