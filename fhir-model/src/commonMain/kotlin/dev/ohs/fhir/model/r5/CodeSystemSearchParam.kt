...
public sealed class CodeSystemSearchParam<T> : SearchParam {
  ...
  public data object ContextQuantity : CodeSystemSearchParam<Any>() {
    ...
    public override val expression: kotlin.String = "(CodeSystem.useContext.value.ofType(Quantity))"
  ...
  public data object Effective : CodeSystemSearchParam<Period>() {
    ...
    public override val expression: kotlin.String = "CodeSystem.effectivePeriod"

    public override val target: List<kotlin.String> = emptyList()

    public override fun extract(resource: CodeSystem): List<Period> =
  ...
  public data object Identifier : CodeSystemSearchParam<dev.ohs.fhir.model.r5.Identifier>() {
    ...
    public override fun extract(resource: CodeSystem): List<dev.ohs.fhir.model.r5.Identifier> =
      resource.identifier
  }
  ...
  public data object Topic : CodeSystemSearchParam<CodeableConcept>() {
    ...
    public override val expression: kotlin.String = "CodeSystem.topic"
