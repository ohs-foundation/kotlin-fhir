...
internal object ResearchElementDefinitionSubjectSerializer :
  KSerializer<ResearchElementDefinition.Subject> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ResearchElementDefinition.Subject") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ResearchElementDefinition.Subject {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ResearchElementDefinition.Subject: " + __i
          )
      }
    }
    return ResearchElementDefinition.Subject.from(subjectCodeableConcept, subjectReference)!!
  }
...
internal object ResearchElementDefinitionCharacteristicDefinitionSerializer :
  KSerializer<ResearchElementDefinition.Characteristic.Definition> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ResearchElementDefinition.Characteristic.Definition") {
      element(
        "definitionCodeableConcept",
        CodeableConcept.serializer().descriptor,
        isOptional = true,
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is ResearchElementDefinition.Characteristic.Definition.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.definitionCodeableConceptSer, __d.value)
        }
        is ResearchElementDefinition.Characteristic.Definition.Canonical -> {
        ...
        is ResearchElementDefinition.Characteristic.Definition.Expression -> {
          encodeSerializableElement(__desc, 3, Hoisted.definitionExpressionSer, __d.value)
        }
        is ResearchElementDefinition.Characteristic.Definition.DataRequirement -> {
          encodeSerializableElement(__desc, 4, Hoisted.definitionDataRequirementSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 -> definitionCanonical = decoder.decodeStringElement(__desc, 1)
        2 ->
          _definitionCanonical =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ResearchElementDefinition.Characteristic.Definition: " + __i
          )
      }
    }
    return ResearchElementDefinition.Characteristic.Definition.from(
      definitionCodeableConcept,
      Canonical.of(definitionCanonical, _definitionCanonical),
      definitionExpression,
      definitionDataRequirement,
...
internal object ResearchElementDefinitionCharacteristicStudyEffectiveSerializer :
  KSerializer<ResearchElementDefinition.Characteristic.StudyEffective> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ResearchElementDefinition.Characteristic.StudyEffective") {
      element("studyEffectiveDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_studyEffectiveDateTime", Element.serializer().descriptor, isOptional = true)
      element("studyEffectivePeriod", Period.serializer().descriptor, isOptional = true)
      element("studyEffectiveDuration", Duration.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ResearchElementDefinition.Characteristic.StudyEffective.Period -> {
          encodeSerializableElement(__desc, 2, Hoisted.studyEffectivePeriodSer, __d.value)
        }
        is ResearchElementDefinition.Characteristic.StudyEffective.Duration -> {
          encodeSerializableElement(__desc, 3, Hoisted.studyEffectiveDurationSer, __d.value)
        }
        is ResearchElementDefinition.Characteristic.StudyEffective.Timing -> {
          encodeSerializableElement(__desc, 4, Hoisted.studyEffectiveTimingSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> studyEffectiveDateTime = decoder.decodeStringElement(__desc, 0)
        1 ->
          _studyEffectiveDateTime =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ResearchElementDefinition.Characteristic.StudyEffective: " +
              __i
          )
      }
    }
    return ResearchElementDefinition.Characteristic.StudyEffective.from(
      DateTime.of(FhirDateTime.fromString(studyEffectiveDateTime), _studyEffectiveDateTime),
      studyEffectivePeriod,
      studyEffectiveDuration,
      studyEffectiveTiming,
...
internal object ResearchElementDefinitionCharacteristicParticipantEffectiveSerializer :
  KSerializer<ResearchElementDefinition.Characteristic.ParticipantEffective> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ResearchElementDefinition.Characteristic.ParticipantEffective") {
      element(
        "participantEffectiveDateTime",
        KotlinString.serializer().descriptor,
        isOptional = true,
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ResearchElementDefinition.Characteristic.ParticipantEffective.Period -> {
          encodeSerializableElement(__desc, 2, Hoisted.participantEffectivePeriodSer, __d.value)
        }
        is ResearchElementDefinition.Characteristic.ParticipantEffective.Duration -> {
          encodeSerializableElement(__desc, 3, Hoisted.participantEffectiveDurationSer, __d.value)
        }
        is ResearchElementDefinition.Characteristic.ParticipantEffective.Timing -> {
          encodeSerializableElement(__desc, 4, Hoisted.participantEffectiveTimingSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> participantEffectiveDateTime = decoder.decodeStringElement(__desc, 0)
        1 ->
          _participantEffectiveDateTime =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ResearchElementDefinition.Characteristic.ParticipantEffective: " +
              __i
          )
      }
    }
    return ResearchElementDefinition.Characteristic.ParticipantEffective.from(
      DateTime.of(
        FhirDateTime.fromString(participantEffectiveDateTime),
        _participantEffectiveDateTime,
      ),
