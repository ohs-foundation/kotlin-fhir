...
public object GenomicStudySearchParam {
  ...
  public data object Focus : SearchParam<GenomicStudy, Reference> {
    ...
    public override val expression: String = "GenomicStudy.analysis.focus"
    ...
    public override fun extract(resource: GenomicStudy): CollectionsList<Reference> =
  ...
  public data object Identifier : SearchParam<GenomicStudy, dev.ohs.fhir.model.r5.Identifier> {
    ...
    public override val expression: String = "GenomicStudy.identifier"
  ...
  public data object Patient : SearchParam<GenomicStudy, Reference> {
    ...
    public override val expression: String = "GenomicStudy.subject.where(resolve() is Patient)"
  ...
  public data object Status : SearchParam<GenomicStudy, Any> {
    ...
    public override val expression: String = "GenomicStudy.status"

    public override val target: CollectionsList<KClass<out Resource>> = emptyList()

    public override fun extract(resource: GenomicStudy): CollectionsList<Any> =
  ...
  public data object Subject : SearchParam<GenomicStudy, Reference> {
    ...
    public override val expression: String = "GenomicStudy.subject"
