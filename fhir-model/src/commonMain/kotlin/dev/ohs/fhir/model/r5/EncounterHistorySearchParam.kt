...
public sealed class EncounterHistorySearchParam<T> : SearchParam {
  ...
  public data object Encounter : EncounterHistorySearchParam<Any>() {
    ...
    public override fun extract(resource: EncounterHistory): List<Any> = emptyList()
  }

  public data object Identifier : EncounterHistorySearchParam<Any>() {
  ...
  public data object Patient : EncounterHistorySearchParam<Any>() {
  ...
  public data object Subject : EncounterHistorySearchParam<Any>() {
