...
internal object AllergyIntoleranceSerializer : KSerializer<AllergyIntolerance> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        16 -> criticality = decoder.decodeStringElement(__desc, __i)
        17 ->
          _criticality =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        18 ->
        ...
        21 -> onsetDateTime = decoder.decodeStringElement(__desc, __i)
        22 ->
          _onsetDateTime =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        23 ->
        ...
        26 -> onsetString = decoder.decodeStringElement(__desc, __i)
        27 ->
          _onsetString =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        28 -> recordedDate = decoder.decodeStringElement(__desc, __i)
        29 ->
          _recordedDate =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        30 ->
        ...
        31 -> lastOccurrence = decoder.decodeStringElement(__desc, __i)
        32 ->
          _lastOccurrence =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
  ...
  internal fun serializeJson(
    ...
    (value.type)?.let {
      encoder.encodeSerializableElement(__desc, 13 + __off, Hoisted.clinicalStatusSer, it)
    }
    (value.category.map { it.value?.getCode() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 14 + __off, Hoisted.categorySer, it)
    }
    (value.category.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 15 + __off, Hoisted.categorySer2, it)
    }
    ...
    (value.code)?.let {
      encoder.encodeSerializableElement(__desc, 18 + __off, Hoisted.clinicalStatusSer, it)
    }
    (value.patient)?.let {
    ...
    when (val __d = value.onset) {
      ...
      is AllergyIntolerance.Onset.Age -> {
        encoder.encodeSerializableElement(__desc, 23 + __off, Hoisted.onsetAgeSer, __d.value)
      }
      is AllergyIntolerance.Onset.Period -> {
        encoder.encodeSerializableElement(__desc, 24 + __off, Hoisted.onsetPeriodSer, __d.value)
      }
      is AllergyIntolerance.Onset.Range -> {
        encoder.encodeSerializableElement(__desc, 25 + __off, Hoisted.onsetRangeSer, __d.value)
      }
      is AllergyIntolerance.Onset.String -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 26 + __off, it) }
        (__d.value.toElement())?.let {
    ...
    if (value.reaction.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 34 + __off, Hoisted.reactionSer, value.reaction)
  }
