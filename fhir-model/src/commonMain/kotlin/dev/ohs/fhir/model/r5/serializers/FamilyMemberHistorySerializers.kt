...
internal object FamilyMemberHistoryBornSerializer : KSerializer<FamilyMemberHistory.Born> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("FamilyMemberHistory.Born") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is FamilyMemberHistory.Born.Period -> {
          encodeSerializableElement(__desc, 0, Hoisted.bornPeriodSer, __d.value)
        }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): FamilyMemberHistory.Born {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          bornPeriod =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.bornPeriodSer, null)
        1 -> bornDate = decoder.decodeStringElement(__desc, 1)
        2 ->
          _bornDate = decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.elementSer, null)
        3 -> bornString = decoder.decodeStringElement(__desc, 3)
        4 ->
          _bornString =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding FamilyMemberHistory.Born: " + __i)
      }
    }
    return FamilyMemberHistory.Born.from(
      bornPeriod,
...
internal object FamilyMemberHistoryAgeSerializer : KSerializer<FamilyMemberHistory.Age> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("FamilyMemberHistory.Age") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is FamilyMemberHistory.Age.Age -> {
          encodeSerializableElement(__desc, 0, Hoisted.ageAgeSer, __d.value)
        }
        is FamilyMemberHistory.Age.Range -> {
          encodeSerializableElement(__desc, 1, Hoisted.ageRangeSer, __d.value)
        }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): FamilyMemberHistory.Age {
    val __desc = descriptor
    var ageAge: Age? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> ageAge = decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.ageAgeSer, null)
        1 ->
          ageRange = decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.ageRangeSer, null)
        2 -> ageString = decoder.decodeStringElement(__desc, 2)
        3 ->
          _ageString =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding FamilyMemberHistory.Age: " + __i)
      }
    }
    return FamilyMemberHistory.Age.from(ageAge, ageRange, R5String.of(ageString, _ageString))!!
  }
...
internal object FamilyMemberHistoryDeceasedSerializer : KSerializer<FamilyMemberHistory.Deceased> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("FamilyMemberHistory.Deceased") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is FamilyMemberHistory.Deceased.Age -> {
          encodeSerializableElement(__desc, 2, Hoisted.deceasedAgeSer, __d.value)
        }
        is FamilyMemberHistory.Deceased.Range -> {
          encodeSerializableElement(__desc, 3, Hoisted.deceasedRangeSer, __d.value)
        }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): FamilyMemberHistory.Deceased {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          deceasedAge =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.deceasedAgeSer, null)
        3 ->
          deceasedRange =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.deceasedRangeSer, null)
        4 -> deceasedDate = decoder.decodeStringElement(__desc, 4)
        5 ->
          _deceasedDate =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.elementSer, null)
        6 -> deceasedString = decoder.decodeStringElement(__desc, 6)
        7 ->
          _deceasedString =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding FamilyMemberHistory.Deceased: " + __i
          )
      }
    }
    return FamilyMemberHistory.Deceased.from(
  ...
  private object Hoisted {
    ...
    public val deceasedAgeSer: KSerializer<Age> = Age.serializer()

    public val deceasedRangeSer: KSerializer<Range> = Range.serializer()
  }
}

internal object FamilyMemberHistoryConditionOnsetSerializer :
  KSerializer<FamilyMemberHistory.Condition.Onset> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("FamilyMemberHistory.Condition.Onset") {
      element("onsetAge", Age.serializer().descriptor, isOptional = true)
      element("onsetRange", Range.serializer().descriptor, isOptional = true)
      element("onsetPeriod", Period.serializer().descriptor, isOptional = true)
      element("onsetString", KotlinString.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: FamilyMemberHistory.Condition.Onset) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is FamilyMemberHistory.Condition.Onset.Age -> {
          encodeSerializableElement(__desc, 0, Hoisted.onsetAgeSer, __d.value)
        }
        is FamilyMemberHistory.Condition.Onset.Range -> {
          encodeSerializableElement(__desc, 1, Hoisted.onsetRangeSer, __d.value)
        }
        is FamilyMemberHistory.Condition.Onset.Period -> {
          encodeSerializableElement(__desc, 2, Hoisted.onsetPeriodSer, __d.value)
        }
        is FamilyMemberHistory.Condition.Onset.String -> {
          ((__d.value.value))?.let { encodeStringElement(__desc, 3, it) }
          (__d.value.toElement())?.let {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): FamilyMemberHistory.Condition.Onset {
    val __desc = descriptor
    var onsetAge: Age? = null
    var onsetRange: Range? = null
    var onsetPeriod: Period? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          onsetAge = decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.onsetAgeSer, null)
        1 ->
          onsetRange =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.onsetRangeSer, null)
        2 ->
          onsetPeriod =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.onsetPeriodSer, null)
        3 -> onsetString = decoder.decodeStringElement(__desc, 3)
        4 ->
          _onsetString =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding FamilyMemberHistory.Condition.Onset: " + __i
          )
      }
    }
    return FamilyMemberHistory.Condition.Onset.from(
      onsetAge,
      onsetRange,
      onsetPeriod,
      R5String.of(onsetString, _onsetString),
...
internal object FamilyMemberHistoryProcedurePerformedSerializer :
  KSerializer<FamilyMemberHistory.Procedure.Performed> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("FamilyMemberHistory.Procedure.Performed") {
      element("performedAge", Age.serializer().descriptor, isOptional = true)
      element("performedRange", Range.serializer().descriptor, isOptional = true)
      element("performedPeriod", Period.serializer().descriptor, isOptional = true)
      element("performedString", KotlinString.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: FamilyMemberHistory.Procedure.Performed) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is FamilyMemberHistory.Procedure.Performed.Age -> {
          encodeSerializableElement(__desc, 0, Hoisted.performedAgeSer, __d.value)
        }
        is FamilyMemberHistory.Procedure.Performed.Range -> {
          encodeSerializableElement(__desc, 1, Hoisted.performedRangeSer, __d.value)
        }
        is FamilyMemberHistory.Procedure.Performed.Period -> {
          encodeSerializableElement(__desc, 2, Hoisted.performedPeriodSer, __d.value)
        }
        is FamilyMemberHistory.Procedure.Performed.String -> {
          ((__d.value.value))?.let { encodeStringElement(__desc, 3, it) }
          (__d.value.toElement())?.let {
        ...
        is FamilyMemberHistory.Procedure.Performed.DateTime -> {
          ((__d.value.value?.toString()))?.let { encodeStringElement(__desc, 5, it) }
          (__d.value.toElement())?.let {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): FamilyMemberHistory.Procedure.Performed {
    val __desc = descriptor
    var performedAge: Age? = null
    var performedRange: Range? = null
    var performedPeriod: Period? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          performedAge =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.performedAgeSer, null)
        1 ->
          performedRange =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.performedRangeSer, null)
        2 ->
          performedPeriod =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.performedPeriodSer, null)
        3 -> performedString = decoder.decodeStringElement(__desc, 3)
        4 ->
          _performedString =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.elementSer, null)
        5 -> performedDateTime = decoder.decodeStringElement(__desc, 5)
        6 ->
          _performedDateTime =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding FamilyMemberHistory.Procedure.Performed: " + __i
          )
      }
    }
    return FamilyMemberHistory.Procedure.Performed.from(
      performedAge,
      performedRange,
      performedPeriod,
      R5String.of(performedString, _performedString),
