...
public object ImplementationGuideSearchParams {
  public val context: SearchParam<ImplementationGuide, Any> =
    SearchParam(
      ...
      expression = "(ImplementationGuide.useContext.value.ofType(CodeableConcept))",
      extractor = {
        throw NotImplementedError(
          "Search parameter 'context' has expression '(ImplementationGuide.useContext.value.ofType(CodeableConcept))' which is not yet supported."
        )
      },
    )
  ...
  public val contextQuantity: SearchParam<ImplementationGuide, Any> =
    SearchParam(
      ...
      expression = "(ImplementationGuide.useContext.value.ofType(Quantity))",
      extractor = {
        throw NotImplementedError(
          "Search parameter 'context-quantity' has expression '(ImplementationGuide.useContext.value.ofType(Quantity))' which is not yet supported."
        )
      },
    )
  ...
  public val identifier: SearchParam<ImplementationGuide, Identifier> =
    SearchParam(
      name = "identifier",
      type = SearchParamType.Token,
      expression = "ImplementationGuide.identifier",
   ...
   * excluded from [all].
   */
  public val unsupported: CollectionsList<SearchParam<ImplementationGuide, *>> =
