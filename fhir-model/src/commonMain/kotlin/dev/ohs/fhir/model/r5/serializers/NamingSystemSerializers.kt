...
internal object NamingSystemVersionAlgorithmSerializer :
  KSerializer<NamingSystem.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("NamingSystem.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): NamingSystem.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding NamingSystem.VersionAlgorithm: " + __i
          )
      }
    }
    return NamingSystem.VersionAlgorithm.from(
...
internal object NamingSystemSerializer : KSerializer<NamingSystem> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("NamingSystem") {
      ...
      element("responsible", KotlinString.serializer().descriptor, isOptional = true)
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: NamingSystem) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "NamingSystem")
