...
internal object CanonicalSerializer : KSerializer<Canonical> {
  ...
  override fun deserialize(decoder: Decoder): Canonical =
    decoder.decodeStructure(descriptor) {
      ...
      Canonical(id = id, extension = extension, `value` = `value`)
    }
}
