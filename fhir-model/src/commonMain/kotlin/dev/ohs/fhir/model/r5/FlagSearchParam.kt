...
public sealed class FlagSearchParam<T> : SearchParam {
  ...
  public data object Author : FlagSearchParam<Any>() {
    ...
    public override fun extract(resource: Flag): List<Any> = emptyList()
  }

  public data object Category : FlagSearchParam<Any>() {
  ...
  public data object Date : FlagSearchParam<Any>() {
  ...
  public data object Encounter : FlagSearchParam<Any>() {
  ...
  public data object Identifier : FlagSearchParam<Any>() {
  ...
  public data object Patient : FlagSearchParam<Any>() {
  ...
  public data object Subject : FlagSearchParam<Any>() {
