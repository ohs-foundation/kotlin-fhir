...
public sealed class SubscriptionTopicSearchParam<T> : SearchParam {
  ...
  public data object Effective : SubscriptionTopicSearchParam<Any>() {
    public override val paramName: String = "effective"

    public override val type: SearchParamType = SearchParamType.fromCode("date")

    public override val expression: String = "SubscriptionTopic.effectivePeriod"
  ...
  public data object Event : SubscriptionTopicSearchParam<Any>() {
    public override val paramName: String = "event"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "SubscriptionTopic.eventTrigger.event"
