...
internal object AgeSerializer : KSerializer<Age> {
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Age {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        else -> throw SerializationException("Unexpected index decoding Age: " + __i)
      }
    }
    return Age(
      id = id,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Age) {
    val __desc = descriptor
