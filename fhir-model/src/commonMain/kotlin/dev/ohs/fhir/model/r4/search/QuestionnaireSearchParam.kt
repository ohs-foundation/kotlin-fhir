...
public sealed class QuestionnaireSearchParam<T> : SearchParam {
  ...
  public data object Identifier : QuestionnaireSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
  ...
  public data object Name : QuestionnaireSearchParam<R4String>() {
  ...
  public data object Publisher : QuestionnaireSearchParam<R4String>() {
  ...
  public data object Title : QuestionnaireSearchParam<R4String>() {
  ...
  public data object Version : QuestionnaireSearchParam<R4String>() {
