...
internal object CommunicationPayloadContentSerializer : KSerializer<Communication.Payload.Content> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Communication.Payload.Content") {
      element("contentAttachment", Attachment.serializer().descriptor, isOptional = true)
      element("contentReference", Reference.serializer().descriptor, isOptional = true)
      element("contentCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Communication.Payload.Content {
    val __desc = descriptor
    var contentAttachment: Attachment? = null
    var contentReference: Reference? = null
    var contentCodeableConcept: CodeableConcept? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Communication.Payload.Content: " + __i
          )
      }
    }
    return Communication.Payload.Content.from(
      contentAttachment,
      contentReference,
      contentCodeableConcept,
    )!!
...
internal object CommunicationSerializer : KSerializer<Communication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Communication") {
      ...
      element("sent", String.serializer().descriptor, isOptional = true)
      element("_sent", Element.serializer().descriptor, isOptional = true)
      element("received", String.serializer().descriptor, isOptional = true)
