...
public data class ConceptMap(
  ...
  public sealed interface Source {
    ...
    @JvmInline public value class Uri(public val `value`: dev.ohs.fhir.model.r4b.Uri) : Source

    @JvmInline
    public value class Canonical(public val `value`: dev.ohs.fhir.model.r4b.Canonical) : Source
  ...
  public sealed interface Target {
    ...
    @JvmInline
    public value class Canonical(public val `value`: dev.ohs.fhir.model.r4b.Canonical) : Target
