...
public sealed class PaymentReconciliationSearchParam<T> : SearchParam {
  ...
  public data object AllocationAccount : PaymentReconciliationSearchParam<Reference>() {
    public override val paramName: kotlin.String = "allocation-account"

    public override val type: SearchParamType = SearchParamType.fromCode("reference")

    public override val expression: kotlin.String = "PaymentReconciliation.allocation.account"
  ...
  public data object AllocationEncounter : PaymentReconciliationSearchParam<Reference>() {
    public override val paramName: kotlin.String = "allocation-encounter"

    public override val type: SearchParamType = SearchParamType.fromCode("reference")

    public override val expression: kotlin.String = "PaymentReconciliation.allocation.encounter"
