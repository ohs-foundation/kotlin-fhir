...
internal object MessageDefinitionSerializer : KSerializer<MessageDefinition> {
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        42 ->
          _copyrightLabel =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        43 -> base = decoder.decodeStringElement(__desc, __i)
        44 ->
          _base =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        45 ->
        ...
        48 -> eventUri = decoder.decodeStringElement(__desc, __i)
        49 ->
          _eventUri =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        50 -> category = decoder.decodeStringElement(__desc, __i)
        51 ->
          _category =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        52 -> focus = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.focusSer, null)
        53 -> responseRequired = decoder.decodeStringElement(__desc, __i)
        54 ->
          _responseRequired =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        55 ->
        ...
        56 -> graph = decoder.decodeStringElement(__desc, __i)
        57 ->
          _graph =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
  ...
  internal fun serializeJson(
    ...
    (value.replaces.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 22 + __off, Hoisted.replacesSer, it)
    }
    (value.replaces.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 23 + __off, Hoisted.replacesSer2, it)
    }
    ...
    ((value.base?.value))?.let { encoder.encodeStringElement(__desc, 43 + __off, it) }
    ...
    (value.parent.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 45 + __off, Hoisted.replacesSer, it)
    }
    (value.parent.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 46 + __off, Hoisted.replacesSer2, it)
    }
    when (val __d = value.event) {
      ...
      is MessageDefinition.Event.Uri -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 48 + __off, it) }
        (__d.value.toElement())?.let {
    ...
    if (value.focus.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 52 + __off, Hoisted.focusSer, value.focus)
    ((value.responseRequired?.value?.getCode()))?.let {
      encoder.encodeStringElement(__desc, 53 + __off, it)
    }
    ...
    ((value.graph?.value))?.let { encoder.encodeStringElement(__desc, 56 + __off, it) }
