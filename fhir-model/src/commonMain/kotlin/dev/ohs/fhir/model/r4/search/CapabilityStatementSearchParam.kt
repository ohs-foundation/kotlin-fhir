...
public sealed class CapabilityStatementSearchParam<T> : SearchParam {
  ...
  public data object Fhirversion : CapabilityStatementSearchParam<R4String>() {
  ...
  public data object Name : CapabilityStatementSearchParam<R4String>() {
  ...
  public data object Publisher : CapabilityStatementSearchParam<R4String>() {
  ...
  public data object Software : CapabilityStatementSearchParam<R4String>() {
  ...
  public data object Title : CapabilityStatementSearchParam<R4String>() {
  ...
  public data object Version : CapabilityStatementSearchParam<R4String>() {
