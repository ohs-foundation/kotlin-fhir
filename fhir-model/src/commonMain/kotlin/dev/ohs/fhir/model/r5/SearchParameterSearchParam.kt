...
public sealed class SearchParameterSearchParam<T> : SearchParam {
  ...
  public data object ContextQuantity : SearchParameterSearchParam<Any>() {
    ...
    public override val expression: String = "(SearchParameter.useContext.value.ofType(Quantity))"
  ...
  public data object Identifier : SearchParameterSearchParam<Any>() {
    public override val paramName: String = "identifier"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "SearchParameter.identifier"
