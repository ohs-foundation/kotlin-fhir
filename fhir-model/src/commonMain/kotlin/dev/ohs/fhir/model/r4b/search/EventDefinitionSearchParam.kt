...
public object EventDefinitionSearchParam {
  ...
  public data object ContextQuantity : SearchParam<EventDefinition, Quantity> {
    ...
    public override fun extract(resource: EventDefinition): CollectionsList<Quantity> =
  ...
  public data object Name : SearchParam<EventDefinition, R4bString> {
    ...
    public override fun extract(resource: EventDefinition): CollectionsList<R4bString> =
