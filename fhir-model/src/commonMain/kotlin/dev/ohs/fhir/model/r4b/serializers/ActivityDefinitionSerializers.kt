...
internal object ActivityDefinitionSerializer : KSerializer<ActivityDefinition> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ActivityDefinition {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        28 -> subjectCanonical = decoder.decodeStringElement(__desc, 28)
        29 ->
          _subjectCanonical =
        ...
        38 ->
          jurisdiction =
            decoder.decodeNullableSerializableElement(__desc, 38, Hoisted.jurisdictionSer, null)
        39 -> purpose = decoder.decodeStringElement(__desc, 39)
        40 ->
          _purpose =
            decoder.decodeNullableSerializableElement(__desc, 40, Hoisted.implicitRulesSer, null)
        41 -> usage = decoder.decodeStringElement(__desc, 41)
        42 ->
          _usage =
        ...
        45 -> approvalDate = decoder.decodeStringElement(__desc, 45)
        46 ->
          _approvalDate =
            decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.implicitRulesSer, null)
        47 -> lastReviewDate = decoder.decodeStringElement(__desc, 47)
        48 ->
          _lastReviewDate =
        ...
        50 ->
          topic =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.jurisdictionSer, null)
        51 ->
          author = decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.contactSer, null)
        52 ->
          editor = decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.contactSer, null)
        53 ->
          reviewer = decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.contactSer, null)
        54 ->
          endorser = decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.contactSer, null)
        55 ->
          relatedArtifact =
            decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.relatedArtifactSer, null)
        56 ->
          library = decoder.decodeNullableSerializableElement(__desc, 56, Hoisted.librarySer, null)
        57 ->
          _library =
            decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.librarySer2, null)
        58 -> kind = decoder.decodeStringElement(__desc, 58)
        59 ->
          _kind =
            decoder.decodeNullableSerializableElement(__desc, 59, Hoisted.implicitRulesSer, null)
        60 -> profile = decoder.decodeStringElement(__desc, 60)
        61 ->
          _profile =
        ...
        63 -> intent = decoder.decodeStringElement(__desc, 63)
        64 ->
          _intent =
            decoder.decodeNullableSerializableElement(__desc, 64, Hoisted.implicitRulesSer, null)
        65 -> priority = decoder.decodeStringElement(__desc, 65)
        66 ->
          _priority =
            decoder.decodeNullableSerializableElement(__desc, 66, Hoisted.implicitRulesSer, null)
        67 -> doNotPerform = decoder.decodeBooleanElement(__desc, 67)
        68 ->
          _doNotPerform =
            decoder.decodeNullableSerializableElement(__desc, 68, Hoisted.implicitRulesSer, null)
        69 ->
          timingTiming =
            decoder.decodeNullableSerializableElement(__desc, 69, Hoisted.timingTimingSer, null)
        70 -> timingDateTime = decoder.decodeStringElement(__desc, 70)
        71 ->
          _timingDateTime =
            decoder.decodeNullableSerializableElement(__desc, 71, Hoisted.implicitRulesSer, null)
        72 ->
          timingAge =
            decoder.decodeNullableSerializableElement(__desc, 72, Hoisted.timingAgeSer, null)
        73 ->
          timingPeriod =
            decoder.decodeNullableSerializableElement(__desc, 73, Hoisted.effectivePeriodSer, null)
        74 ->
          timingRange =
            decoder.decodeNullableSerializableElement(__desc, 74, Hoisted.timingRangeSer, null)
        75 ->
          timingDuration =
            decoder.decodeNullableSerializableElement(__desc, 75, Hoisted.timingDurationSer, null)
        76 ->
          location =
            decoder.decodeNullableSerializableElement(__desc, 76, Hoisted.subjectReferenceSer, null)
        77 ->
          participant =
            decoder.decodeNullableSerializableElement(__desc, 77, Hoisted.participantSer, null)
        78 ->
          productReference =
            decoder.decodeNullableSerializableElement(__desc, 78, Hoisted.subjectReferenceSer, null)
        79 ->
        ...
        80 ->
          quantity =
            decoder.decodeNullableSerializableElement(__desc, 80, Hoisted.quantitySer, null)
        81 ->
          dosage = decoder.decodeNullableSerializableElement(__desc, 81, Hoisted.dosageSer, null)
        82 ->
          bodySite =
            decoder.decodeNullableSerializableElement(__desc, 82, Hoisted.jurisdictionSer, null)
        83 ->
          specimenRequirement =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        86 -> transform = decoder.decodeStringElement(__desc, 86)
        87 ->
          _transform =
            decoder.decodeNullableSerializableElement(__desc, 87, Hoisted.implicitRulesSer, null)
        88 ->
          dynamicValue =
            decoder.decodeNullableSerializableElement(__desc, 88, Hoisted.dynamicValueSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  internal fun serializeJson(encoder: CompositeEncoder, `value`: ActivityDefinition) {
    val __desc = descriptor
    ...
    if (value.jurisdiction.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 38, Hoisted.jurisdictionSer, value.jurisdiction)
    ((value.purpose?.value))?.let { encoder.encodeStringElement(__desc, 39, it) }
    (value.purpose?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 40, Hoisted.implicitRulesSer, it)
    }
    ((value.usage?.value))?.let { encoder.encodeStringElement(__desc, 41, it) }
    ...
    ((value.approvalDate?.value?.toString()))?.let { encoder.encodeStringElement(__desc, 45, it) }
    (value.approvalDate?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 46, Hoisted.implicitRulesSer, it)
    }
    ((value.lastReviewDate?.value?.toString()))?.let { encoder.encodeStringElement(__desc, 47, it) }
    (value.lastReviewDate?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 48, Hoisted.implicitRulesSer, it)
    }
    (value.effectivePeriod)?.let {
      encoder.encodeSerializableElement(__desc, 49, Hoisted.effectivePeriodSer, it)
    }
    if (value.topic.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 50, Hoisted.jurisdictionSer, value.topic)
    if (value.author.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 51, Hoisted.contactSer, value.author)
    if (value.editor.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 52, Hoisted.contactSer, value.editor)
    if (value.reviewer.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 53, Hoisted.contactSer, value.reviewer)
    if (value.endorser.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 54, Hoisted.contactSer, value.endorser)
    ...
    (value.library.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 56, Hoisted.librarySer, it)
    }
    (value.library.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 57, Hoisted.librarySer2, it)
    }
    ((value.kind?.value?.getCode()))?.let { encoder.encodeStringElement(__desc, 58, it) }
    (value.kind?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 59, Hoisted.implicitRulesSer, it)
    }
    ((value.profile?.value))?.let { encoder.encodeStringElement(__desc, 60, it) }
    (value.profile?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 61, Hoisted.implicitRulesSer, it)
    }
    (value.code)?.let {
      encoder.encodeSerializableElement(__desc, 62, Hoisted.subjectCodeableConceptSer, it)
    }
    ((value.intent?.value?.getCode()))?.let { encoder.encodeStringElement(__desc, 63, it) }
    (value.intent?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 64, Hoisted.implicitRulesSer, it)
    }
    ((value.priority?.value?.getCode()))?.let { encoder.encodeStringElement(__desc, 65, it) }
    (value.priority?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 66, Hoisted.implicitRulesSer, it)
    }
    ((value.doNotPerform?.value))?.let { encoder.encodeBooleanElement(__desc, 67, it) }
    ...
    when (val __d = value.timing) {
      ...
      is ActivityDefinition.Timing.Timing -> {
        encoder.encodeSerializableElement(__desc, 69, Hoisted.timingTimingSer, __d.value)
      }
      is ActivityDefinition.Timing.DateTime -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(__desc, 70, it) }
        (__d.value.toElement())?.let {
          encoder.encodeSerializableElement(__desc, 71, Hoisted.implicitRulesSer, it)
        }
      }
      is ActivityDefinition.Timing.Age -> {
        encoder.encodeSerializableElement(__desc, 72, Hoisted.timingAgeSer, __d.value)
      }
      is ActivityDefinition.Timing.Period -> {
        encoder.encodeSerializableElement(__desc, 73, Hoisted.effectivePeriodSer, __d.value)
      }
      is ActivityDefinition.Timing.Range -> {
        encoder.encodeSerializableElement(__desc, 74, Hoisted.timingRangeSer, __d.value)
      }
      is ActivityDefinition.Timing.Duration -> {
        encoder.encodeSerializableElement(__desc, 75, Hoisted.timingDurationSer, __d.value)
      }
    }
    (value.location)?.let {
      encoder.encodeSerializableElement(__desc, 76, Hoisted.subjectReferenceSer, it)
    }
    if (value.participant.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 77, Hoisted.participantSer, value.participant)
    when (val __d = value.product) {
      null -> {}
      is ActivityDefinition.Product.Reference -> {
        encoder.encodeSerializableElement(__desc, 78, Hoisted.subjectReferenceSer, __d.value)
      }
      is ActivityDefinition.Product.CodeableConcept -> {
        encoder.encodeSerializableElement(__desc, 79, Hoisted.subjectCodeableConceptSer, __d.value)
      }
    }
    (value.quantity)?.let { encoder.encodeSerializableElement(__desc, 80, Hoisted.quantitySer, it) }
    if (value.dosage.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 81, Hoisted.dosageSer, value.dosage)
    if (value.bodySite.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 82, Hoisted.jurisdictionSer, value.bodySite)
    ...
    ((value.transform?.value))?.let { encoder.encodeStringElement(__desc, 86, it) }
    (value.transform?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 87, Hoisted.implicitRulesSer, it)
    }
    if (value.dynamicValue.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 88, Hoisted.dynamicValueSer, value.dynamicValue)
  }
...
internal object ActivityDefinitionPolymorphicSerializer : KSerializer<ActivityDefinition> {
  ...
  override fun serialize(encoder: Encoder, `value`: ActivityDefinition) {
    encoder.encodeStructure(descriptor) { ActivityDefinitionSerializer.serializeJson(this, value) }
  }

  override fun deserialize(decoder: Decoder): ActivityDefinition =
    decoder.decodeStructure(descriptor) { ActivityDefinitionSerializer.deserializeJson(this) }
}
