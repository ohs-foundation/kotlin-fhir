...
public sealed class AuditEventSearchParam<T> : SearchParam {
  ...
  public data object Address : AuditEventSearchParam<R4String>() {
  ...
  public data object AgentName : AuditEventSearchParam<R4String>() {
  ...
  public data object Altid : AuditEventSearchParam<R4String>() {
  ...
  public data object EntityName : AuditEventSearchParam<R4String>() {
  ...
  public data object Site : AuditEventSearchParam<R4String>() {
