...
public sealed class CapabilityStatementSearchParam<T> : SearchParam {
  ...
  public data object Fhirversion : CapabilityStatementSearchParam<R4bString>() {
  ...
  public data object Name : CapabilityStatementSearchParam<R4bString>() {
  ...
  public data object Publisher : CapabilityStatementSearchParam<R4bString>() {
  ...
  public data object Software : CapabilityStatementSearchParam<R4bString>() {
  ...
  public data object Title : CapabilityStatementSearchParam<R4bString>() {
  ...
  public data object Version : CapabilityStatementSearchParam<R4bString>() {
