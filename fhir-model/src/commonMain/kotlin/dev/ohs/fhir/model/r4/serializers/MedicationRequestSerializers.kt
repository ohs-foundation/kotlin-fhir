...
internal object MedicationRequestReportedSerializer : KSerializer<MedicationRequest.Reported> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicationRequest.Reported") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MedicationRequest.Reported {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationRequest.Reported: " + __i
          )
      }
    }
    return MedicationRequest.Reported.from(
...
internal object MedicationRequestMedicationSerializer : KSerializer<MedicationRequest.Medication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicationRequest.Medication") {
      element(
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MedicationRequest.Medication {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationRequest.Medication: " + __i
          )
      }
    }
    return MedicationRequest.Medication.from(medicationCodeableConcept, medicationReference)!!
  }
...
internal object MedicationRequestSubstitutionAllowedSerializer :
  KSerializer<MedicationRequest.Substitution.Allowed> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicationRequest.Substitution.Allowed") {
      element("allowedBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_allowedBoolean", Element.serializer().descriptor, isOptional = true)
      element("allowedCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: MedicationRequest.Substitution.Allowed) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is MedicationRequest.Substitution.Allowed.CodeableConcept -> {
          encodeSerializableElement(__desc, 2, Hoisted.allowedCodeableConceptSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MedicationRequest.Substitution.Allowed {
    val __desc = descriptor
    var allowedBoolean: KotlinBoolean? = null
    var _allowedBoolean: Element? = null
    var allowedCodeableConcept: CodeableConcept? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> allowedBoolean = decoder.decodeBooleanElement(__desc, 0)
        1 ->
          _allowedBoolean =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationRequest.Substitution.Allowed: " + __i
          )
      }
    }
    return MedicationRequest.Substitution.Allowed.from(
      R4Boolean.of(allowedBoolean, _allowedBoolean),
      allowedCodeableConcept,
    )!!
  }
