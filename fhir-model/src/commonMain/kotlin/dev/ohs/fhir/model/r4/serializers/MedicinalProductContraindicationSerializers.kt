...
internal object MedicinalProductContraindicationOtherTherapyMedicationSerializer :
  KSerializer<MedicinalProductContraindication.OtherTherapy.Medication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicinalProductContraindication.OtherTherapy.Medication") {
      element(
        "medicationCodeableConcept",
        CodeableConcept.serializer().descriptor,
        isOptional = true,
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicinalProductContraindication.OtherTherapy.Medication: " +
              __i
          )
      }
    }
    return MedicinalProductContraindication.OtherTherapy.Medication.from(
      medicationCodeableConcept,
      medicationReference,
    )!!
  }
