...
public object MedicinalProductContraindicationSearchParams {
   ...
   * subtracted from [all].
   */
  public val unsupported: List<SearchParam<MedicinalProductContraindication, *>> = listOf()

  /**
   * Supported search parameters for the MedicinalProductContraindication resource type. Entries in
   * [unsupported] are excluded so iterating `all` and calling `extractFrom` on each entry is safe.
   */
  public val all: List<SearchParam<MedicinalProductContraindication, *>> =
