...
internal object NutritionOrderSerializer : KSerializer<NutritionOrder> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("NutritionOrder") {
      ...
      element("outsideFoodAllowed", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_outsideFoodAllowed", Element.serializer().descriptor, isOptional = true)
      element(
        "oralDiet",
