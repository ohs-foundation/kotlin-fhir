...
internal object MedicinalProductInteractionSerializer : KSerializer<MedicinalProductInteraction> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        15 -> effect = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.typeSer, null)
        16 ->
          incidence = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.typeSer, null)
        17 ->
          management = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.typeSer, null)
        else ->
  ...
  internal fun serializeJson(
    ...
    ((value.description?.value))?.let { encoder.encodeStringElement(__desc, 11 + __off, it) }
    ...
    (value.management)?.let {
      encoder.encodeSerializableElement(__desc, 17 + __off, Hoisted.typeSer, it)
    }
  }
...
internal object MedicinalProductInteractionPolymorphicSerializer :
  ...
  override fun serialize(encoder: Encoder, `value`: MedicinalProductInteraction) {
    encoder.encodeStructure(descriptor) {
      MedicinalProductInteractionSerializer.serializeJson(this, descriptor, 0, value)
    }
  }

  override fun deserialize(decoder: Decoder): MedicinalProductInteraction =
    decoder.decodeStructure(descriptor) {
      MedicinalProductInteractionSerializer.deserializeJson(this, descriptor, 0)
    }
}
