...
public sealed class PlanDefinitionSearchParam<T> : SearchParam {
  ...
  public data object Identifier : PlanDefinitionSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
    ...
    public override fun extract(resource: PlanDefinition): List<dev.ohs.fhir.model.r4.Identifier> =
      resource.identifier
  }
  ...
  public data object Name : PlanDefinitionSearchParam<R4String>() {
    ...
    public override fun extract(resource: PlanDefinition): List<R4String> =
  ...
  public data object Publisher : PlanDefinitionSearchParam<R4String>() {
  ...
  public data object Title : PlanDefinitionSearchParam<R4String>() {
  ...
  public data object Version : PlanDefinitionSearchParam<R4String>() {
