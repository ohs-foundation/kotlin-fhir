...
public sealed class PlanDefinitionSearchParam<T> : SearchParam {
  ...
  public data object Context : PlanDefinitionSearchParam<Any>() {
    ...
    public override val expression: String = "(PlanDefinition.useContext.value as CodeableConcept)"
  ...
  public data object ContextQuantity : PlanDefinitionSearchParam<Any>() {
    ...
    public override val expression: String = "(PlanDefinition.useContext.value as Quantity)"
  ...
  public data object Definition : PlanDefinitionSearchParam<Any>() {
    ...
    public override val expression: String = "PlanDefinition.action.definition"
