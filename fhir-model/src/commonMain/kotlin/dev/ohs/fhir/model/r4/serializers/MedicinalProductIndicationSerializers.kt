...
internal object MedicinalProductIndicationOtherTherapyMedicationSerializer :
  KSerializer<MedicinalProductIndication.OtherTherapy.Medication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicinalProductIndication.OtherTherapy.Medication") {
      element(
        "medicationCodeableConcept",
        CodeableConcept.serializer().descriptor,
        isOptional = true,
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicinalProductIndication.OtherTherapy.Medication: " + __i
          )
      }
    }
    return MedicinalProductIndication.OtherTherapy.Medication.from(
      medicationCodeableConcept,
      medicationReference,
    )!!
  }
...
internal object MedicinalProductIndicationSerializer : KSerializer<MedicinalProductIndication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicinalProductIndication") {
      ...
      element("diseaseSymptomProcedure", CodeableConcept.serializer().descriptor, isOptional = true)
      ...
      element("intendedEffect", CodeableConcept.serializer().descriptor, isOptional = true)
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: MedicinalProductIndication) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "MedicinalProductIndication")
