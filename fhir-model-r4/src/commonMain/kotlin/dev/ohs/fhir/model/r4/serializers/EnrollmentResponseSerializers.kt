...
internal object EnrollmentResponseSerializer : KSerializer<EnrollmentResponse> {
  ...
  internal fun deserializeInternal(
    ...
    while (true) {
      ...
      when (i - descriptorOffset) {
        ...
        14 -> outcome = decoder.decodeStringElement(descriptor, i)
        15 ->
          _outcome =
            decoder.decodeNullableSerializableElement(descriptor, i, Hoisted.implicitRulesSer, null)
        16 -> disposition = decoder.decodeStringElement(descriptor, i)
        17 ->
          _disposition =
            decoder.decodeNullableSerializableElement(descriptor, i, Hoisted.implicitRulesSer, null)
  ...
  internal fun serializeInternal(
    ...
    (value.organization)?.let {
      encoder.encodeSerializableElement(descriptor, 20 + descriptorOffset, Hoisted.requestSer, it)
    }
