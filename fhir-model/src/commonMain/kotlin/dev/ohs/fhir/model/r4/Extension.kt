...
public data class Extension(
  ...
  public sealed interface Value {
    ...
    @JvmInline
    public value class Base64Binary(public val `value`: dev.ohs.fhir.model.r4.Base64Binary) : Value
    ...
    @JvmInline public value class Coding(public val `value`: dev.ohs.fhir.model.r4.Coding) : Value

    @JvmInline
    public value class ContactPoint(public val `value`: dev.ohs.fhir.model.r4.ContactPoint) : Value
    ...
    @JvmInline public value class Timing(public val `value`: dev.ohs.fhir.model.r4.Timing) : Value
    ...
    @JvmInline
    public value class UsageContext(public val `value`: dev.ohs.fhir.model.r4.UsageContext) : Value

    @JvmInline public value class Dosage(public val `value`: dev.ohs.fhir.model.r4.Dosage) : Value
