...
internal object ImmunizationOccurrenceSerializer : KSerializer<Immunization.Occurrence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Immunization.Occurrence") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Immunization.Occurrence {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 -> occurrenceString = decoder.decodeStringElement(__desc, 2)
        3 ->
          _occurrenceString =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding Immunization.Occurrence: " + __i)
      }
    }
    return Immunization.Occurrence.from(
...
internal object ImmunizationProtocolAppliedDoseNumberSerializer :
  KSerializer<Immunization.ProtocolApplied.DoseNumber> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Immunization.ProtocolApplied.DoseNumber") {
      element("doseNumberPositiveInt", Int.serializer().descriptor, isOptional = true)
      element("_doseNumberPositiveInt", Element.serializer().descriptor, isOptional = true)
      element("doseNumberString", KotlinString.serializer().descriptor, isOptional = true)
      element("_doseNumberString", Element.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Immunization.ProtocolApplied.DoseNumber {
    val __desc = descriptor
    var doseNumberPositiveInt: Int? = null
    var _doseNumberPositiveInt: Element? = null
    var doseNumberString: KotlinString? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Immunization.ProtocolApplied.DoseNumber: " + __i
          )
      }
    }
    return Immunization.ProtocolApplied.DoseNumber.from(
      PositiveInt.of(doseNumberPositiveInt, _doseNumberPositiveInt),
      R4String.of(doseNumberString, _doseNumberString),
    )!!
  }
...
internal object ImmunizationProtocolAppliedSeriesDosesSerializer :
  KSerializer<Immunization.ProtocolApplied.SeriesDoses> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Immunization.ProtocolApplied.SeriesDoses") {
      element("seriesDosesPositiveInt", Int.serializer().descriptor, isOptional = true)
      element("_seriesDosesPositiveInt", Element.serializer().descriptor, isOptional = true)
      element("seriesDosesString", KotlinString.serializer().descriptor, isOptional = true)
      element("_seriesDosesString", Element.serializer().descriptor, isOptional = true)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Immunization.ProtocolApplied.SeriesDoses: " + __i
          )
      }
    }
    return Immunization.ProtocolApplied.SeriesDoses.from(
      PositiveInt.of(seriesDosesPositiveInt, _seriesDosesPositiveInt),
      R4String.of(seriesDosesString, _seriesDosesString),
    )!!
  }
...
internal object ImmunizationSerializer : KSerializer<Immunization> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Immunization") {
      ...
      element("reportOrigin", CodeableConcept.serializer().descriptor, isOptional = true)
