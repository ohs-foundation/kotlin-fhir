  ...
  private fun deserializeJson(decoder: CompositeDecoder): PlanDefinition.Action {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        20 -> subjectCanonical = decoder.decodeStringElement(__desc, 20)
        21 ->
          _subjectCanonical =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.prefixSer, null)
        22 ->
          trigger = decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.triggerSer, null)
        23 ->
          condition =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.conditionSer, null)
        24 -> input = decoder.decodeNullableSerializableElement(__desc, 24, Hoisted.inputSer, null)
        25 -> output = decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.inputSer, null)
        26 ->
          relatedAction =
            decoder.decodeNullableSerializableElement(__desc, 26, Hoisted.relatedActionSer, null)
        27 -> timingDateTime = decoder.decodeStringElement(__desc, 27)
        28 ->
          _timingDateTime =
            decoder.decodeNullableSerializableElement(__desc, 28, Hoisted.prefixSer, null)
        29 ->
          timingAge =
            decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.timingAgeSer, null)
        30 ->
          timingPeriod =
            decoder.decodeNullableSerializableElement(__desc, 30, Hoisted.timingPeriodSer, null)
        31 ->
          timingDuration =
            decoder.decodeNullableSerializableElement(__desc, 31, Hoisted.timingDurationSer, null)
        32 ->
          timingRange =
            decoder.decodeNullableSerializableElement(__desc, 32, Hoisted.timingRangeSer, null)
        33 ->
          timingTiming =
            decoder.decodeNullableSerializableElement(__desc, 33, Hoisted.timingTimingSer, null)
        34 ->
          participant =
            decoder.decodeNullableSerializableElement(__desc, 34, Hoisted.participantSer, null)
        35 ->
          type = decoder.decodeNullableSerializableElement(__desc, 35, Hoisted.codeSerInner, null)
        ...
        51 ->
          _transform =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.prefixSer, null)
        52 ->
          dynamicValue =
...
internal object PlanDefinitionSerializer : KSerializer<PlanDefinition> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): PlanDefinition {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        29 -> subjectCanonical = decoder.decodeStringElement(__desc, 29)
        30 ->
          _subjectCanonical =
        ...
        42 -> usage = decoder.decodeStringElement(__desc, 42)
        43 ->
          _usage =
        ...
        52 ->
          author = decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.contactSer, null)
        53 ->
          editor = decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.contactSer, null)
        54 ->
          reviewer = decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.contactSer, null)
        55 ->
          endorser = decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.contactSer, null)
        56 ->
          relatedArtifact =
            decoder.decodeNullableSerializableElement(__desc, 56, Hoisted.relatedArtifactSer, null)
        57 ->
          library = decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.librarySer, null)
        58 ->
          _library =
            decoder.decodeNullableSerializableElement(__desc, 58, Hoisted.librarySer2, null)
        59 -> goal = decoder.decodeNullableSerializableElement(__desc, 59, Hoisted.goalSer, null)
        60 ->
          action = decoder.decodeNullableSerializableElement(__desc, 60, Hoisted.actionSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  internal fun serializeJson(encoder: CompositeEncoder, `value`: PlanDefinition) {
    val __desc = descriptor
    ...
    ((value.usage?.value))?.let { encoder.encodeStringElement(__desc, 42, it) }
    ...
    if (value.topic.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 51, Hoisted.jurisdictionSer, value.topic)
    if (value.author.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 52, Hoisted.contactSer, value.author)
    if (value.editor.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 53, Hoisted.contactSer, value.editor)
    if (value.reviewer.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 54, Hoisted.contactSer, value.reviewer)
    if (value.endorser.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 55, Hoisted.contactSer, value.endorser)
    ...
    (value.library.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 57, Hoisted.librarySer, it)
    }
    (value.library.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 58, Hoisted.librarySer2, it)
    }
    if (value.goal.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 59, Hoisted.goalSer, value.goal)
    if (value.action.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 60, Hoisted.actionSer, value.action)
  }
...
internal object PlanDefinitionPolymorphicSerializer : KSerializer<PlanDefinition> {
  ...
  override fun serialize(encoder: Encoder, `value`: PlanDefinition) {
    encoder.encodeStructure(descriptor) { PlanDefinitionSerializer.serializeJson(this, value) }
  }

  override fun deserialize(decoder: Decoder): PlanDefinition =
    decoder.decodeStructure(descriptor) { PlanDefinitionSerializer.deserializeJson(this) }
}
