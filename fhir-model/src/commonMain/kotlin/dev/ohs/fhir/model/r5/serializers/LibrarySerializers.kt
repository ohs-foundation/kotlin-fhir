...
internal object LibraryVersionAlgorithmSerializer : KSerializer<Library.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Library.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Library.VersionAlgorithm {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding Library.VersionAlgorithm: " + __i)
      }
    }
    return Library.VersionAlgorithm.from(
