  ...
  private fun deserializeJson(decoder: CompositeDecoder): Substance.Instance {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 -> expiry = decoder.decodeStringElement(__desc, __i)
        5 ->
          _expiry = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.expirySer, null)
        6 ->
          quantity =
...
internal object SubstanceSerializer : KSerializer<Substance> {
  ...
  internal fun serializeJson(
    ...
    if (value.instance.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 17 + __off, Hoisted.instanceSer, value.instance)
    if (value.ingredient.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 18 + __off, Hoisted.ingredientSer, value.ingredient)
  }
