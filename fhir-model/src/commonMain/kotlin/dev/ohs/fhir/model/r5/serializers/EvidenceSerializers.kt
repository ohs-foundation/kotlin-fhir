...
internal object EvidenceVersionAlgorithmSerializer : KSerializer<Evidence.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Evidence.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Evidence.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Evidence.VersionAlgorithm: " + __i
          )
      }
    }
    return Evidence.VersionAlgorithm.from(
