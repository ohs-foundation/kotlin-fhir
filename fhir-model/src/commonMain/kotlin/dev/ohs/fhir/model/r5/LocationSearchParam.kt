...
public sealed class LocationSearchParam<T> : SearchParam {
  ...
  public data object Characteristic : LocationSearchParam<Any>() {
    public override val paramName: String = "characteristic"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "Location.characteristic"
  ...
  public data object Contains : LocationSearchParam<Any>() {
    public override val paramName: String = "contains"
