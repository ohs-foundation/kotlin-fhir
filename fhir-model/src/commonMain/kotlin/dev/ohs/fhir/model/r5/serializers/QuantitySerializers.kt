...
internal object QuantitySerializer : KSerializer<Quantity> {
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Quantity {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        else -> throw SerializationException("Unexpected index decoding Quantity: " + __i)
      }
    }
    return Quantity(
      id = id,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Quantity) {
    val __desc = descriptor
