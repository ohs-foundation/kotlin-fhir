...
internal object MedicationKnowledgeIngredientItemSerializer :
  KSerializer<MedicationKnowledge.Ingredient.Item> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicationKnowledge.Ingredient.Item") {
      element("itemCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("itemReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MedicationKnowledge.Ingredient.Item {
    val __desc = descriptor
    var itemCodeableConcept: CodeableConcept? = null
    var itemReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationKnowledge.Ingredient.Item: " + __i
          )
      }
    }
    return MedicationKnowledge.Ingredient.Item.from(itemCodeableConcept, itemReference)!!
  }
...
internal object MedicationKnowledgeAdministrationGuidelinesIndicationSerializer :
  KSerializer<MedicationKnowledge.AdministrationGuidelines.Indication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicationKnowledge.AdministrationGuidelines.Indication") {
      element(
        "indicationCodeableConcept",
        CodeableConcept.serializer().descriptor,
        isOptional = true,
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is MedicationKnowledge.AdministrationGuidelines.Indication.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.indicationCodeableConceptSer, __d.value)
        }
        is MedicationKnowledge.AdministrationGuidelines.Indication.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.indicationReferenceSer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationKnowledge.AdministrationGuidelines.Indication: " +
              __i
          )
      }
    }
    return MedicationKnowledge.AdministrationGuidelines.Indication.from(
      indicationCodeableConcept,
      indicationReference,
    )!!
  }
...
internal object MedicationKnowledgeAdministrationGuidelinesPatientCharacteristicsCharacteristicSerializer :
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.characteristicCodeableConceptSer, __d.value)
        }
        is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.Quantity -> {
          encodeSerializableElement(__desc, 1, Hoisted.characteristicQuantitySer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic: " +
              __i
          )
      }
    }
    return MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.from(
      characteristicCodeableConcept,
      characteristicQuantity,
    )!!
  }
...
internal object MedicationKnowledgeDrugCharacteristicValueSerializer :
  KSerializer<MedicationKnowledge.DrugCharacteristic.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicationKnowledge.DrugCharacteristic.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueString", Element.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationKnowledge.DrugCharacteristic.Value: " + __i
          )
      }
    }
    return MedicationKnowledge.DrugCharacteristic.Value.from(
      valueCodeableConcept,
      R4bString.of(valueString, _valueString),
      valueQuantity,
      Base64Binary.of(valueBase64Binary, _valueBase64Binary),
