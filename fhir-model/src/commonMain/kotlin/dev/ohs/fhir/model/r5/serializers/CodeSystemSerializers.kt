...
internal object CodeSystemVersionAlgorithmSerializer : KSerializer<CodeSystem.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CodeSystem.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CodeSystem.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CodeSystem.VersionAlgorithm: " + __i
          )
      }
    }
    return CodeSystem.VersionAlgorithm.from(
...
internal object CodeSystemConceptPropertyValueSerializer :
  KSerializer<CodeSystem.Concept.Property.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CodeSystem.Concept.Property.Value") {
      element("valueCode", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueCode", Element.serializer().descriptor, isOptional = true)
      element("valueCoding", Coding.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CodeSystem.Concept.Property.Value {
    val __desc = descriptor
    var valueCode: KotlinString? = null
    var _valueCode: Element? = null
    var valueCoding: Coding? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CodeSystem.Concept.Property.Value: " + __i
          )
      }
    }
    return CodeSystem.Concept.Property.Value.from(
      Code.of(valueCode, _valueCode),
      valueCoding,
      R5String.of(valueString, _valueString),
      Integer.of(valueInteger, _valueInteger),
