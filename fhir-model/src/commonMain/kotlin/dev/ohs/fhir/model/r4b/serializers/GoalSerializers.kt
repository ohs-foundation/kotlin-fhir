...
internal object GoalStartSerializer : KSerializer<Goal.Start> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Goal.Start") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is Goal.Start.CodeableConcept -> {
          encodeSerializableElement(__desc, 2, Hoisted.startCodeableConceptSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Goal.Start {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> startDate = decoder.decodeStringElement(__desc, 0)
        1 ->
          _startDate =
        ...
        2 ->
          startCodeableConcept =
            decoder.decodeNullableSerializableElement(
              __desc,
              2,
              Hoisted.startCodeableConceptSer,
              null,
            )
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Goal.Start: " + __i)
      }
    }
    return Goal.Start.from(
      Date.of(FhirDate.fromString(startDate), _startDate),
      startCodeableConcept,
    )!!
  }
  ...
  private object Hoisted {
    ...
    public val startCodeableConceptSer: KSerializer<CodeableConcept> = CodeableConcept.serializer()
  }
}

internal object GoalTargetDetailSerializer : KSerializer<Goal.Target.Detail> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Goal.Target.Detail") {
      element("detailQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("detailRange", Range.serializer().descriptor, isOptional = true)
      element("detailCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("detailString", KotlinString.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Goal.Target.Detail {
    val __desc = descriptor
    var detailQuantity: Quantity? = null
    var detailRange: Range? = null
    var detailCodeableConcept: CodeableConcept? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Goal.Target.Detail: " + __i)
      }
    }
    return Goal.Target.Detail.from(
      detailQuantity,
      detailRange,
      detailCodeableConcept,
      R4bString.of(detailString, _detailString),
...
internal object GoalTargetDueSerializer : KSerializer<Goal.Target.Due> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Goal.Target.Due") {
      element("dueDate", KotlinString.serializer().descriptor, isOptional = true)
      element("_dueDate", Element.serializer().descriptor, isOptional = true)
      element("dueDuration", Duration.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: Goal.Target.Due) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is Goal.Target.Due.Duration -> {
          encodeSerializableElement(__desc, 2, Hoisted.dueDurationSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Goal.Target.Due {
    val __desc = descriptor
    var dueDate: KotlinString? = null
    var _dueDate: Element? = null
    var dueDuration: Duration? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> dueDate = decoder.decodeStringElement(__desc, 0)
        1 ->
          _dueDate = decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
          dueDuration =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.dueDurationSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Goal.Target.Due: " + __i)
      }
    }
    return Goal.Target.Due.from(Date.of(FhirDate.fromString(dueDate), _dueDate), dueDuration)!!
  }
...
internal object GoalSerializer : KSerializer<Goal> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Goal") {
      ...
      element("expressedBy", Reference.serializer().descriptor, isOptional = true)
      element(
        "addresses",
