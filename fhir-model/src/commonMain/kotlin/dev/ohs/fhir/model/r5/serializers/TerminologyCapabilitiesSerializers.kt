  ...
  private fun deserializeJson(decoder: CompositeDecoder): TerminologyCapabilities.CodeSystem {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        6 -> content = decoder.decodeStringElement(__desc, 6)
        7 -> _content = decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.uriSer, null)
        8 -> subsumption = decoder.decodeBooleanElement(__desc, 8)
        9 ->
          _subsumption = decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.uriSer, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object TerminologyCapabilitiesVersionAlgorithmSerializer :
  KSerializer<TerminologyCapabilities.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("TerminologyCapabilities.VersionAlgorithm") {
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding TerminologyCapabilities.VersionAlgorithm: " + __i
          )
      }
    }
    return TerminologyCapabilities.VersionAlgorithm.from(
...
internal object TerminologyCapabilitiesSerializer : KSerializer<TerminologyCapabilities> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("TerminologyCapabilities") {
      ...
      element("lockedDate", KotlinBoolean.serializer().descriptor, isOptional = true)
      ...
      element("codeSearch", KotlinString.serializer().descriptor, isOptional = true)
      element("_codeSearch", Element.serializer().descriptor, isOptional = true)
      element(
        "validateCode",
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): TerminologyCapabilities {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        44 ->
          software =
            decoder.decodeNullableSerializableElement(__desc, 44, Hoisted.softwareSer, null)
        45 ->
          implementation =
            decoder.decodeNullableSerializableElement(__desc, 45, Hoisted.implementationSer, null)
        46 -> lockedDate = decoder.decodeBooleanElement(__desc, 46)
        47 ->
          _lockedDate =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.implicitRulesSer, null)
        48 ->
          codeSystem =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.codeSystemSer, null)
        49 ->
          expansion =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.expansionSer, null)
        50 -> codeSearch = decoder.decodeStringElement(__desc, 50)
        51 ->
          _codeSearch =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.implicitRulesSer, null)
        52 ->
          validateCode =
            decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.validateCodeSer, null)
        53 ->
          translation =
            decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.translationSer, null)
        54 ->
          closure = decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.closureSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: TerminologyCapabilities) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "TerminologyCapabilities")
    ...
    (value.software)?.let { encoder.encodeSerializableElement(__desc, 44, Hoisted.softwareSer, it) }
    (value.implementation)?.let {
      encoder.encodeSerializableElement(__desc, 45, Hoisted.implementationSer, it)
    }
    ((value.lockedDate?.value))?.let { encoder.encodeBooleanElement(__desc, 46, it) }
    ...
    if (value.codeSystem.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 48, Hoisted.codeSystemSer, value.codeSystem)
    (value.expansion)?.let {
      encoder.encodeSerializableElement(__desc, 49, Hoisted.expansionSer, it)
    }
    ((value.codeSearch?.value?.getCode()))?.let { encoder.encodeStringElement(__desc, 50, it) }
    ...
    (value.validateCode)?.let {
      encoder.encodeSerializableElement(__desc, 52, Hoisted.validateCodeSer, it)
    }
    (value.translation)?.let {
      encoder.encodeSerializableElement(__desc, 53, Hoisted.translationSer, it)
    }
    (value.closure)?.let { encoder.encodeSerializableElement(__desc, 54, Hoisted.closureSer, it) }
  }
