...
internal object Integer64Serializer : KSerializer<Integer64> {
  ...
  override fun serialize(encoder: Encoder, `value`: Integer64) {
    encoder.encodeStructure(descriptor) {
      ...
      encodeNullableSerializableElement(descriptor, 2, Long.serializer(), value.`value`)
    }
  }

  override fun deserialize(decoder: Decoder): Integer64 =
    decoder.decodeStructure(descriptor) {
      ...
      while (true) {
        when (val index = decodeElementIndex(descriptor)) {
          ...
          2 -> `value` = decodeNullableSerializableElement(descriptor, 2, Long.serializer())
