...
internal object MedicinalProductManufacturedSerializer : KSerializer<MedicinalProductManufactured> {
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: MedicinalProductManufactured) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "MedicinalProductManufactured")
