...
internal object MessageDefinitionVersionAlgorithmSerializer :
  KSerializer<MessageDefinition.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MessageDefinition.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MessageDefinition.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MessageDefinition.VersionAlgorithm: " + __i
          )
      }
    }
    return MessageDefinition.VersionAlgorithm.from(
...
internal object MessageDefinitionEventSerializer : KSerializer<MessageDefinition.Event> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MessageDefinition.Event") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MessageDefinition.Event {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding MessageDefinition.Event: " + __i)
      }
    }
    return MessageDefinition.Event.from(eventCoding, Uri.of(eventUri, _eventUri))!!
  }
