...
internal object AdverseEventOccurrenceSerializer : KSerializer<AdverseEvent.Occurrence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("AdverseEvent.Occurrence") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): AdverseEvent.Occurrence {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding AdverseEvent.Occurrence: " + __i)
      }
    }
    return AdverseEvent.Occurrence.from(
...
internal object AdverseEventSuspectEntityInstanceSerializer :
  KSerializer<AdverseEvent.SuspectEntity.Instance> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("AdverseEvent.SuspectEntity.Instance") {
      element("instanceCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("instanceReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: AdverseEvent.SuspectEntity.Instance) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is AdverseEvent.SuspectEntity.Instance.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.instanceCodeableConceptSer, __d.value)
        }
        is AdverseEvent.SuspectEntity.Instance.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.instanceReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): AdverseEvent.SuspectEntity.Instance {
    val __desc = descriptor
    var instanceCodeableConcept: CodeableConcept? = null
    var instanceReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          instanceReference =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.instanceReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding AdverseEvent.SuspectEntity.Instance: " + __i
          )
      }
    }
    return AdverseEvent.SuspectEntity.Instance.from(instanceCodeableConcept, instanceReference)!!
  }
...
internal object AdverseEventContributingFactorItemSerializer :
  KSerializer<AdverseEvent.ContributingFactor.Item> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("AdverseEvent.ContributingFactor.Item") {
      element("itemReference", Reference.serializer().descriptor, isOptional = true)
      element("itemCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): AdverseEvent.ContributingFactor.Item {
    val __desc = descriptor
    var itemReference: Reference? = null
    var itemCodeableConcept: CodeableConcept? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding AdverseEvent.ContributingFactor.Item: " + __i
          )
      }
    }
    return AdverseEvent.ContributingFactor.Item.from(itemReference, itemCodeableConcept)!!
  }
...
internal object AdverseEventPreventiveActionItemSerializer :
  KSerializer<AdverseEvent.PreventiveAction.Item> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("AdverseEvent.PreventiveAction.Item") {
      element("itemReference", Reference.serializer().descriptor, isOptional = true)
      element("itemCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): AdverseEvent.PreventiveAction.Item {
    val __desc = descriptor
    var itemReference: Reference? = null
    var itemCodeableConcept: CodeableConcept? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding AdverseEvent.PreventiveAction.Item: " + __i
          )
      }
    }
    return AdverseEvent.PreventiveAction.Item.from(itemReference, itemCodeableConcept)!!
  }
...
internal object AdverseEventMitigatingActionItemSerializer :
  KSerializer<AdverseEvent.MitigatingAction.Item> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("AdverseEvent.MitigatingAction.Item") {
      element("itemReference", Reference.serializer().descriptor, isOptional = true)
      element("itemCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): AdverseEvent.MitigatingAction.Item {
    val __desc = descriptor
    var itemReference: Reference? = null
    var itemCodeableConcept: CodeableConcept? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding AdverseEvent.MitigatingAction.Item: " + __i
          )
      }
    }
    return AdverseEvent.MitigatingAction.Item.from(itemReference, itemCodeableConcept)!!
  }
...
internal object AdverseEventSupportingInfoItemSerializer :
  KSerializer<AdverseEvent.SupportingInfo.Item> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("AdverseEvent.SupportingInfo.Item") {
      element("itemReference", Reference.serializer().descriptor, isOptional = true)
      element("itemCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): AdverseEvent.SupportingInfo.Item {
    val __desc = descriptor
    var itemReference: Reference? = null
    var itemCodeableConcept: CodeableConcept? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding AdverseEvent.SupportingInfo.Item: " + __i
          )
      }
    }
    return AdverseEvent.SupportingInfo.Item.from(itemReference, itemCodeableConcept)!!
  }
