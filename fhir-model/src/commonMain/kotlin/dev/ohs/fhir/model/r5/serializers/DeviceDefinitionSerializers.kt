...
internal object DeviceDefinitionPropertyValueSerializer :
  KSerializer<DeviceDefinition.Property.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("DeviceDefinition.Property.Value") {
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueString", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: DeviceDefinition.Property.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is DeviceDefinition.Property.Value.Attachment -> {
          encodeSerializableElement(__desc, 9, Hoisted.valueAttachmentSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): DeviceDefinition.Property.Value {
    val __desc = descriptor
    var valueQuantity: Quantity? = null
    var valueCodeableConcept: CodeableConcept? = null
    var valueString: KotlinString? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        9 ->
          valueAttachment =
            decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.valueAttachmentSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding DeviceDefinition.Property.Value: " + __i
          )
      }
    }
    return DeviceDefinition.Property.Value.from(
      valueQuantity,
      valueCodeableConcept,
      R5String.of(valueString, _valueString),
      R5Boolean.of(valueBoolean, _valueBoolean),
  ...
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("DeviceDefinition") {
      ...
      element(
        "conformsTo",
        listSerialDescriptor(
          lazyDescriptor { DeviceDefinition.ConformsTo.serializer().descriptor }
        ),
        isOptional = true,
      )
      element(
      ...
      element(
        "chargeItem",
        listSerialDescriptor(
          lazyDescriptor { DeviceDefinition.ChargeItem.serializer().descriptor }
        ),
        isOptional = true,
      )
    }
