...
internal object UnsignedIntSerializer : KSerializer<UnsignedInt> {
  ...
  override fun deserialize(decoder: Decoder): UnsignedInt =
    decoder.decodeStructure(descriptor) {
      ...
      UnsignedInt(id = id, extension = extension, `value` = `value`)
    }
}
