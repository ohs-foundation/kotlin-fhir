...
internal object DurationSerializer : KSerializer<Duration> {
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Duration {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        else -> throw SerializationException("Unexpected index decoding Duration: " + __i)
      }
    }
    return Duration(
      id = id,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Duration) {
    val __desc = descriptor
