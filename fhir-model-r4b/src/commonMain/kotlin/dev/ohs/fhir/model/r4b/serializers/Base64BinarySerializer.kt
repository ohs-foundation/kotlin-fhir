...
internal object Base64BinarySerializer : KSerializer<Base64Binary> {
  ...
  override fun deserialize(decoder: Decoder): Base64Binary =
    decoder.decodeStructure(descriptor) {
      ...
      Base64Binary(id = id, extension = extension, `value` = `value`)
    }
}
