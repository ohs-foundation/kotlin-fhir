...
internal object BiologicallyDerivedProductProcessingTimeSerializer :
  KSerializer<BiologicallyDerivedProduct.Processing.Time> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("BiologicallyDerivedProduct.Processing.Time") {
      element("timeDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_timeDateTime", Element.serializer().descriptor, isOptional = true)
      element("timePeriod", Period.serializer().descriptor, isOptional = true)
    }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding BiologicallyDerivedProduct.Processing.Time: " + __i
          )
      }
    }
    return BiologicallyDerivedProduct.Processing.Time.from(
      DateTime.of(FhirDateTime.fromString(timeDateTime), _timeDateTime),
      timePeriod,
    )!!
  }
...
internal object BiologicallyDerivedProductManipulationTimeSerializer :
  KSerializer<BiologicallyDerivedProduct.Manipulation.Time> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("BiologicallyDerivedProduct.Manipulation.Time") {
      element("timeDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_timeDateTime", Element.serializer().descriptor, isOptional = true)
      element("timePeriod", Period.serializer().descriptor, isOptional = true)
    }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding BiologicallyDerivedProduct.Manipulation.Time: " + __i
          )
      }
    }
    return BiologicallyDerivedProduct.Manipulation.Time.from(
      DateTime.of(FhirDateTime.fromString(timeDateTime), _timeDateTime),
      timePeriod,
    )!!
  }
...
internal object BiologicallyDerivedProductSerializer : KSerializer<BiologicallyDerivedProduct> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("BiologicallyDerivedProduct") {
      ...
      element("productCategory", KotlinString.serializer().descriptor, isOptional = true)
      element("_productCategory", Element.serializer().descriptor, isOptional = true)
