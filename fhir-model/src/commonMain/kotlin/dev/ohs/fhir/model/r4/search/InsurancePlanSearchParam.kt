...
public sealed class InsurancePlanSearchParam<T> : SearchParam {
  ...
  public data object Address : InsurancePlanSearchParam<dev.ohs.fhir.model.r4.Address>() {
  ...
  public data object AddressCity : InsurancePlanSearchParam<R4String>() {
  ...
  public data object AddressCountry : InsurancePlanSearchParam<R4String>() {
  ...
  public data object AddressPostalcode : InsurancePlanSearchParam<R4String>() {
  ...
  public data object AddressState : InsurancePlanSearchParam<R4String>() {
  ...
  public data object Identifier : InsurancePlanSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
  ...
  public data object Phonetic : InsurancePlanSearchParam<R4String>() {
