...
internal object QuestionnaireResponseItemAnswerValueSerializer :
  KSerializer<QuestionnaireResponse.Item.Answer.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("QuestionnaireResponse.Item.Answer.Value") {
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
      element("valueDecimal", BigDecimalSerializer.descriptor, isOptional = true)
      element("_valueDecimal", Element.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): QuestionnaireResponse.Item.Answer.Value {
    val __desc = descriptor
    var valueBoolean: KotlinBoolean? = null
    var _valueBoolean: Element? = null
    var valueDecimal: BigDecimal? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding QuestionnaireResponse.Item.Answer.Value: " + __i
          )
      }
    }
    return QuestionnaireResponse.Item.Answer.Value.from(
      R4Boolean.of(valueBoolean, _valueBoolean),
      Decimal.of(valueDecimal, _valueDecimal),
      Integer.of(valueInteger, _valueInteger),
      Date.of(FhirDate.fromString(valueDate), _valueDate),
...
internal object QuestionnaireResponseSerializer : KSerializer<QuestionnaireResponse> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("QuestionnaireResponse") {
      ...
      element("questionnaire", KotlinString.serializer().descriptor, isOptional = true)
      element("_questionnaire", Element.serializer().descriptor, isOptional = true)
      ...
      element("authored", KotlinString.serializer().descriptor, isOptional = true)
      element("_authored", Element.serializer().descriptor, isOptional = true)
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: QuestionnaireResponse) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "QuestionnaireResponse")
