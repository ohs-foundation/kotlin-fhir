...
internal object ActivityDefinitionVersionAlgorithmSerializer :
  KSerializer<ActivityDefinition.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ActivityDefinition.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ActivityDefinition.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ActivityDefinition.VersionAlgorithm: " + __i
          )
      }
    }
    return ActivityDefinition.VersionAlgorithm.from(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ActivityDefinition.Timing.Age -> {
          encodeSerializableElement(__desc, 1, Hoisted.timingAgeSer, __d.value)
        }
        ...
        is ActivityDefinition.Timing.Duration -> {
          encodeSerializableElement(__desc, 3, Hoisted.timingDurationSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ActivityDefinition.Timing {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          timingAge =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.timingAgeSer, null)
        2 ->
          timingRange =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.timingRangeSer, null)
        3 ->
          timingDuration =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.timingDurationSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
    ...
    return ActivityDefinition.Timing.from(timingTiming, timingAge, timingRange, timingDuration)!!
  }
...
internal object ActivityDefinitionAsNeededSerializer : KSerializer<ActivityDefinition.AsNeeded> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ActivityDefinition.AsNeeded") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ActivityDefinition.AsNeeded {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ActivityDefinition.AsNeeded: " + __i
          )
      }
    }
    return ActivityDefinition.AsNeeded.from(
