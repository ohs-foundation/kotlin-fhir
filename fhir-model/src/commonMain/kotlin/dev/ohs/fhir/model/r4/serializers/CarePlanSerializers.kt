...
internal object CarePlanActivityDetailScheduledSerializer :
  KSerializer<CarePlan.Activity.Detail.Scheduled> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CarePlan.Activity.Detail.Scheduled") {
      element("scheduledTiming", Timing.serializer().descriptor, isOptional = true)
      element("scheduledPeriod", Period.serializer().descriptor, isOptional = true)
      element("scheduledString", KotlinString.serializer().descriptor, isOptional = true)
      element("_scheduledString", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: CarePlan.Activity.Detail.Scheduled) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is CarePlan.Activity.Detail.Scheduled.Timing -> {
          encodeSerializableElement(__desc, 0, Hoisted.scheduledTimingSer, __d.value)
        }
        is CarePlan.Activity.Detail.Scheduled.Period -> {
          encodeSerializableElement(__desc, 1, Hoisted.scheduledPeriodSer, __d.value)
        }
        is CarePlan.Activity.Detail.Scheduled.String -> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CarePlan.Activity.Detail.Scheduled {
    val __desc = descriptor
    var scheduledTiming: Timing? = null
    var scheduledPeriod: Period? = null
    var scheduledString: KotlinString? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          scheduledTiming =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.scheduledTimingSer, null)
        1 ->
          scheduledPeriod =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.scheduledPeriodSer, null)
        2 -> scheduledString = decoder.decodeStringElement(__desc, 2)
        3 ->
          _scheduledString =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CarePlan.Activity.Detail.Scheduled: " + __i
          )
      }
    }
    return CarePlan.Activity.Detail.Scheduled.from(
      scheduledTiming,
      scheduledPeriod,
      R4String.of(scheduledString, _scheduledString),
    )!!
...
internal object CarePlanActivityDetailProductSerializer :
  KSerializer<CarePlan.Activity.Detail.Product> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CarePlan.Activity.Detail.Product") {
      element("productCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("productReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: CarePlan.Activity.Detail.Product) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is CarePlan.Activity.Detail.Product.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.productCodeableConceptSer, __d.value)
        }
        is CarePlan.Activity.Detail.Product.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.productReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CarePlan.Activity.Detail.Product {
    val __desc = descriptor
    var productCodeableConcept: CodeableConcept? = null
    var productReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          productReference =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.productReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding CarePlan.Activity.Detail.Product: " + __i
          )
      }
    }
    return CarePlan.Activity.Detail.Product.from(productCodeableConcept, productReference)!!
  }
