...
public data class Goal(
  ...
  public data class Target(
    ...
    public sealed interface Detail {
      ...
      @JvmInline public value class Range(public val `value`: dev.ohs.fhir.model.r5.Range) : Detail
      ...
      @JvmInline public value class Ratio(public val `value`: dev.ohs.fhir.model.r5.Ratio) : Detail
    ...
    public sealed interface Due {
      ...
      @JvmInline public value class Date(public val `value`: dev.ohs.fhir.model.r5.Date) : Due

      @JvmInline
      public value class Duration(public val `value`: dev.ohs.fhir.model.r5.Duration) : Due
  ...
  public sealed interface Start {
    ...
    @JvmInline public value class Date(public val `value`: dev.ohs.fhir.model.r5.Date) : Start
