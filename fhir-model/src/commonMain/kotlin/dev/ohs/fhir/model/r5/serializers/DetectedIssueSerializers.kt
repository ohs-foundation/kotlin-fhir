...
internal object DetectedIssueSerializer : KSerializer<DetectedIssue> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("DetectedIssue") {
      ...
      element("severity", String.serializer().descriptor, isOptional = true)
      ...
      element("detail", String.serializer().descriptor, isOptional = true)
      element("_detail", Element.serializer().descriptor, isOptional = true)
      element("reference", String.serializer().descriptor, isOptional = true)
