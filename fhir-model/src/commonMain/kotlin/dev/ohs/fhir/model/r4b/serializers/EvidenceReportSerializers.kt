...
internal object EvidenceReportCiteAsSerializer : KSerializer<EvidenceReport.CiteAs> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceReport.CiteAs") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): EvidenceReport.CiteAs {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding EvidenceReport.CiteAs: " + __i)
      }
    }
    return EvidenceReport.CiteAs.from(
      citeAsReference,
...
internal object EvidenceReportSubjectCharacteristicValueSerializer :
  KSerializer<EvidenceReport.Subject.Characteristic.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceReport.Subject.Characteristic.Value") {
      element("valueReference", Reference.serializer().descriptor, isOptional = true)
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: EvidenceReport.Subject.Characteristic.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is EvidenceReport.Subject.Characteristic.Value.Reference -> {
          encodeSerializableElement(__desc, 0, Hoisted.valueReferenceSer, __d.value)
        }
        is EvidenceReport.Subject.Characteristic.Value.CodeableConcept -> {
        ...
        is EvidenceReport.Subject.Characteristic.Value.Range -> {
          encodeSerializableElement(__desc, 5, Hoisted.valueRangeSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          valueReference =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.valueReferenceSer, null)
        1 ->
          valueCodeableConcept =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding EvidenceReport.Subject.Characteristic.Value: " + __i
          )
      }
    }
    return EvidenceReport.Subject.Characteristic.Value.from(
      valueReference,
      valueCodeableConcept,
      R4bBoolean.of(valueBoolean, _valueBoolean),
      valueQuantity,
...
internal object EvidenceReportRelatesToTargetSerializer :
  ...
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceReport.RelatesTo.Target") {
      element("targetIdentifier", Identifier.serializer().descriptor, isOptional = true)
      element("targetReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): EvidenceReport.RelatesTo.Target {
    val __desc = descriptor
    var targetIdentifier: Identifier? = null
    var targetReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding EvidenceReport.RelatesTo.Target: " + __i
          )
      }
    }
    return EvidenceReport.RelatesTo.Target.from(targetIdentifier, targetReference)!!
  }
...
internal object EvidenceReportSerializer : KSerializer<EvidenceReport> {
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: EvidenceReport) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "EvidenceReport")
