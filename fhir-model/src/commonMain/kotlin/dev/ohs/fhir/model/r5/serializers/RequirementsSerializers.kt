  ...
  private fun deserializeJson(decoder: CompositeDecoder): Requirements.Statement {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        6 -> _label = decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.keySer, null)
        7 ->
          conformance =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.conformanceSer, null)
        8 ->
          _conformance =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.conformanceSer2, null)
        9 -> conditionality = decoder.decodeBooleanElement(__desc, 9)
        10 ->
          _conditionality =
            decoder.decodeNullableSerializableElement(__desc, 10, Hoisted.keySer, null)
        11 -> requirement = decoder.decodeStringElement(__desc, 11)
        12 ->
          _requirement = decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.keySer, null)
        13 -> derivedFrom = decoder.decodeStringElement(__desc, 13)
        14 ->
          _derivedFrom = decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.keySer, null)
        15 -> parent = decoder.decodeStringElement(__desc, 15)
        16 -> _parent = decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.keySer, null)
        17 ->
          satisfiedBy =
            decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.conformanceSer, null)
        18 ->
          _satisfiedBy =
            decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.conformanceSer2, null)
        19 ->
          reference =
            decoder.decodeNullableSerializableElement(__desc, 19, Hoisted.conformanceSer, null)
        20 ->
          _reference =
            decoder.decodeNullableSerializableElement(__desc, 20, Hoisted.conformanceSer2, null)
        21 ->
          source = decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.sourceSer, null)
...
internal object RequirementsVersionAlgorithmSerializer :
  KSerializer<Requirements.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Requirements.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Requirements.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Requirements.VersionAlgorithm: " + __i
          )
      }
    }
    return Requirements.VersionAlgorithm.from(
...
internal object RequirementsSerializer : KSerializer<Requirements> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Requirements") {
      ...
      element("_actor", listSerialDescriptor(Element.serializer().descriptor), isOptional = true)
      element(
        "statement",
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Requirements {
    val __desc = descriptor
    var id: KotlinString? = null
    var meta: Meta? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        42 ->
          derivedFrom =
            decoder.decodeNullableSerializableElement(__desc, 42, Hoisted.derivedFromSer, null)
        43 ->
          _derivedFrom =
            decoder.decodeNullableSerializableElement(__desc, 43, Hoisted.derivedFromSer2, null)
        44 ->
          reference =
            decoder.decodeNullableSerializableElement(__desc, 44, Hoisted.derivedFromSer, null)
        45 ->
          _reference =
            decoder.decodeNullableSerializableElement(__desc, 45, Hoisted.derivedFromSer2, null)
        46 ->
          actor =
            decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.derivedFromSer, null)
        47 ->
          _actor =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.derivedFromSer2, null)
        48 ->
          statement =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.statementSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Requirements) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "Requirements")
    ...
    (value.derivedFrom.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 42, Hoisted.derivedFromSer, it)
    }
    (value.derivedFrom.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 43, Hoisted.derivedFromSer2, it)
    }
    (value.reference.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 44, Hoisted.derivedFromSer, it)
    }
    (value.reference.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 45, Hoisted.derivedFromSer2, it)
    }
    (value.actor.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 46, Hoisted.derivedFromSer, it)
    }
    (value.actor.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 47, Hoisted.derivedFromSer2, it)
    }
    if (value.statement.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 48, Hoisted.statementSer, value.statement)
  }
