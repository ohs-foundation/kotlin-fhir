...
internal object EvidenceVariableCharacteristicDefinitionSerializer :
  KSerializer<EvidenceVariable.Characteristic.Definition> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.Characteristic.Definition") {
      element("definitionReference", Reference.serializer().descriptor, isOptional = true)
      element("definitionCanonical", KotlinString.serializer().descriptor, isOptional = true)
      element("_definitionCanonical", Element.serializer().descriptor, isOptional = true)
      element(
  ...
  override fun serialize(encoder: Encoder, `value`: EvidenceVariable.Characteristic.Definition) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is EvidenceVariable.Characteristic.Definition.Reference -> {
          encodeSerializableElement(__desc, 0, Hoisted.definitionReferenceSer, __d.value)
        }
        is EvidenceVariable.Characteristic.Definition.Canonical -> {
        ...
        is EvidenceVariable.Characteristic.Definition.CodeableConcept -> {
          encodeSerializableElement(__desc, 3, Hoisted.definitionCodeableConceptSer, __d.value)
        }
        is EvidenceVariable.Characteristic.Definition.Expression -> {
          encodeSerializableElement(__desc, 4, Hoisted.definitionExpressionSer, __d.value)
        }
        is EvidenceVariable.Characteristic.Definition.DataRequirement -> {
          encodeSerializableElement(__desc, 5, Hoisted.definitionDataRequirementSer, __d.value)
        }
        is EvidenceVariable.Characteristic.Definition.TriggerDefinition -> {
          encodeSerializableElement(__desc, 6, Hoisted.definitionTriggerDefinitionSer, __d.value)
        }
      }
    }
  }
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.Characteristic.Definition: " + __i
          )
      }
    }
    return EvidenceVariable.Characteristic.Definition.from(
      definitionReference,
      Canonical.of(definitionCanonical, _definitionCanonical),
      definitionCodeableConcept,
      definitionExpression,
...
internal object EvidenceVariableCharacteristicParticipantEffectiveSerializer :
  KSerializer<EvidenceVariable.Characteristic.ParticipantEffective> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.Characteristic.ParticipantEffective") {
      element(
        "participantEffectiveDateTime",
        KotlinString.serializer().descriptor,
        isOptional = true,
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.Characteristic.ParticipantEffective: " + __i
          )
      }
    }
    return EvidenceVariable.Characteristic.ParticipantEffective.from(
      DateTime.of(
        FhirDateTime.fromString(participantEffectiveDateTime),
        _participantEffectiveDateTime,
      ),
