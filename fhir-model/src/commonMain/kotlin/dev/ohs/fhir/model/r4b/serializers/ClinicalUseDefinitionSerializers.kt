  ...
  private fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 ->
          therapy = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.therapySer, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object ClinicalUseDefinitionSerializer : KSerializer<ClinicalUseDefinition> {
  ...
  internal fun serializeJson(
    ...
    (value.undesirableEffect)?.let {
      encoder.encodeSerializableElement(__desc, 20 + __off, Hoisted.undesirableEffectSer, it)
    }
    (value.warning)?.let {
      encoder.encodeSerializableElement(__desc, 21 + __off, Hoisted.warningSer, it)
    }
  }
