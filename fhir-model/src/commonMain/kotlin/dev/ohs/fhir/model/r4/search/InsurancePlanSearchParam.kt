...
public object InsurancePlanSearchParam {
  ...
  public data object Address : SearchParam<InsurancePlan, dev.ohs.fhir.model.r4.Address> {
  ...
  public data object AddressCity : SearchParam<InsurancePlan, R4String> {
  ...
  public data object AddressCountry : SearchParam<InsurancePlan, R4String> {
  ...
  public data object AddressPostalcode : SearchParam<InsurancePlan, R4String> {
  ...
  public data object AddressState : SearchParam<InsurancePlan, R4String> {
  ...
  public data object Identifier : SearchParam<InsurancePlan, dev.ohs.fhir.model.r4.Identifier> {
  ...
  public data object Phonetic : SearchParam<InsurancePlan, R4String> {
