...
internal object ConceptMapSourceSerializer : KSerializer<ConceptMap.Source> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ConceptMap.Source") {
      ...
      element("sourceCanonical", KotlinString.serializer().descriptor, isOptional = true)
      element("_sourceCanonical", Element.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ConceptMap.Source {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> sourceUri = decoder.decodeStringElement(__desc, 0)
        1 ->
          _sourceUri =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> sourceCanonical = decoder.decodeStringElement(__desc, 2)
        3 ->
          _sourceCanonical =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding ConceptMap.Source: " + __i)
      }
    }
    return ConceptMap.Source.from(
...
internal object ConceptMapTargetSerializer : KSerializer<ConceptMap.Target> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ConceptMap.Target") {
      ...
      element("targetCanonical", KotlinString.serializer().descriptor, isOptional = true)
      element("_targetCanonical", Element.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ConceptMap.Target {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          _targetUri =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> targetCanonical = decoder.decodeStringElement(__desc, 2)
        3 ->
          _targetCanonical =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding ConceptMap.Target: " + __i)
      }
    }
    return ConceptMap.Target.from(
