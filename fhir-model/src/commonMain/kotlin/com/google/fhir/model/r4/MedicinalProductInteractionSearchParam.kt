...
public sealed class MedicinalProductInteractionSearchParam<T> : SearchParam {
  ...
  public data object Subject : MedicinalProductInteractionSearchParam<Any>() {
    ...
    public override fun extract(resource: MedicinalProductInteraction): List<Any> = emptyList()
  }
