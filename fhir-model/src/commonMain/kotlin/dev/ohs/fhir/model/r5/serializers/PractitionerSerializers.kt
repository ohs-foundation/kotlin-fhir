...
internal object PractitionerDeceasedSerializer : KSerializer<Practitioner.Deceased> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Practitioner.Deceased") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Practitioner.Deceased {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding Practitioner.Deceased: " + __i)
      }
    }
    return Practitioner.Deceased.from(
