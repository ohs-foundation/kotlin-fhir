  ...
  private fun deserializeJson(decoder: CompositeDecoder): CompartmentDefinition.Resource {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        5 ->
          `param` = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.paramSer, null)
        6 ->
          _param = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.paramSer2, null)
        ...
        9 -> startParam = decoder.decodeStringElement(__desc, __i)
        10 ->
          _startParam =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.codeSer, null)
        11 -> endParam = decoder.decodeStringElement(__desc, __i)
        12 ->
          _endParam = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.codeSer, null)
...
internal object CompartmentDefinitionSerializer : KSerializer<CompartmentDefinition> {
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        13 ->
          _version =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        14 -> versionAlgorithmString = decoder.decodeStringElement(__desc, __i)
        15 ->
        ...
        17 -> name = decoder.decodeStringElement(__desc, __i)
        18 ->
          _name =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        19 -> title = decoder.decodeStringElement(__desc, __i)
        20 ->
          _title =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        ...
        34 ->
          _purpose =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        35 -> code = decoder.decodeStringElement(__desc, __i)
        36 ->
          _code =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        37 -> search = decoder.decodeBooleanElement(__desc, __i)
        38 ->
          _search =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        39 ->
  ...
  internal fun serializeJson(
    ...
    ((value.name.value))?.let { encoder.encodeStringElement(__desc, 17 + __off, it) }
    (value.name.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 18 + __off, Hoisted.implicitRulesSer, it)
    }
    ((value.title?.value))?.let { encoder.encodeStringElement(__desc, 19 + __off, it) }
    ...
    ((value.code.value?.getCode()))?.let { encoder.encodeStringElement(__desc, 35 + __off, it) }
    (value.code.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 36 + __off, Hoisted.implicitRulesSer, it)
    }
    ((value.search.value))?.let { encoder.encodeBooleanElement(__desc, 37 + __off, it) }
    ...
    if (value.resource.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 39 + __off, Hoisted.resourceSer, value.resource)
  }
...
internal object CompartmentDefinitionPolymorphicSerializer : KSerializer<CompartmentDefinition> {
  ...
  override fun serialize(encoder: Encoder, `value`: CompartmentDefinition) {
    encoder.encodeStructure(descriptor) {
      CompartmentDefinitionSerializer.serializeJson(this, descriptor, 0, value)
    }
  }

  override fun deserialize(decoder: Decoder): CompartmentDefinition =
    decoder.decodeStructure(descriptor) {
      CompartmentDefinitionSerializer.deserializeJson(this, descriptor, 0)
    }
}
