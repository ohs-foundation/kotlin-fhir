...
public sealed class OrganizationSearchParam<T> : SearchParam {
  ...
  public data object Address : OrganizationSearchParam<Any>() {
    ...
    public override val expression: String = "Organization.contact.address"
  ...
  public data object AddressCity : OrganizationSearchParam<Any>() {
    ...
    public override val expression: String = "Organization.contact.address.city"
  ...
  public data object AddressCountry : OrganizationSearchParam<Any>() {
    ...
    public override val expression: String = "Organization.contact.address.country"
  ...
  public data object AddressPostalcode : OrganizationSearchParam<Any>() {
    ...
    public override val expression: String = "Organization.contact.address.postalCode"
  ...
  public data object AddressState : OrganizationSearchParam<Any>() {
    ...
    public override val expression: String = "Organization.contact.address.state"
  ...
  public data object AddressUse : OrganizationSearchParam<Any>() {
    ...
    public override val expression: String = "Organization.contact.address.use"
