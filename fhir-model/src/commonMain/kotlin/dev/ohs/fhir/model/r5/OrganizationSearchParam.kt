...
public sealed class OrganizationSearchParam<T> : SearchParam {
  ...
  public data object Address : OrganizationSearchParam<dev.ohs.fhir.model.r5.Address>() {
    ...
    public override val expression: kotlin.String = "Organization.contact.address"
  ...
  public data object AddressCity : OrganizationSearchParam<String>() {
    ...
    public override val expression: kotlin.String = "Organization.contact.address.city"
  ...
  public data object AddressCountry : OrganizationSearchParam<String>() {
    ...
    public override val expression: kotlin.String = "Organization.contact.address.country"
  ...
  public data object AddressPostalcode : OrganizationSearchParam<String>() {
    ...
    public override val expression: kotlin.String = "Organization.contact.address.postalCode"
  ...
  public data object AddressState : OrganizationSearchParam<String>() {
    ...
    public override val expression: kotlin.String = "Organization.contact.address.state"
  ...
  public data object AddressUse : OrganizationSearchParam<Any>() {
    ...
    public override val expression: kotlin.String = "Organization.contact.address.use"
