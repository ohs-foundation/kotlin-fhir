...
public sealed class StructureDefinitionSearchParam<T> : SearchParam {
  ...
  public data object ExtContext : StructureDefinitionSearchParam<Any>() {
    ...
    public override val expression: String = "StructureDefinition.context"
  ...
  public data object ExtContextExpression : StructureDefinitionSearchParam<Any>() {
    public override val paramName: String = "ext-context-expression"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "StructureDefinition.context.expression"
  ...
  public data object ExtContextType : StructureDefinitionSearchParam<Any>() {
    public override val paramName: String = "ext-context-type"
