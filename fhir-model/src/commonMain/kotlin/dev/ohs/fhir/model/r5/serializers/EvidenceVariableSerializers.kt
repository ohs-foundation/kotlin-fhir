...
internal object EvidenceVariableVersionAlgorithmSerializer :
  KSerializer<EvidenceVariable.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): EvidenceVariable.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.VersionAlgorithm: " + __i
          )
      }
    }
    return EvidenceVariable.VersionAlgorithm.from(
...
internal object EvidenceVariableCharacteristicDefinitionByTypeAndValueValueSerializer :
  KSerializer<EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value.Boolean -> {
          ((__d.value.value))?.let { encodeBooleanElement(__desc, 1, it) }
          (__d.value.toElement())?.let {
        ...
        is EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value.Range -> {
          encodeSerializableElement(__desc, 4, Hoisted.valueRangeSer, __d.value)
        }
        is EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value.Reference -> {
          encodeSerializableElement(__desc, 5, Hoisted.valueReferenceSer, __d.value)
        }
        is EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value.Id -> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 -> valueBoolean = decoder.decodeBooleanElement(__desc, 1)
        2 ->
          _valueBoolean =
        ...
        4 ->
          valueRange =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.valueRangeSer, null)
        5 ->
          valueReference =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.valueReferenceSer, null)
        6 -> valueId = decoder.decodeStringElement(__desc, 6)
        7 ->
          _valueId = decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value: " +
              __i
          )
      }
    }
    return EvidenceVariable.Characteristic.DefinitionByTypeAndValue.Value.from(
      valueCodeableConcept,
      R5Boolean.of(valueBoolean, _valueBoolean),
      valueQuantity,
      valueRange,
...
internal object EvidenceVariableCharacteristicInstancesSerializer :
  KSerializer<EvidenceVariable.Characteristic.Instances> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.Characteristic.Instances") {
      element("instancesQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("instancesRange", Range.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: EvidenceVariable.Characteristic.Instances) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is EvidenceVariable.Characteristic.Instances.Quantity -> {
          encodeSerializableElement(__desc, 0, Hoisted.instancesQuantitySer, __d.value)
        }
        is EvidenceVariable.Characteristic.Instances.Range -> {
          encodeSerializableElement(__desc, 1, Hoisted.instancesRangeSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          instancesQuantity =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.instancesQuantitySer, null)
        1 ->
          instancesRange =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.instancesRangeSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.Characteristic.Instances: " + __i
          )
      }
    }
    return EvidenceVariable.Characteristic.Instances.from(instancesQuantity, instancesRange)!!
  }
...
internal object EvidenceVariableCharacteristicDurationSerializer :
  KSerializer<EvidenceVariable.Characteristic.Duration> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.Characteristic.Duration") {
      element("durationQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("durationRange", Range.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: EvidenceVariable.Characteristic.Duration) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is EvidenceVariable.Characteristic.Duration.Quantity -> {
          encodeSerializableElement(__desc, 0, Hoisted.durationQuantitySer, __d.value)
        }
        is EvidenceVariable.Characteristic.Duration.Range -> {
          encodeSerializableElement(__desc, 1, Hoisted.durationRangeSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          durationQuantity =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.durationQuantitySer, null)
        1 ->
          durationRange =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.durationRangeSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.Characteristic.Duration: " + __i
          )
      }
    }
    return EvidenceVariable.Characteristic.Duration.from(durationQuantity, durationRange)!!
  }

  private object Hoisted {
    public val durationQuantitySer: KSerializer<Quantity> = Quantity.serializer()

    public val durationRangeSer: KSerializer<Range> = Range.serializer()
  }
}

internal object EvidenceVariableCharacteristicTimeFromEventEventSerializer :
  KSerializer<EvidenceVariable.Characteristic.TimeFromEvent.Event> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.Characteristic.TimeFromEvent.Event") {
      element("eventCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("eventReference", Reference.serializer().descriptor, isOptional = true)
      element("eventDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_eventDateTime", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is EvidenceVariable.Characteristic.TimeFromEvent.Event.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.eventCodeableConceptSer, __d.value)
        }
        is EvidenceVariable.Characteristic.TimeFromEvent.Event.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.eventReferenceSer, __d.value)
        }
        is EvidenceVariable.Characteristic.TimeFromEvent.Event.DateTime -> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          eventReference =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.eventReferenceSer, null)
        2 -> eventDateTime = decoder.decodeStringElement(__desc, 2)
        3 ->
          _eventDateTime =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        4 -> eventId = decoder.decodeStringElement(__desc, 4)
        5 ->
          _eventId = decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.Characteristic.TimeFromEvent.Event: " + __i
          )
      }
    }
    return EvidenceVariable.Characteristic.TimeFromEvent.Event.from(
      eventCodeableConcept,
      eventReference,
      DateTime.of(FhirDateTime.fromString(eventDateTime), _eventDateTime),
      Id.of(eventId, _eventId),
...
internal object EvidenceVariableCategoryValueSerializer :
  KSerializer<EvidenceVariable.Category.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("EvidenceVariable.Category.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("valueRange", Range.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): EvidenceVariable.Category.Value {
    val __desc = descriptor
    var valueCodeableConcept: CodeableConcept? = null
    var valueQuantity: Quantity? = null
    var valueRange: Range? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding EvidenceVariable.Category.Value: " + __i
          )
      }
    }
    return EvidenceVariable.Category.Value.from(valueCodeableConcept, valueQuantity, valueRange)!!
  }
