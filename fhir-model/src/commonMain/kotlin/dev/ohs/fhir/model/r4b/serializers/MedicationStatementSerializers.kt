...
internal object MedicationStatementMedicationSerializer :
  KSerializer<MedicationStatement.Medication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicationStatement.Medication") {
      element(
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MedicationStatement.Medication {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicationStatement.Medication: " + __i
          )
      }
    }
    return MedicationStatement.Medication.from(medicationCodeableConcept, medicationReference)!!
  }
