...
internal object StructureDefinitionVersionAlgorithmSerializer :
  KSerializer<StructureDefinition.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("StructureDefinition.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): StructureDefinition.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding StructureDefinition.VersionAlgorithm: " + __i
          )
      }
    }
    return StructureDefinition.VersionAlgorithm.from(
