...
internal object OrganizationAffiliationSerializer : KSerializer<OrganizationAffiliation> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("OrganizationAffiliation") {
      ...
      element("participatingOrganization", Reference.serializer().descriptor, isOptional = true)
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: OrganizationAffiliation) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "OrganizationAffiliation")
