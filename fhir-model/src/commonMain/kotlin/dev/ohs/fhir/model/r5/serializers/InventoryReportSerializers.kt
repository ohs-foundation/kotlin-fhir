...
internal object InventoryReportSerializer : KSerializer<InventoryReport> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("InventoryReport") {
      ...
      element("countType", String.serializer().descriptor, isOptional = true)
      element("_countType", Element.serializer().descriptor, isOptional = true)
      element("operationType", CodeableConcept.serializer().descriptor, isOptional = true)
      element("operationTypeReason", CodeableConcept.serializer().descriptor, isOptional = true)
      element("reportedDateTime", String.serializer().descriptor, isOptional = true)
      element("_reportedDateTime", Element.serializer().descriptor, isOptional = true)
      element("reporter", Reference.serializer().descriptor, isOptional = true)
      element("reportingPeriod", Period.serializer().descriptor, isOptional = true)
      element(
        "inventoryListing",
        listSerialDescriptor(
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: InventoryReport) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "InventoryReport")
