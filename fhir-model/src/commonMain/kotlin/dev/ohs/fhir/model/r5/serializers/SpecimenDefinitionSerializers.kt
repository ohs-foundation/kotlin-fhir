...
internal object SpecimenDefinitionVersionAlgorithmSerializer :
  KSerializer<SpecimenDefinition.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SpecimenDefinition.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SpecimenDefinition.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SpecimenDefinition.VersionAlgorithm: " + __i
          )
      }
    }
    return SpecimenDefinition.VersionAlgorithm.from(
...
internal object SpecimenDefinitionSubjectSerializer : KSerializer<SpecimenDefinition.Subject> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SpecimenDefinition.Subject") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SpecimenDefinition.Subject {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SpecimenDefinition.Subject: " + __i
          )
      }
    }
    return SpecimenDefinition.Subject.from(subjectCodeableConcept, subjectReference)!!
  }
...
internal object SpecimenDefinitionTypeTestedContainerMinimumVolumeSerializer :
  KSerializer<SpecimenDefinition.TypeTested.Container.MinimumVolume> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SpecimenDefinition.TypeTested.Container.MinimumVolume") {
      element("minimumVolumeQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("minimumVolumeString", KotlinString.serializer().descriptor, isOptional = true)
      element("_minimumVolumeString", Element.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is SpecimenDefinition.TypeTested.Container.MinimumVolume.Quantity -> {
          encodeSerializableElement(__desc, 0, Hoisted.minimumVolumeQuantitySer, __d.value)
        }
        is SpecimenDefinition.TypeTested.Container.MinimumVolume.String -> {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          minimumVolumeQuantity =
            decoder.decodeNullableSerializableElement(
              __desc,
              0,
              Hoisted.minimumVolumeQuantitySer,
              null,
            )
        1 -> minimumVolumeString = decoder.decodeStringElement(__desc, 1)
        2 ->
          _minimumVolumeString =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SpecimenDefinition.TypeTested.Container.MinimumVolume: " +
              __i
          )
      }
    }
    return SpecimenDefinition.TypeTested.Container.MinimumVolume.from(
      minimumVolumeQuantity,
      R5String.of(minimumVolumeString, _minimumVolumeString),
    )!!
  }
  ...
  private object Hoisted {
    public val minimumVolumeQuantitySer: KSerializer<Quantity> = Quantity.serializer()

    public val elementSer: KSerializer<Element> = Element.serializer()
  }
}

internal object SpecimenDefinitionTypeTestedContainerAdditiveAdditiveSerializer :
  KSerializer<SpecimenDefinition.TypeTested.Container.Additive.Additive> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SpecimenDefinition.TypeTested.Container.Additive.Additive") {
      element("additiveCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("additiveReference", Reference.serializer().descriptor, isOptional = true)
    }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SpecimenDefinition.TypeTested.Container.Additive.Additive: " +
              __i
          )
      }
    }
    return SpecimenDefinition.TypeTested.Container.Additive.Additive.from(
      additiveCodeableConcept,
      additiveReference,
    )!!
  }
