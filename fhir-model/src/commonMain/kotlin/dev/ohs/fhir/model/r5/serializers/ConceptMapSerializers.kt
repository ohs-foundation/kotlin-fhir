...
internal object ConceptMapVersionAlgorithmSerializer : KSerializer<ConceptMap.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ConceptMap.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ConceptMap.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ConceptMap.VersionAlgorithm: " + __i
          )
      }
    }
    return ConceptMap.VersionAlgorithm.from(
...
internal object ConceptMapSourceScopeSerializer : KSerializer<ConceptMap.SourceScope> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ConceptMap.SourceScope") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ConceptMap.SourceScope {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> sourceScopeUri = decoder.decodeStringElement(__desc, 0)
        1 ->
          _sourceScopeUri =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> sourceScopeCanonical = decoder.decodeStringElement(__desc, 2)
        3 ->
          _sourceScopeCanonical =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding ConceptMap.SourceScope: " + __i)
      }
    }
    return ConceptMap.SourceScope.from(
...
internal object ConceptMapTargetScopeSerializer : KSerializer<ConceptMap.TargetScope> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ConceptMap.TargetScope") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ConceptMap.TargetScope {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> targetScopeUri = decoder.decodeStringElement(__desc, 0)
        1 ->
          _targetScopeUri =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> targetScopeCanonical = decoder.decodeStringElement(__desc, 2)
        3 ->
          _targetScopeCanonical =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding ConceptMap.TargetScope: " + __i)
      }
    }
    return ConceptMap.TargetScope.from(
...
internal object ConceptMapGroupElementTargetPropertyValueSerializer :
  KSerializer<ConceptMap.Group.Element.Target.Property.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ConceptMap.Group.Element.Target.Property.Value") {
      element("valueCoding", Coding.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueString", Element.serializer().descriptor, isOptional = true)
      element("valueInteger", Int.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is ConceptMap.Group.Element.Target.Property.Value.Coding -> {
          encodeSerializableElement(__desc, 0, Hoisted.valueCodingSer, __d.value)
        }
        is ConceptMap.Group.Element.Target.Property.Value.String -> {
        ...
        is ConceptMap.Group.Element.Target.Property.Value.DateTime -> {
          ((__d.value.value?.toString()))?.let { encodeStringElement(__desc, 7, it) }
          (__d.value.toElement())?.let {
        ...
        is ConceptMap.Group.Element.Target.Property.Value.Decimal -> {
          ((__d.value.value))?.let {
            encodeSerializableElement(__desc, 9, BigDecimalSerializer, it)
          }
          (__d.value.toElement())?.let {
        ...
        is ConceptMap.Group.Element.Target.Property.Value.Code -> {
          ((__d.value.value))?.let { encodeStringElement(__desc, 11, it) }
          (__d.value.toElement())?.let {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          valueCoding =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.valueCodingSer, null)
        ...
        7 -> valueDateTime = decoder.decodeStringElement(__desc, 7)
        8 ->
          _valueDateTime =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ConceptMap.Group.Element.Target.Property.Value: " + __i
          )
      }
    }
    return ConceptMap.Group.Element.Target.Property.Value.from(
      valueCoding,
      R5String.of(valueString, _valueString),
      Integer.of(valueInteger, _valueInteger),
      R5Boolean.of(valueBoolean, _valueBoolean),
...
internal object ConceptMapGroupElementTargetDependsOnValueSerializer :
  KSerializer<ConceptMap.Group.Element.Target.DependsOn.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ConceptMap.Group.Element.Target.DependsOn.Value") {
      element("valueCode", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueCode", Element.serializer().descriptor, isOptional = true)
      element("valueCoding", Coding.serializer().descriptor, isOptional = true)
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ConceptMap.Group.Element.Target.DependsOn.Value.Quantity -> {
          encodeSerializableElement(__desc, 7, Hoisted.valueQuantitySer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ConceptMap.Group.Element.Target.DependsOn.Value: " + __i
          )
      }
    }
    return ConceptMap.Group.Element.Target.DependsOn.Value.from(
      Code.of(valueCode, _valueCode),
      valueCoding,
      R5String.of(valueString, _valueString),
      R5Boolean.of(valueBoolean, _valueBoolean),
