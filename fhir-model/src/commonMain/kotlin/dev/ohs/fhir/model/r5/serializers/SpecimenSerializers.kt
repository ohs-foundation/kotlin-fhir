    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        3 ->
          device = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.deviceSer, null)
        4 ->
          location = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.deviceSer, null)
        5 ->
          specimenQuantity =
            decoder.decodeNullableSerializableElement(
              __desc,
...
internal object SpecimenSerializer : KSerializer<Specimen> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        20 -> combined = decoder.decodeStringElement(__desc, __i)
        21 ->
          _combined =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        22 -> role = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.roleSer, null)
        23 ->
          feature = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.featureSer, null)
        24 ->
          collection =
        ...
        27 ->
          condition = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.roleSer, null)
  ...
  internal fun serializeJson(
    ...
    if (value.role.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 22 + __off, Hoisted.roleSer, value.role)
    if (value.feature.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 23 + __off, Hoisted.featureSer, value.feature)
    (value.collection)?.let {
      encoder.encodeSerializableElement(__desc, 24 + __off, Hoisted.collectionSer, it)
    }
    if (value.processing.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 25 + __off, Hoisted.processingSer, value.processing)
    if (value.container.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 26 + __off, Hoisted.containerSer, value.container)
    if (value.condition.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 27 + __off, Hoisted.roleSer, value.condition)
