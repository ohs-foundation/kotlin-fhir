...
public object InvoiceSearchParam {
  ...
  public data object Identifier : SearchParam<Invoice, dev.ohs.fhir.model.r4b.Identifier> {
    ...
    public override fun extract(resource: Invoice): List<dev.ohs.fhir.model.r4b.Identifier> =
      resource.identifier
  }
  ...
  public data object Recipient : SearchParam<Invoice, Reference> {
    ...
    public override val target: List<KClass<out Resource>> =
      listOf(Organization::class, dev.ohs.fhir.model.r4b.Patient::class, RelatedPerson::class)
