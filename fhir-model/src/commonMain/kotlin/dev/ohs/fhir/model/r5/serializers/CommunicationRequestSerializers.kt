...
internal object CommunicationRequestPayloadContentSerializer :
  KSerializer<CommunicationRequest.Payload.Content> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CommunicationRequest.Payload.Content") {
      element("contentAttachment", Attachment.serializer().descriptor, isOptional = true)
      element("contentReference", Reference.serializer().descriptor, isOptional = true)
      element("contentCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: CommunicationRequest.Payload.Content) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is CommunicationRequest.Payload.Content.CodeableConcept -> {
          encodeSerializableElement(__desc, 2, Hoisted.contentCodeableConceptSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CommunicationRequest.Payload.Content {
    val __desc = descriptor
    var contentAttachment: Attachment? = null
    var contentReference: Reference? = null
    var contentCodeableConcept: CodeableConcept? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CommunicationRequest.Payload.Content: " + __i
          )
      }
    }
    return CommunicationRequest.Payload.Content.from(
      contentAttachment,
      contentReference,
      contentCodeableConcept,
    )!!
...
internal object CommunicationRequestOccurrenceSerializer :
  KSerializer<CommunicationRequest.Occurrence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CommunicationRequest.Occurrence") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CommunicationRequest.Occurrence {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CommunicationRequest.Occurrence: " + __i
          )
      }
    }
    return CommunicationRequest.Occurrence.from(
