...
public object DeviceUseStatementSearchParams {
   ...
   * subtracted from [all].
   */
  public val unsupported: List<SearchParam<DeviceUseStatement, *>> = listOf()

  /**
   * Supported search parameters for the DeviceUseStatement resource type. Entries in [unsupported]
  ...
  public val all: List<SearchParam<DeviceUseStatement, *>> =
    listOf(device, identifier, patient, subject) - unsupported.toSet()
}
