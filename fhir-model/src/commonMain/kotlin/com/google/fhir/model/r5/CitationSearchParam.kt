...
public sealed class CitationSearchParam<T> : SearchParam {
  ...
  public data object Classification : CitationSearchParam<Any>() {
    public override val paramName: String = "classification"

    public override val type: SearchParamType = SearchParamType.fromCode("composite")

    public override val expression: String = "Citation.classification"
  ...
  public data object ClassificationType : CitationSearchParam<Any>() {
    ...
    public override val expression: String = "(Citation.classification.type)"
  ...
  public data object Classifier : CitationSearchParam<Any>() {
    ...
    public override val expression: String = "(Citation.classification.classifier)"
  ...
  public data object Context : CitationSearchParam<Any>() {
    ...
    public override val expression: String = "(Citation.useContext.value.ofType(CodeableConcept))"
  ...
  public data object ContextQuantity : CitationSearchParam<Any>() {
    ...
    public override val expression: String = "(Citation.useContext.value.ofType(Quantity))"
