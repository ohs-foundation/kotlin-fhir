...
public object TestPlanSearchParam {
  ...
  public data object Identifier : SearchParam<TestPlan, dev.ohs.fhir.model.r5.Identifier> {
    ...
    public override val expression: String = "TestPlan.identifier"
  ...
  public data object Scope : SearchParam<TestPlan, Reference> {
    ...
    public override val expression: String = "TestPlan.scope"
    ...
    public override fun extract(resource: TestPlan): CollectionsList<Reference> = resource.scope
  }
  ...
  public data object Status : SearchParam<TestPlan, Any> {
    ...
    public override val expression: String = "TestPlan.status"

    public override val target: CollectionsList<KClass<out Resource>> = emptyList()

    public override fun extract(resource: TestPlan): CollectionsList<Any> = listOf(resource.status)
  }
  ...
  public data object Url : SearchParam<TestPlan, Uri> {
    ...
    public override val expression: String = "TestPlan.url"

    public override val target: CollectionsList<KClass<out Resource>> = emptyList()

    public override fun extract(resource: TestPlan): CollectionsList<Uri> =
