...
internal object CapabilityStatementVersionAlgorithmSerializer :
  KSerializer<CapabilityStatement.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CapabilityStatement.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CapabilityStatement.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CapabilityStatement.VersionAlgorithm: " + __i
          )
      }
    }
    return CapabilityStatement.VersionAlgorithm.from(
