...
internal object MolecularSequenceRelativeStartingSequenceSequenceSerializer :
  KSerializer<MolecularSequence.Relative.StartingSequence.Sequence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MolecularSequence.Relative.StartingSequence.Sequence") {
      element("sequenceCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("sequenceString", KotlinString.serializer().descriptor, isOptional = true)
      element("_sequenceString", Element.serializer().descriptor, isOptional = true)
      element("sequenceReference", Reference.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is MolecularSequence.Relative.StartingSequence.Sequence.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.sequenceCodeableConceptSer, __d.value)
        }
        is MolecularSequence.Relative.StartingSequence.Sequence.String -> {
        ...
        is MolecularSequence.Relative.StartingSequence.Sequence.Reference -> {
          encodeSerializableElement(__desc, 3, Hoisted.sequenceReferenceSer, __d.value)
        }
      }
    }
  }
        ...
        0 ->
          sequenceCodeableConcept =
            decoder.decodeNullableSerializableElement(
              __desc,
              0,
              Hoisted.sequenceCodeableConceptSer,
              null,
            )
        1 -> sequenceString = decoder.decodeStringElement(__desc, 1)
        2 ->
          _sequenceString =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.elementSer, null)
        3 ->
          sequenceReference =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.sequenceReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding MolecularSequence.Relative.StartingSequence.Sequence: " + __i
          )
      }
    }
    return MolecularSequence.Relative.StartingSequence.Sequence.from(
      sequenceCodeableConcept,
      R5String.of(sequenceString, _sequenceString),
      sequenceReference,
    )!!
  ...
  private object Hoisted {
    public val sequenceCodeableConceptSer: KSerializer<CodeableConcept> =
...
internal object MolecularSequenceSerializer : KSerializer<MolecularSequence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MolecularSequence") {
      ...
      element("literal", KotlinString.serializer().descriptor, isOptional = true)
      element("_literal", Element.serializer().descriptor, isOptional = true)
      element(
        "formatted",
