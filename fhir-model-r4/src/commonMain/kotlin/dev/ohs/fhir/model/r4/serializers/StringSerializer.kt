...
internal object StringSerializer : KSerializer<R4String> {
  ...
  override fun serialize(encoder: Encoder, `value`: R4String) {
  ...
  override fun deserialize(decoder: Decoder): R4String =
    decoder.decodeStructure(descriptor) {
      ...
      R4String(id = id, extension = extension, `value` = `value`)
    }
}
