...
public sealed class LibrarySearchParam<T> : SearchParam {
  ...
  public data object ContextQuantity : LibrarySearchParam<Any>() {
    ...
    public override val expression: KotlinString = "(Library.useContext.value.ofType(Quantity))"
  ...
  public data object Identifier : LibrarySearchParam<dev.ohs.fhir.model.r5.Identifier>() {
    ...
    public override fun extract(resource: Library): List<dev.ohs.fhir.model.r5.Identifier> =
      resource.identifier
  }
  ...
  public data object Name : LibrarySearchParam<R5String>() {
    ...
    public override fun extract(resource: Library): List<R5String> = listOfNotNull(resource.name)
  }
  ...
  public data object Publisher : LibrarySearchParam<R5String>() {
    ...
    public override fun extract(resource: Library): List<R5String> =
  ...
  public data object Title : LibrarySearchParam<R5String>() {
    ...
    public override fun extract(resource: Library): List<R5String> = listOfNotNull(resource.title)
  }
  ...
  public data object Version : LibrarySearchParam<R5String>() {
    ...
    public override fun extract(resource: Library): List<R5String> = listOfNotNull(resource.version)
  }
