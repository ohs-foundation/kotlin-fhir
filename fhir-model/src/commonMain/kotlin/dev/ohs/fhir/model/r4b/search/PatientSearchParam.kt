...
public sealed class PatientSearchParam<T> : SearchParam {
  ...
  public data object Address : PatientSearchParam<dev.ohs.fhir.model.r4b.Address>() {
  ...
  public data object AddressCity : PatientSearchParam<R4bString>() {
  ...
  public data object AddressCountry : PatientSearchParam<R4bString>() {
  ...
  public data object AddressPostalcode : PatientSearchParam<R4bString>() {
  ...
  public data object AddressState : PatientSearchParam<R4bString>() {
  ...
  public data object DeathDate : PatientSearchParam<DateTime>() {
  ...
  public data object Family : PatientSearchParam<R4bString>() {
  ...
  public data object Given : PatientSearchParam<R4bString>() {
  ...
  public data object Identifier : PatientSearchParam<dev.ohs.fhir.model.r4b.Identifier>() {
