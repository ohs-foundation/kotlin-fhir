    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        6 ->
          _timestamp =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.identifierSer, null)
        7 -> total = decoder.decodeIntElement(__desc, __i)
        8 ->
          _total =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.identifierSer, null)
        9 -> offset = decoder.decodeIntElement(__desc, __i)
        10 ->
          _offset =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.identifierSer, null)
        11 ->
...
internal object ValueSetSerializer : KSerializer<ValueSet> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        32 -> immutable = decoder.decodeBooleanElement(__desc, __i)
        33 ->
          _immutable =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
  ...
  internal fun serializeJson(
    ...
    ((value.immutable?.value))?.let { encoder.encodeBooleanElement(__desc, 32 + __off, it) }
    ...
    (value.compose)?.let {
      encoder.encodeSerializableElement(__desc, 38 + __off, Hoisted.composeSer, it)
    }
    (value.expansion)?.let {
      encoder.encodeSerializableElement(__desc, 39 + __off, Hoisted.expansionSer, it)
    }
  }
