...
public object CarePlanSearchParam {
  ...
  public data object CareTeam : SearchParam<CarePlan, Reference> {
    ...
    public override val target: List<KClass<out Resource>> =
      listOf(dev.ohs.fhir.model.r4b.CareTeam::class)
  ...
  public data object Goal : SearchParam<CarePlan, Reference> {
    ...
    public override val target: List<KClass<out Resource>> =
      listOf(dev.ohs.fhir.model.r4b.Goal::class)

    public override fun extract(resource: CarePlan): List<Reference> = resource.goal
  }

  public data object Identifier : SearchParam<CarePlan, dev.ohs.fhir.model.r4b.Identifier> {
    ...
    public override fun extract(resource: CarePlan): List<dev.ohs.fhir.model.r4b.Identifier> =
      resource.identifier
  }
