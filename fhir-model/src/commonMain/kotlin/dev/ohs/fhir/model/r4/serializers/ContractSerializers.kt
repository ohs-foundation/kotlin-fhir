  ...
  private fun deserializeJson(decoder: CompositeDecoder): Contract.ContentDefinition {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 -> subType = decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.typeSer, null)
        5 ->
          publisher =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.publisherSer, null)
        6 -> publicationDate = decoder.decodeStringElement(__desc, 6)
        7 ->
          _publicationDate =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.publicationDateSer, null)
        8 -> publicationStatus = decoder.decodeStringElement(__desc, 8)
        9 ->
          _publicationStatus =
            decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.publicationDateSer, null)
        10 -> copyright = decoder.decodeStringElement(__desc, 10)
        11 ->
          _copyright =
            decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.publicationDateSer, null)
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Contract.Term {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 -> issued = decoder.decodeStringElement(__desc, 4)
        5 -> _issued = decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.issuedSer, null)
        6 ->
          applies = decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.appliesSer, null)
        7 ->
        ...
        8 ->
          topicReference =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.topicReferenceSer, null)
        9 ->
          type =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        11 -> text = decoder.decodeStringElement(__desc, 11)
        12 -> _text = decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.issuedSer, null)
        13 ->
          securityLabel =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.securityLabelSer, null)
        14 -> offer = decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.offerSer, null)
        15 -> asset = decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.assetSer, null)
        16 ->
          action = decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.actionSer, null)
        17 -> group = decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.groupSer, null)
        CompositeDecoder.DECODE_DONE -> break
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          modifierExtension =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.extensionSer, null)
        3 -> number = decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.numberSer, null)
        4 ->
          _number = decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.numberSer2, null)
        5 ->
          classification =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.classificationSer, null)
        6 ->
          category = decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.categorySer, null)
        7 ->
          control = decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.categorySer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Contract.Term.Offer {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        5 -> topic = decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.topicSer, null)
        6 -> type = decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.typeSer, null)
        7 -> decision = decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.typeSer, null)
        8 ->
          decisionMode =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.decisionModeSer, null)
        ...
        11 -> _text = decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.textSer, null)
        12 ->
          linkId = decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.linkIdSer, null)
        13 ->
          _linkId = decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.linkIdSer2, null)
        14 ->
          securityLabelNumber =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        15 ->
          _securityLabelNumber =
            decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.linkIdSer2, null)
        CompositeDecoder.DECODE_DONE -> break
    ...
    return Contract.Term.Offer(
      ...
      linkId =
        (kotlin.collections.List(maxOf(linkId?.size ?: 0, _linkId?.size ?: 0)) { __i ->
          R4String.of(linkId?.getOrNull(__i)?.let { it }, _linkId?.getOrNull(__i))!!
        }),
      securityLabelNumber =
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          modifierExtension =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.extensionSer, null)
        3 -> scope = decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.scopeSer, null)
        4 -> type = decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.typeSer, null)
        5 ->
          typeReference =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.typeReferenceSer, null)
        6 -> subtype = decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.typeSer, null)
        7 ->
          relationship =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.relationshipSer, null)
        8 ->
          context = decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.contextSer, null)
        9 -> condition = decoder.decodeStringElement(__desc, 9)
        10 ->
          _condition =
            decoder.decodeNullableSerializableElement(__desc, 10, Hoisted.conditionSer, null)
        11 ->
          periodType = decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.typeSer, null)
        12 ->
          period = decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.periodSer, null)
        13 ->
          usePeriod = decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.periodSer, null)
        14 -> text = decoder.decodeStringElement(__desc, 14)
        15 ->
          _text = decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.conditionSer, null)
        16 ->
          linkId = decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.linkIdSer, null)
        17 ->
          _linkId = decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.linkIdSer2, null)
        18 ->
          answer = decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.answerSer, null)
        19 ->
          securityLabelNumber =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        20 ->
          _securityLabelNumber =
            decoder.decodeNullableSerializableElement(__desc, 20, Hoisted.linkIdSer2, null)
        21 ->
          valuedItem =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.valuedItemSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Contract.Term.Asset.ValuedItem {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 ->
          entityReference =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.entityReferenceSer, null)
        5 ->
          identifier =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.identifierSer, null)
        6 -> effectiveTime = decoder.decodeStringElement(__desc, 6)
        7 ->
          _effectiveTime =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.effectiveTimeSer, null)
        8 ->
        ...
        11 ->
          _factor =
            decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.effectiveTimeSer, null)
        12 ->
          points = decoder.decodeNullableSerializableElement(__desc, 12, BigDecimalSerializer, null)
        13 ->
          _points =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.effectiveTimeSer, null)
        14 ->
          net = decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.unitPriceSer, null)
        15 -> payment = decoder.decodeStringElement(__desc, 15)
        16 ->
          _payment =
            decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.effectiveTimeSer, null)
        17 -> paymentDate = decoder.decodeStringElement(__desc, 17)
        18 ->
          _paymentDate =
            decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.effectiveTimeSer, null)
        19 ->
          responsible =
            decoder.decodeNullableSerializableElement(__desc, 19, Hoisted.entityReferenceSer, null)
        20 ->
          recipient =
            decoder.decodeNullableSerializableElement(__desc, 20, Hoisted.entityReferenceSer, null)
        21 ->
          linkId = decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.linkIdSer, null)
        22 ->
          _linkId = decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.linkIdSer2, null)
        23 ->
          securityLabelNumber =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        24 ->
          _securityLabelNumber =
            decoder.decodeNullableSerializableElement(__desc, 24, Hoisted.linkIdSer2, null)
        CompositeDecoder.DECODE_DONE -> break
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          modifierExtension =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.extensionSer, null)
        3 -> doNotPerform = decoder.decodeBooleanElement(__desc, 3)
        4 ->
          _doNotPerform =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.doNotPerformSer, null)
        ...
        7 -> intent = decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.typeSer, null)
        8 -> linkId = decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.linkIdSer, null)
        9 ->
          _linkId = decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.linkIdSer2, null)
        10 -> status = decoder.decodeNullableSerializableElement(__desc, 10, Hoisted.typeSer, null)
        11 ->
          context = decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.contextSer, null)
        12 ->
          contextLinkId =
            decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.linkIdSer, null)
        13 ->
          _contextLinkId =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.linkIdSer2, null)
        14 -> occurrenceDateTime = decoder.decodeStringElement(__desc, 14)
        15 ->
          _occurrenceDateTime =
            decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.doNotPerformSer, null)
        16 ->
          occurrencePeriod =
            decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.occurrencePeriodSer, null)
        17 ->
          occurrenceTiming =
            decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.occurrenceTimingSer, null)
        18 ->
          requester =
            decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.requesterSer, null)
        19 ->
          requesterLinkId =
            decoder.decodeNullableSerializableElement(__desc, 19, Hoisted.linkIdSer, null)
        20 ->
          _requesterLinkId =
            decoder.decodeNullableSerializableElement(__desc, 20, Hoisted.linkIdSer2, null)
        21 ->
          performerType =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.performerTypeSer, null)
        22 ->
          performerRole =
            decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.typeSer, null)
        23 ->
          performer =
            decoder.decodeNullableSerializableElement(__desc, 23, Hoisted.contextSer, null)
        24 ->
          performerLinkId =
            decoder.decodeNullableSerializableElement(__desc, 24, Hoisted.linkIdSer, null)
        25 ->
          _performerLinkId =
            decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.linkIdSer2, null)
        26 ->
          reasonCode =
            decoder.decodeNullableSerializableElement(__desc, 26, Hoisted.performerTypeSer, null)
        27 ->
          reasonReference =
            decoder.decodeNullableSerializableElement(__desc, 27, Hoisted.requesterSer, null)
        28 ->
          reason = decoder.decodeNullableSerializableElement(__desc, 28, Hoisted.linkIdSer, null)
        29 ->
          _reason = decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.linkIdSer2, null)
        30 ->
          reasonLinkId =
            decoder.decodeNullableSerializableElement(__desc, 30, Hoisted.linkIdSer, null)
        31 ->
          _reasonLinkId =
            decoder.decodeNullableSerializableElement(__desc, 31, Hoisted.linkIdSer2, null)
        ...
        34 ->
          _securityLabelNumber =
            decoder.decodeNullableSerializableElement(__desc, 34, Hoisted.linkIdSer2, null)
        CompositeDecoder.DECODE_DONE -> break
    ...
    return Contract.Term.Action(
      ...
      contextLinkId =
        (kotlin.collections.List(maxOf(contextLinkId?.size ?: 0, _contextLinkId?.size ?: 0)) { __i
          ->
          R4String.of(contextLinkId?.getOrNull(__i)?.let { it }, _contextLinkId?.getOrNull(__i))!!
        }),
      occurrence =
      ...
      reason =
        (kotlin.collections.List(maxOf(reason?.size ?: 0, _reason?.size ?: 0)) { __i ->
          R4String.of(reason?.getOrNull(__i)?.let { it }, _reason?.getOrNull(__i))!!
        }),
      reasonLinkId =
        (kotlin.collections.List(maxOf(reasonLinkId?.size ?: 0, _reasonLinkId?.size ?: 0)) { __i ->
          R4String.of(reasonLinkId?.getOrNull(__i)?.let { it }, _reasonLinkId?.getOrNull(__i))!!
        }),
      note = note ?: listOf(),
      securityLabelNumber =
        (kotlin.collections.List(
  ...
  private fun deserializeJson(decoder: CompositeDecoder): Contract.Signer {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        5 ->
          signature =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.signatureSer, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object ContractTopicSerializer : KSerializer<Contract.Topic> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Topic") {
      element("topicCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("topicReference", Reference.serializer().descriptor, isOptional = true)
    }
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is Contract.Topic.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.topicCodeableConceptSer, __d.value)
        }
        is Contract.Topic.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.topicReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Topic {
    val __desc = descriptor
    var topicCodeableConcept: CodeableConcept? = null
    var topicReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          topicReference =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.topicReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Contract.Topic: " + __i)
      }
    }
    return Contract.Topic.from(topicCodeableConcept, topicReference)!!
  }
...
internal object ContractTermTopicSerializer : KSerializer<Contract.Term.Topic> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Term.Topic") {
      element("topicCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("topicReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Term.Topic {
    val __desc = descriptor
    var topicCodeableConcept: CodeableConcept? = null
    var topicReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding Contract.Term.Topic: " + __i)
      }
    }
    return Contract.Term.Topic.from(topicCodeableConcept, topicReference)!!
  }
...
internal object ContractTermOfferAnswerValueSerializer :
  KSerializer<Contract.Term.Offer.Answer.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Term.Offer.Answer.Value") {
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
      element("valueDecimal", BigDecimalSerializer.descriptor, isOptional = true)
      element("_valueDecimal", Element.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Term.Offer.Answer.Value {
    val __desc = descriptor
    var valueBoolean: KotlinBoolean? = null
    var _valueBoolean: Element? = null
    var valueDecimal: BigDecimal? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Contract.Term.Offer.Answer.Value: " + __i
          )
      }
    }
    return Contract.Term.Offer.Answer.Value.from(
      R4Boolean.of(valueBoolean, _valueBoolean),
      Decimal.of(valueDecimal, _valueDecimal),
      Integer.of(valueInteger, _valueInteger),
      Date.of(FhirDate.fromString(valueDate), _valueDate),
...
internal object ContractTermAssetValuedItemEntitySerializer :
  KSerializer<Contract.Term.Asset.ValuedItem.Entity> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Term.Asset.ValuedItem.Entity") {
      element("entityCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("entityReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: Contract.Term.Asset.ValuedItem.Entity) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is Contract.Term.Asset.ValuedItem.Entity.CodeableConcept -> {
          encodeSerializableElement(__desc, 0, Hoisted.entityCodeableConceptSer, __d.value)
        }
        is Contract.Term.Asset.ValuedItem.Entity.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.entityReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Term.Asset.ValuedItem.Entity {
    val __desc = descriptor
    var entityCodeableConcept: CodeableConcept? = null
    var entityReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          entityReference =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.entityReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding Contract.Term.Asset.ValuedItem.Entity: " + __i
          )
      }
    }
    return Contract.Term.Asset.ValuedItem.Entity.from(entityCodeableConcept, entityReference)!!
  }
...
internal object ContractTermActionOccurrenceSerializer :
  KSerializer<Contract.Term.Action.Occurrence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Term.Action.Occurrence") {
      element("occurrenceDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_occurrenceDateTime", Element.serializer().descriptor, isOptional = true)
      element("occurrencePeriod", Period.serializer().descriptor, isOptional = true)
      element("occurrenceTiming", Timing.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Term.Action.Occurrence {
    val __desc = descriptor
    var occurrenceDateTime: KotlinString? = null
    var _occurrenceDateTime: Element? = null
    var occurrencePeriod: Period? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding Contract.Term.Action.Occurrence: " + __i
          )
      }
    }
    return Contract.Term.Action.Occurrence.from(
      DateTime.of(FhirDateTime.fromString(occurrenceDateTime), _occurrenceDateTime),
      occurrencePeriod,
      occurrenceTiming,
    )!!
...
internal object ContractFriendlyContentSerializer : KSerializer<Contract.Friendly.Content> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Friendly.Content") {
      element("contentAttachment", Attachment.serializer().descriptor, isOptional = true)
      element("contentReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: Contract.Friendly.Content) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is Contract.Friendly.Content.Attachment -> {
          encodeSerializableElement(__desc, 0, Hoisted.contentAttachmentSer, __d.value)
        }
        is Contract.Friendly.Content.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.contentReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Friendly.Content {
    val __desc = descriptor
    var contentAttachment: Attachment? = null
    var contentReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          contentAttachment =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.contentAttachmentSer, null)
        1 ->
          contentReference =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.contentReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding Contract.Friendly.Content: " + __i
          )
      }
    }
    return Contract.Friendly.Content.from(contentAttachment, contentReference)!!
  }
...
internal object ContractLegalContentSerializer : KSerializer<Contract.Legal.Content> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Legal.Content") {
      element("contentAttachment", Attachment.serializer().descriptor, isOptional = true)
      element("contentReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Legal.Content {
    val __desc = descriptor
    var contentAttachment: Attachment? = null
    var contentReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding Contract.Legal.Content: " + __i)
      }
    }
    return Contract.Legal.Content.from(contentAttachment, contentReference)!!
  }
...
internal object ContractRuleContentSerializer : KSerializer<Contract.Rule.Content> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.Rule.Content") {
      element("contentAttachment", Attachment.serializer().descriptor, isOptional = true)
      element("contentReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.Rule.Content {
    val __desc = descriptor
    var contentAttachment: Attachment? = null
    var contentReference: Reference? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding Contract.Rule.Content: " + __i)
      }
    }
    return Contract.Rule.Content.from(contentAttachment, contentReference)!!
  }
...
internal object ContractLegallyBindingSerializer : KSerializer<Contract.LegallyBinding> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract.LegallyBinding") {
      element("legallyBindingAttachment", Attachment.serializer().descriptor, isOptional = true)
      element("legallyBindingReference", Reference.serializer().descriptor, isOptional = true)
    }
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is Contract.LegallyBinding.Attachment -> {
          encodeSerializableElement(__desc, 0, Hoisted.legallyBindingAttachmentSer, __d.value)
        }
        is Contract.LegallyBinding.Reference -> {
          encodeSerializableElement(__desc, 1, Hoisted.legallyBindingReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract.LegallyBinding {
    val __desc = descriptor
        ...
        1 ->
          legallyBindingReference =
            decoder.decodeNullableSerializableElement(
              __desc,
              1,
              Hoisted.legallyBindingReferenceSer,
              null,
            )
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding Contract.LegallyBinding: " + __i)
      }
    }
    return Contract.LegallyBinding.from(legallyBindingAttachment, legallyBindingReference)!!
  }

  private object Hoisted {
    public val legallyBindingAttachmentSer: KSerializer<Attachment> = Attachment.serializer()

    public val legallyBindingReferenceSer: KSerializer<Reference> = Reference.serializer()
  }
}
...
internal object ContractSerializer : KSerializer<Contract> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Contract") {
      ...
      element("legalState", CodeableConcept.serializer().descriptor, isOptional = true)
      element("instantiatesCanonical", Reference.serializer().descriptor, isOptional = true)
      ...
      element("contentDerivative", CodeableConcept.serializer().descriptor, isOptional = true)
      element("issued", KotlinString.serializer().descriptor, isOptional = true)
      element("_issued", Element.serializer().descriptor, isOptional = true)
      element("applies", Period.serializer().descriptor, isOptional = true)
      element("expirationType", CodeableConcept.serializer().descriptor, isOptional = true)
      ...
      element("domain", listSerialDescriptor(Reference.serializer().descriptor), isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Contract {
    val __desc = descriptor
    var id: KotlinString? = null
    var meta: Meta? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        12 -> url = decoder.decodeStringElement(__desc, 12)
        13 ->
          _url =
        ...
        18 ->
          legalState =
            decoder.decodeNullableSerializableElement(__desc, 18, Hoisted.legalStateSer, null)
        19 ->
        ...
        20 -> instantiatesUri = decoder.decodeStringElement(__desc, 20)
        21 ->
          _instantiatesUri =
            decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.implicitRulesSer, null)
        22 ->
          contentDerivative =
            decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.legalStateSer, null)
        ...
        25 ->
          applies = decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.appliesSer, null)
        26 ->
          expirationType =
            decoder.decodeNullableSerializableElement(__desc, 26, Hoisted.legalStateSer, null)
        27 ->
          subject = decoder.decodeNullableSerializableElement(__desc, 27, Hoisted.subjectSer, null)
        28 ->
          authority =
            decoder.decodeNullableSerializableElement(__desc, 28, Hoisted.subjectSer, null)
        29 ->
          domain = decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.subjectSer, null)
        30 -> site = decoder.decodeNullableSerializableElement(__desc, 30, Hoisted.subjectSer, null)
        31 -> name = decoder.decodeStringElement(__desc, 31)
        32 ->
          _name =
            decoder.decodeNullableSerializableElement(__desc, 32, Hoisted.implicitRulesSer, null)
        33 -> title = decoder.decodeStringElement(__desc, 33)
        34 ->
          _title =
            decoder.decodeNullableSerializableElement(__desc, 34, Hoisted.implicitRulesSer, null)
        35 -> subtitle = decoder.decodeStringElement(__desc, 35)
        36 ->
          _subtitle =
            decoder.decodeNullableSerializableElement(__desc, 36, Hoisted.implicitRulesSer, null)
        37 -> alias = decoder.decodeNullableSerializableElement(__desc, 37, Hoisted.aliasSer, null)
        38 ->
          _alias = decoder.decodeNullableSerializableElement(__desc, 38, Hoisted.aliasSer2, null)
        39 ->
          author =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        40 ->
          scope = decoder.decodeNullableSerializableElement(__desc, 40, Hoisted.legalStateSer, null)
        41 ->
          topicCodeableConcept =
            decoder.decodeNullableSerializableElement(__desc, 41, Hoisted.legalStateSer, null)
        42 ->
          topicReference =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        43 ->
          type = decoder.decodeNullableSerializableElement(__desc, 43, Hoisted.legalStateSer, null)
        44 ->
          subType = decoder.decodeNullableSerializableElement(__desc, 44, Hoisted.subTypeSer, null)
        45 ->
          contentDefinition =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        46 -> term = decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.termSer, null)
        47 ->
          supportingInfo =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.subjectSer, null)
        48 ->
          relevantHistory =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.subjectSer, null)
        49 ->
          signer = decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.signerSer, null)
        50 ->
          friendly =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.friendlySer, null)
        51 -> legal = decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.legalSer, null)
        52 -> rule = decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.ruleSer, null)
        53 ->
          legallyBindingAttachment =
            decoder.decodeNullableSerializableElement(
              __desc,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: Contract) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "Contract")
    ...
    ((value.url?.value))?.let { encoder.encodeStringElement(__desc, 12, it) }
    ...
    (value.legalState)?.let {
      encoder.encodeSerializableElement(__desc, 18, Hoisted.legalStateSer, it)
    }
    (value.instantiatesCanonical)?.let {
      encoder.encodeSerializableElement(__desc, 19, Hoisted.instantiatesCanonicalSer, it)
    }
    ((value.instantiatesUri?.value))?.let { encoder.encodeStringElement(__desc, 20, it) }
    ...
    (value.contentDerivative)?.let {
      encoder.encodeSerializableElement(__desc, 22, Hoisted.legalStateSer, it)
    }
    ...
    (value.applies)?.let { encoder.encodeSerializableElement(__desc, 25, Hoisted.appliesSer, it) }
    (value.expirationType)?.let {
      encoder.encodeSerializableElement(__desc, 26, Hoisted.legalStateSer, it)
    }
    if (value.subject.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 27, Hoisted.subjectSer, value.subject)
    if (value.authority.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 28, Hoisted.subjectSer, value.authority)
    if (value.domain.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 29, Hoisted.subjectSer, value.domain)
    if (value.site.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 30, Hoisted.subjectSer, value.site)
    ((value.name?.value))?.let { encoder.encodeStringElement(__desc, 31, it) }
    (value.name?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 32, Hoisted.implicitRulesSer, it)
    }
    ((value.title?.value))?.let { encoder.encodeStringElement(__desc, 33, it) }
    (value.title?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 34, Hoisted.implicitRulesSer, it)
    }
    ((value.subtitle?.value))?.let { encoder.encodeStringElement(__desc, 35, it) }
    ...
    (value.alias.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 37, Hoisted.aliasSer, it)
    }
    (value.alias.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 38, Hoisted.aliasSer2, it)
    }
    (value.author)?.let {
      encoder.encodeSerializableElement(__desc, 39, Hoisted.instantiatesCanonicalSer, it)
    }
    (value.scope)?.let { encoder.encodeSerializableElement(__desc, 40, Hoisted.legalStateSer, it) }
    when (val __d = value.topic) {
      null -> {}
      is Contract.Topic.CodeableConcept -> {
        encoder.encodeSerializableElement(__desc, 41, Hoisted.legalStateSer, __d.value)
      }
      is Contract.Topic.Reference -> {
        encoder.encodeSerializableElement(__desc, 42, Hoisted.instantiatesCanonicalSer, __d.value)
      }
    }
    (value.type)?.let { encoder.encodeSerializableElement(__desc, 43, Hoisted.legalStateSer, it) }
    if (value.subType.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 44, Hoisted.subTypeSer, value.subType)
    (value.contentDefinition)?.let {
      encoder.encodeSerializableElement(__desc, 45, Hoisted.contentDefinitionSer, it)
    }
    if (value.term.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 46, Hoisted.termSer, value.term)
    if (value.supportingInfo.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 47, Hoisted.subjectSer, value.supportingInfo)
    if (value.relevantHistory.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 48, Hoisted.subjectSer, value.relevantHistory)
    if (value.signer.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 49, Hoisted.signerSer, value.signer)
    if (value.friendly.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 50, Hoisted.friendlySer, value.friendly)
    if (value.legal.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 51, Hoisted.legalSer, value.legal)
    if (value.rule.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 52, Hoisted.ruleSer, value.rule)
    when (val __d = value.legallyBinding) {
      ...
      is Contract.LegallyBinding.Reference -> {
        encoder.encodeSerializableElement(__desc, 54, Hoisted.instantiatesCanonicalSer, __d.value)
      }
    }
  }
