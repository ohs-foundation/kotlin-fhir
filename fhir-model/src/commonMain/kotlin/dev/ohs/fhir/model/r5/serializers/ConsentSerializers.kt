...
internal object ConsentSerializer : KSerializer<Consent> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Consent") {
      ...
      element("period", Period.serializer().descriptor, isOptional = true)
      element("grantor", listSerialDescriptor(Reference.serializer().descriptor), isOptional = true)
      element("grantee", listSerialDescriptor(Reference.serializer().descriptor), isOptional = true)
      element("manager", listSerialDescriptor(Reference.serializer().descriptor), isOptional = true)
      element(
        "controller",
      ...
      element("decision", String.serializer().descriptor, isOptional = true)
      element("_decision", Element.serializer().descriptor, isOptional = true)
      element(
        "provision",
        listSerialDescriptor(lazyDescriptor { Consent.Provision.serializer().descriptor }),
        isOptional = true,
