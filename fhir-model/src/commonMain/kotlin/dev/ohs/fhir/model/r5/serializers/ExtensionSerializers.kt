  ...
  private fun serializeInternal(encoder: CompositeEncoder, `value`: Extension) {
    ...
    when (val __d = value.`value`) {
      ...
      is Extension.Value.Integer64 -> {
        ((__d.value.value?.toString()))?.let { encoder.encodeStringElement(descriptor, 23, it) }
        (__d.value.toElement())?.let {
      ...
      is Extension.Value.Coding -> {
        encoder.encodeSerializableElement(descriptor, 49, Hoisted.valueCodingSer, __d.value)
      }
      is Extension.Value.ContactPoint -> {
        encoder.encodeSerializableElement(descriptor, 50, Hoisted.valueContactPointSer, __d.value)
      }
      is Extension.Value.Count -> {
        encoder.encodeSerializableElement(descriptor, 51, Hoisted.valueCountSer, __d.value)
      }
      is Extension.Value.Distance -> {
        encoder.encodeSerializableElement(descriptor, 52, Hoisted.valueDistanceSer, __d.value)
      }
      is Extension.Value.Duration -> {
        encoder.encodeSerializableElement(descriptor, 53, Hoisted.valueDurationSer, __d.value)
      }
      is Extension.Value.HumanName -> {
        encoder.encodeSerializableElement(descriptor, 54, Hoisted.valueHumanNameSer, __d.value)
      }
      is Extension.Value.Identifier -> {
        encoder.encodeSerializableElement(descriptor, 55, Hoisted.valueIdentifierSer, __d.value)
      }
      is Extension.Value.Money -> {
        encoder.encodeSerializableElement(descriptor, 56, Hoisted.valueMoneySer, __d.value)
      }
      is Extension.Value.Period -> {
        encoder.encodeSerializableElement(descriptor, 57, Hoisted.valuePeriodSer, __d.value)
      }
      is Extension.Value.Quantity -> {
        encoder.encodeSerializableElement(descriptor, 58, Hoisted.valueQuantitySer, __d.value)
      }
      is Extension.Value.Range -> {
        encoder.encodeSerializableElement(descriptor, 59, Hoisted.valueRangeSer, __d.value)
      }
      is Extension.Value.Ratio -> {
        encoder.encodeSerializableElement(descriptor, 60, Hoisted.valueRatioSer, __d.value)
      }
      is Extension.Value.RatioRange -> {
        encoder.encodeSerializableElement(descriptor, 61, Hoisted.valueRatioRangeSer, __d.value)
      }
      is Extension.Value.Reference -> {
        encoder.encodeSerializableElement(descriptor, 62, Hoisted.valueReferenceSer, __d.value)
      }
      is Extension.Value.SampledData -> {
        encoder.encodeSerializableElement(descriptor, 63, Hoisted.valueSampledDataSer, __d.value)
      }
      is Extension.Value.Signature -> {
        encoder.encodeSerializableElement(descriptor, 64, Hoisted.valueSignatureSer, __d.value)
      }
      is Extension.Value.Timing -> {
        encoder.encodeSerializableElement(descriptor, 65, Hoisted.valueTimingSer, __d.value)
      }
      is Extension.Value.ContactDetail -> {
        encoder.encodeSerializableElement(descriptor, 66, Hoisted.valueContactDetailSer, __d.value)
      }
      ...
      is Extension.Value.Availability -> {
        encoder.encodeSerializableElement(descriptor, 73, Hoisted.valueAvailabilitySer, __d.value)
      }
      ...
      is Extension.Value.Dosage -> {
        encoder.encodeSerializableElement(descriptor, 75, Hoisted.valueDosageSer, __d.value)
      }
      is Extension.Value.Meta -> {
        encoder.encodeSerializableElement(descriptor, 76, Hoisted.valueMetaSer, __d.value)
      }
    }
  }
