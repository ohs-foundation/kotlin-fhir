...
public sealed class GraphDefinitionSearchParam<T> : SearchParam {
  ...
  public data object Context : GraphDefinitionSearchParam<CodeableConcept>() {
  ...
  public data object ContextQuantity : GraphDefinitionSearchParam<Quantity>() {
  ...
  public data object Name : GraphDefinitionSearchParam<R4bString>() {
    ...
    public override fun extract(resource: GraphDefinition): List<R4bString> = listOf(resource.name)
  }

  public data object Publisher : GraphDefinitionSearchParam<R4bString>() {
    ...
    public override fun extract(resource: GraphDefinition): List<R4bString> =
  ...
  public data object Version : GraphDefinitionSearchParam<R4bString>() {
