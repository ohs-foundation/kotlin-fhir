  ...
  private fun deserializeJson(decoder: CompositeDecoder): CareTeam.Participant {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        6 ->
          coveragePeriod =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.coveragePeriodSer, null)
        7 ->
          coverageTiming =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.coverageTimingSer, null)
