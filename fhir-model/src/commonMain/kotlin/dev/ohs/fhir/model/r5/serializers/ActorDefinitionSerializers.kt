...
internal object ActorDefinitionVersionAlgorithmSerializer :
  KSerializer<ActorDefinition.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ActorDefinition.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ActorDefinition.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ActorDefinition.VersionAlgorithm: " + __i
          )
      }
    }
    return ActorDefinition.VersionAlgorithm.from(
...
internal object ActorDefinitionSerializer : KSerializer<ActorDefinition> {
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: ActorDefinition) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "ActorDefinition")
