...
internal object MeasureReportGroupMeasureScoreSerializer :
  KSerializer<MeasureReport.Group.MeasureScore> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MeasureReport.Group.MeasureScore") {
      element("measureScoreQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("measureScoreDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_measureScoreDateTime", Element.serializer().descriptor, isOptional = true)
      element(
  ...
  override fun serialize(encoder: Encoder, `value`: MeasureReport.Group.MeasureScore) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is MeasureReport.Group.MeasureScore.Quantity -> {
          encodeSerializableElement(__desc, 0, Hoisted.measureScoreQuantitySer, __d.value)
        }
        is MeasureReport.Group.MeasureScore.DateTime -> {
        ...
        is MeasureReport.Group.MeasureScore.CodeableConcept -> {
          encodeSerializableElement(__desc, 3, Hoisted.measureScoreCodeableConceptSer, __d.value)
        }
        is MeasureReport.Group.MeasureScore.Period -> {
          encodeSerializableElement(__desc, 4, Hoisted.measureScorePeriodSer, __d.value)
        }
        is MeasureReport.Group.MeasureScore.Range -> {
          encodeSerializableElement(__desc, 5, Hoisted.measureScoreRangeSer, __d.value)
        }
        is MeasureReport.Group.MeasureScore.Duration -> {
          encodeSerializableElement(__desc, 6, Hoisted.measureScoreDurationSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): MeasureReport.Group.MeasureScore {
    val __desc = descriptor
    var measureScoreQuantity: Quantity? = null
    var measureScoreDateTime: KotlinString? = null
    var _measureScoreDateTime: Element? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 -> measureScoreDateTime = decoder.decodeStringElement(__desc, 1)
        2 ->
          _measureScoreDateTime =
        ...
        3 ->
          measureScoreCodeableConcept =
            decoder.decodeNullableSerializableElement(
              __desc,
              3,
              Hoisted.measureScoreCodeableConceptSer,
              null,
            )
        4 ->
          measureScorePeriod =
        ...
        5 ->
          measureScoreRange =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.measureScoreRangeSer, null)
        6 ->
          measureScoreDuration =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MeasureReport.Group.MeasureScore: " + __i
          )
      }
    }
    return MeasureReport.Group.MeasureScore.from(
      measureScoreQuantity,
      DateTime.of(FhirDateTime.fromString(measureScoreDateTime), _measureScoreDateTime),
      measureScoreCodeableConcept,
      measureScorePeriod,
  ...
  private object Hoisted {
    ...
    public val measureScoreCodeableConceptSer: KSerializer<CodeableConcept> =
...
internal object MeasureReportGroupStratifierStratumValueSerializer :
  KSerializer<MeasureReport.Group.Stratifier.Stratum.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MeasureReport.Group.Stratifier.Stratum.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MeasureReport.Group.Stratifier.Stratum.Value: " + __i
          )
      }
    }
    return MeasureReport.Group.Stratifier.Stratum.Value.from(
      valueCodeableConcept,
      R5Boolean.of(valueBoolean, _valueBoolean),
      valueQuantity,
      valueRange,
...
internal object MeasureReportGroupStratifierStratumComponentValueSerializer :
  KSerializer<MeasureReport.Group.Stratifier.Stratum.Component.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MeasureReport.Group.Stratifier.Stratum.Component.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
      element("_valueBoolean", Element.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MeasureReport.Group.Stratifier.Stratum.Component.Value: " +
              __i
          )
      }
    }
    return MeasureReport.Group.Stratifier.Stratum.Component.Value.from(
      valueCodeableConcept,
      R5Boolean.of(valueBoolean, _valueBoolean),
      valueQuantity,
      valueRange,
...
internal object MeasureReportGroupStratifierStratumMeasureScoreSerializer :
  KSerializer<MeasureReport.Group.Stratifier.Stratum.MeasureScore> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MeasureReport.Group.Stratifier.Stratum.MeasureScore") {
      element("measureScoreQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("measureScoreDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_measureScoreDateTime", Element.serializer().descriptor, isOptional = true)
      element(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MeasureReport.Group.Stratifier.Stratum.MeasureScore: " + __i
          )
      }
    }
    return MeasureReport.Group.Stratifier.Stratum.MeasureScore.from(
      measureScoreQuantity,
      DateTime.of(FhirDateTime.fromString(measureScoreDateTime), _measureScoreDateTime),
      measureScoreCodeableConcept,
      measureScorePeriod,
