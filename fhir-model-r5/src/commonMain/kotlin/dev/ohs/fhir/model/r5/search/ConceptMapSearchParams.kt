...
public object ConceptMapSearchParams {
    ...
    SearchParam(
      ...
      extractor = {
        throw NotImplementedError(
          "Search parameter 'context' has expression '(ConceptMap.useContext.value.ofType(CodeableConcept))' which is not yet supported."
        )
      },
    )
  ...
  public val contextQuantity: SearchParam<ConceptMap, Any> =
    SearchParam(
      ...
      extractor = {
        throw NotImplementedError(
          "Search parameter 'context-quantity' has expression '(ConceptMap.useContext.value.ofType(Quantity))' which is not yet supported."
        )
      },
    )
   ...
   * excluded from [all].
   */
  public val unsupported: CollectionsList<SearchParam<ConceptMap, *>> =
