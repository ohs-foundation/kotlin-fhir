...
internal object InventoryItemCharacteristicValueSerializer :
  KSerializer<InventoryItem.Characteristic.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("InventoryItem.Characteristic.Value") {
      element("valueString", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueString", Element.serializer().descriptor, isOptional = true)
      element("valueInteger", Int.serializer().descriptor, isOptional = true)
      element("_valueInteger", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: InventoryItem.Characteristic.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is InventoryItem.Characteristic.Value.Decimal -> {
          ((__d.value.value))?.let {
            encodeSerializableElement(__desc, 4, BigDecimalSerializer, it)
          }
          (__d.value.toElement())?.let {
        ...
        is InventoryItem.Characteristic.Value.Boolean -> {
          ((__d.value.value))?.let { encodeBooleanElement(__desc, 6, it) }
          (__d.value.toElement())?.let {
        ...
        is InventoryItem.Characteristic.Value.Quantity -> {
          encodeSerializableElement(__desc, 12, Hoisted.valueQuantitySer, __d.value)
        }
        is InventoryItem.Characteristic.Value.Range -> {
          encodeSerializableElement(__desc, 13, Hoisted.valueRangeSer, __d.value)
        }
        is InventoryItem.Characteristic.Value.Ratio -> {
          encodeSerializableElement(__desc, 14, Hoisted.valueRatioSer, __d.value)
        }
        is InventoryItem.Characteristic.Value.Annotation -> {
          encodeSerializableElement(__desc, 15, Hoisted.valueAnnotationSer, __d.value)
        }
        is InventoryItem.Characteristic.Value.Address -> {
          encodeSerializableElement(__desc, 16, Hoisted.valueAddressSer, __d.value)
        }
        is InventoryItem.Characteristic.Value.Duration -> {
          encodeSerializableElement(__desc, 17, Hoisted.valueDurationSer, __d.value)
        }
        is InventoryItem.Characteristic.Value.CodeableConcept -> {
          encodeSerializableElement(__desc, 18, Hoisted.valueCodeableConceptSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): InventoryItem.Characteristic.Value {
    val __desc = descriptor
    var valueString: KotlinString? = null
    var _valueString: Element? = null
    var valueInteger: Int? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        8 -> valueUrl = decoder.decodeStringElement(__desc, 8)
        9 ->
          _valueUrl = decoder.decodeNullableSerializableElement(__desc, 9, Hoisted.elementSer, null)
        ...
        13 ->
          valueRange =
            decoder.decodeNullableSerializableElement(__desc, 13, Hoisted.valueRangeSer, null)
        14 ->
          valueRatio =
            decoder.decodeNullableSerializableElement(__desc, 14, Hoisted.valueRatioSer, null)
        15 ->
          valueAnnotation =
            decoder.decodeNullableSerializableElement(__desc, 15, Hoisted.valueAnnotationSer, null)
        16 ->
          valueAddress =
            decoder.decodeNullableSerializableElement(__desc, 16, Hoisted.valueAddressSer, null)
        17 ->
          valueDuration =
            decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.valueDurationSer, null)
        18 ->
          valueCodeableConcept =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding InventoryItem.Characteristic.Value: " + __i
          )
      }
    }
    return InventoryItem.Characteristic.Value.from(
      R5String.of(valueString, _valueString),
      Integer.of(valueInteger, _valueInteger),
      Decimal.of(valueDecimal, _valueDecimal),
      R5Boolean.of(valueBoolean, _valueBoolean),
