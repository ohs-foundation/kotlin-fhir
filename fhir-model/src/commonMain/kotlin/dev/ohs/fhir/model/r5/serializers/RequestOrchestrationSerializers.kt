...
internal object RequestOrchestrationActionRelatedActionOffsetSerializer :
  KSerializer<RequestOrchestration.Action.RelatedAction.Offset> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("RequestOrchestration.Action.RelatedAction.Offset") {
      element("offsetDuration", Duration.serializer().descriptor, isOptional = true)
      element("offsetRange", Range.serializer().descriptor, isOptional = true)
    }
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding RequestOrchestration.Action.RelatedAction.Offset: " + __i
          )
      }
    }
    return RequestOrchestration.Action.RelatedAction.Offset.from(offsetDuration, offsetRange)!!
  }
...
internal object RequestOrchestrationActionTimingSerializer :
  KSerializer<RequestOrchestration.Action.Timing> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("RequestOrchestration.Action.Timing") {
      element("timingDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_timingDateTime", Element.serializer().descriptor, isOptional = true)
      element("timingAge", Age.serializer().descriptor, isOptional = true)
      element("timingPeriod", Period.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): RequestOrchestration.Action.Timing {
    val __desc = descriptor
    var timingDateTime: KotlinString? = null
    var _timingDateTime: Element? = null
    var timingAge: Age? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding RequestOrchestration.Action.Timing: " + __i
          )
      }
    }
    return RequestOrchestration.Action.Timing.from(
      DateTime.of(FhirDateTime.fromString(timingDateTime), _timingDateTime),
      timingAge,
      timingPeriod,
      timingDuration,
...
internal object RequestOrchestrationActionParticipantActorSerializer :
  KSerializer<RequestOrchestration.Action.Participant.Actor> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("RequestOrchestration.Action.Participant.Actor") {
      element("actorCanonical", KotlinString.serializer().descriptor, isOptional = true)
      element("_actorCanonical", Element.serializer().descriptor, isOptional = true)
      element("actorReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: RequestOrchestration.Action.Participant.Actor) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is RequestOrchestration.Action.Participant.Actor.Reference -> {
          encodeSerializableElement(__desc, 2, Hoisted.actorReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> actorCanonical = decoder.decodeStringElement(__desc, 0)
        1 ->
          _actorCanonical =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
          actorReference =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.actorReferenceSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding RequestOrchestration.Action.Participant.Actor: " + __i
          )
      }
    }
    return RequestOrchestration.Action.Participant.Actor.from(
      Canonical.of(actorCanonical, _actorCanonical),
      actorReference,
    )!!
  }
  ...
  private object Hoisted {
    ...
    public val actorReferenceSer: KSerializer<Reference> = Reference.serializer()
  }
}

internal object RequestOrchestrationActionDefinitionSerializer :
  KSerializer<RequestOrchestration.Action.Definition> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("RequestOrchestration.Action.Definition") {
      element("definitionCanonical", KotlinString.serializer().descriptor, isOptional = true)
      element("_definitionCanonical", Element.serializer().descriptor, isOptional = true)
      element("definitionUri", KotlinString.serializer().descriptor, isOptional = true)
      element("_definitionUri", Element.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): RequestOrchestration.Action.Definition {
    val __desc = descriptor
    var definitionCanonical: KotlinString? = null
    var _definitionCanonical: Element? = null
    var definitionUri: KotlinString? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding RequestOrchestration.Action.Definition: " + __i
          )
      }
    }
    return RequestOrchestration.Action.Definition.from(
      Canonical.of(definitionCanonical, _definitionCanonical),
      Uri.of(definitionUri, _definitionUri),
    )!!
  }
...
internal object RequestOrchestrationSerializer : KSerializer<RequestOrchestration> {
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: RequestOrchestration) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "RequestOrchestration")
