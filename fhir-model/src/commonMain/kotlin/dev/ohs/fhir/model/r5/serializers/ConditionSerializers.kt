...
internal object ConditionOnsetSerializer : KSerializer<Condition.Onset> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Condition.Onset") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Condition.Onset {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Condition.Onset: " + __i)
      }
    }
    return Condition.Onset.from(
...
internal object ConditionAbatementSerializer : KSerializer<Condition.Abatement> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Condition.Abatement") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is Condition.Abatement.Age -> {
          encodeSerializableElement(__desc, 2, Hoisted.abatementAgeSer, __d.value)
        }
        is Condition.Abatement.Period -> {
          encodeSerializableElement(__desc, 3, Hoisted.abatementPeriodSer, __d.value)
        }
        is Condition.Abatement.Range -> {
          encodeSerializableElement(__desc, 4, Hoisted.abatementRangeSer, __d.value)
        }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Condition.Abatement {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> abatementDateTime = decoder.decodeStringElement(__desc, 0)
        1 ->
          _abatementDateTime =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
          abatementAge =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.abatementAgeSer, null)
        3 ->
          abatementPeriod =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.abatementPeriodSer, null)
        4 ->
          abatementRange =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.abatementRangeSer, null)
        5 -> abatementString = decoder.decodeStringElement(__desc, 5)
        6 ->
          _abatementString =
            decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.elementSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding Condition.Abatement: " + __i)
      }
    }
    return Condition.Abatement.from(
  ...
  private object Hoisted {
    ...
    public val abatementAgeSer: KSerializer<Age> = Age.serializer()

    public val abatementPeriodSer: KSerializer<Period> = Period.serializer()

    public val abatementRangeSer: KSerializer<Range> = Range.serializer()
  }
}
