...
public object CapabilityStatementSearchParam {
  ...
  public data object Fhirversion : SearchParam<CapabilityStatement, R4bString> {
  ...
  public data object Name : SearchParam<CapabilityStatement, R4bString> {
  ...
  public data object Publisher : SearchParam<CapabilityStatement, R4bString> {
  ...
  public data object Software : SearchParam<CapabilityStatement, R4bString> {
  ...
  public data object Title : SearchParam<CapabilityStatement, R4bString> {
  ...
  public data object Version : SearchParam<CapabilityStatement, R4bString> {
