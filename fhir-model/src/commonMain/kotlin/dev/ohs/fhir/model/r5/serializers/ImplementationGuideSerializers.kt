...
internal object ImplementationGuideVersionAlgorithmSerializer :
  KSerializer<ImplementationGuide.VersionAlgorithm> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ImplementationGuide.VersionAlgorithm") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ImplementationGuide.VersionAlgorithm {
    val __desc = descriptor
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ImplementationGuide.VersionAlgorithm: " + __i
          )
      }
    }
    return ImplementationGuide.VersionAlgorithm.from(
...
internal object ImplementationGuideDefinitionPageSourceSerializer :
  KSerializer<ImplementationGuide.Definition.Page.Source> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ImplementationGuide.Definition.Page.Source") {
      element("sourceUrl", KotlinString.serializer().descriptor, isOptional = true)
      element("_sourceUrl", Element.serializer().descriptor, isOptional = true)
      element("sourceString", KotlinString.serializer().descriptor, isOptional = true)
      element("_sourceString", Element.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> sourceUrl = decoder.decodeStringElement(__desc, 0)
        1 ->
          _sourceUrl =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> sourceString = decoder.decodeStringElement(__desc, 2)
        3 ->
          _sourceString =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        4 -> sourceMarkdown = decoder.decodeStringElement(__desc, 4)
        5 ->
          _sourceMarkdown =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ImplementationGuide.Definition.Page.Source: " + __i
          )
      }
    }
    return ImplementationGuide.Definition.Page.Source.from(
      Url.of(sourceUrl, _sourceUrl),
      R5String.of(sourceString, _sourceString),
      Markdown.of(sourceMarkdown, _sourceMarkdown),
    )!!
