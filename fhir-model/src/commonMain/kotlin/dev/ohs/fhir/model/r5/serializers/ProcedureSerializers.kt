...
internal object ProcedureOccurrenceSerializer : KSerializer<Procedure.Occurrence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Procedure.Occurrence") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is Procedure.Occurrence.Age -> {
          encodeSerializableElement(__desc, 5, Hoisted.occurrenceAgeSer, __d.value)
        }
        is Procedure.Occurrence.Range -> {
          encodeSerializableElement(__desc, 6, Hoisted.occurrenceRangeSer, __d.value)
        }
        is Procedure.Occurrence.Timing -> {
          encodeSerializableElement(__desc, 7, Hoisted.occurrenceTimingSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Procedure.Occurrence {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        3 -> occurrenceString = decoder.decodeStringElement(__desc, 3)
        4 ->
          _occurrenceString =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.elementSer, null)
        5 ->
          occurrenceAge =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.occurrenceAgeSer, null)
        6 ->
          occurrenceRange =
            decoder.decodeNullableSerializableElement(__desc, 6, Hoisted.occurrenceRangeSer, null)
        7 ->
          occurrenceTiming =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.occurrenceTimingSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding Procedure.Occurrence: " + __i)
      }
    }
    return Procedure.Occurrence.from(
...
internal object ProcedureReportedSerializer : KSerializer<Procedure.Reported> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Procedure.Reported") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): Procedure.Reported {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Procedure.Reported: " + __i)
      }
    }
    return Procedure.Reported.from(
