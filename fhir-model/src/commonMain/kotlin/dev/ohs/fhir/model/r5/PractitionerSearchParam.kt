...
public sealed class PractitionerSearchParam<T> : SearchParam {
  ...
  public data object Communication : PractitionerSearchParam<CodeableConcept>() {
    ...
    public override val expression: kotlin.String = "Practitioner.communication.language"
  ...
  public data object DeathDate : PractitionerSearchParam<Any>() {
    ...
    public override val expression: kotlin.String = "(Practitioner.deceased.ofType(dateTime))"
  ...
  public data object QualificationPeriod : PractitionerSearchParam<Period>() {
    public override val paramName: kotlin.String = "qualification-period"

    public override val type: SearchParamType = SearchParamType.fromCode("date")

    public override val expression: kotlin.String = "Practitioner.qualification.period"
