  ...
  private fun deserializeJson(decoder: CompositeDecoder): ClinicalUseDefinition.Contraindication {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        7 ->
          applicability =
            decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.applicabilitySer, null)
        8 ->
          otherTherapy =
            decoder.decodeNullableSerializableElement(__desc, 8, Hoisted.otherTherapySer, null)
  ...
  private fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 ->
          treatment =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.treatmentSer, null)
        CompositeDecoder.DECODE_DONE -> break
  ...
  private fun deserializeJson(decoder: CompositeDecoder): ClinicalUseDefinition.Indication {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        11 ->
          applicability =
            decoder.decodeNullableSerializableElement(__desc, 11, Hoisted.applicabilitySer, null)
        12 ->
          otherTherapy =
            decoder.decodeNullableSerializableElement(__desc, 12, Hoisted.otherTherapySer, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object ClinicalUseDefinitionIndicationDurationSerializer :
  KSerializer<ClinicalUseDefinition.Indication.Duration> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ClinicalUseDefinition.Indication.Duration") {
      element("durationRange", Range.serializer().descriptor, isOptional = true)
      element("durationString", KotlinString.serializer().descriptor, isOptional = true)
      element("_durationString", Element.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: ClinicalUseDefinition.Indication.Duration) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is ClinicalUseDefinition.Indication.Duration.Range -> {
          encodeSerializableElement(__desc, 0, Hoisted.durationRangeSer, __d.value)
        }
        is ClinicalUseDefinition.Indication.Duration.String -> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          durationRange =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.durationRangeSer, null)
        1 -> durationString = decoder.decodeStringElement(__desc, 1)
        2 ->
          _durationString =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ClinicalUseDefinition.Indication.Duration: " + __i
          )
      }
    }
    return ClinicalUseDefinition.Indication.Duration.from(
      durationRange,
      R5String.of(durationString, _durationString),
    )!!
  }
...
internal object ClinicalUseDefinitionInteractionInteractantItemSerializer :
  KSerializer<ClinicalUseDefinition.Interaction.Interactant.Item> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ClinicalUseDefinition.Interaction.Interactant.Item") {
      element("itemReference", Reference.serializer().descriptor, isOptional = true)
      element("itemCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
    }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ClinicalUseDefinition.Interaction.Interactant.Item: " + __i
          )
      }
    }
    return ClinicalUseDefinition.Interaction.Interactant.Item.from(
      itemReference,
      itemCodeableConcept,
    )!!
  }
...
internal object ClinicalUseDefinitionSerializer : KSerializer<ClinicalUseDefinition> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ClinicalUseDefinition {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        21 ->
          library = decoder.decodeNullableSerializableElement(__desc, 21, Hoisted.librarySer, null)
        22 ->
          _library =
            decoder.decodeNullableSerializableElement(__desc, 22, Hoisted.librarySer2, null)
        23 ->
          undesirableEffect =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        24 ->
          warning = decoder.decodeNullableSerializableElement(__desc, 24, Hoisted.warningSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: ClinicalUseDefinition) {
    ...
    (value.library.map { it.value }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 21, Hoisted.librarySer, it)
    }
    (value.library.map { it.toElement() }.takeUnless { it.all { it == null } })?.let {
      encoder.encodeSerializableElement(__desc, 22, Hoisted.librarySer2, it)
    }
    (value.undesirableEffect)?.let {
      encoder.encodeSerializableElement(__desc, 23, Hoisted.undesirableEffectSer, it)
    }
    (value.warning)?.let { encoder.encodeSerializableElement(__desc, 24, Hoisted.warningSer, it) }
  }
