...
internal class PropertyMapper(
   ...
   * (the flat `value` + `_value` pair for a primitive, or `fieldType[x]` arms for a choice). For
   * the data class generated by [ModelFileSpecGenerator] (e.g. `Patient`), use [getClassName].
   *
