    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.DefaultValue.Coding -> {
          encodeSerializableElement(__desc, 43, Hoisted.defaultValueCodingSer, __d.value)
        }
        is ElementDefinition.DefaultValue.ContactPoint -> {
          encodeSerializableElement(__desc, 44, Hoisted.defaultValueContactPointSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Count -> {
          encodeSerializableElement(__desc, 45, Hoisted.defaultValueCountSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Distance -> {
          encodeSerializableElement(__desc, 46, Hoisted.defaultValueDistanceSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Duration -> {
          encodeSerializableElement(__desc, 47, Hoisted.defaultValueDurationSer, __d.value)
        }
        is ElementDefinition.DefaultValue.HumanName -> {
          encodeSerializableElement(__desc, 48, Hoisted.defaultValueHumanNameSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Identifier -> {
          encodeSerializableElement(__desc, 49, Hoisted.defaultValueIdentifierSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Money -> {
          encodeSerializableElement(__desc, 50, Hoisted.defaultValueMoneySer, __d.value)
        }
        is ElementDefinition.DefaultValue.Period -> {
          encodeSerializableElement(__desc, 51, Hoisted.defaultValuePeriodSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Quantity -> {
          encodeSerializableElement(__desc, 52, Hoisted.defaultValueQuantitySer, __d.value)
        }
        is ElementDefinition.DefaultValue.Range -> {
          encodeSerializableElement(__desc, 53, Hoisted.defaultValueRangeSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Ratio -> {
          encodeSerializableElement(__desc, 54, Hoisted.defaultValueRatioSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Reference -> {
          encodeSerializableElement(__desc, 55, Hoisted.defaultValueReferenceSer, __d.value)
        }
        is ElementDefinition.DefaultValue.SampledData -> {
          encodeSerializableElement(__desc, 56, Hoisted.defaultValueSampledDataSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Signature -> {
          encodeSerializableElement(__desc, 57, Hoisted.defaultValueSignatureSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Timing -> {
          encodeSerializableElement(__desc, 58, Hoisted.defaultValueTimingSer, __d.value)
        }
        is ElementDefinition.DefaultValue.ContactDetail -> {
          encodeSerializableElement(__desc, 59, Hoisted.defaultValueContactDetailSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Contributor -> {
          encodeSerializableElement(__desc, 60, Hoisted.defaultValueContributorSer, __d.value)
        }
        is ElementDefinition.DefaultValue.DataRequirement -> {
          encodeSerializableElement(__desc, 61, Hoisted.defaultValueDataRequirementSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Expression -> {
          encodeSerializableElement(__desc, 62, Hoisted.defaultValueExpressionSer, __d.value)
        }
        ...
        is ElementDefinition.DefaultValue.RelatedArtifact -> {
          encodeSerializableElement(__desc, 64, Hoisted.defaultValueRelatedArtifactSer, __d.value)
        }
        is ElementDefinition.DefaultValue.TriggerDefinition -> {
          encodeSerializableElement(__desc, 65, Hoisted.defaultValueTriggerDefinitionSer, __d.value)
        }
        is ElementDefinition.DefaultValue.UsageContext -> {
          encodeSerializableElement(__desc, 66, Hoisted.defaultValueUsageContextSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Dosage -> {
          encodeSerializableElement(__desc, 67, Hoisted.defaultValueDosageSer, __d.value)
        }
        is ElementDefinition.DefaultValue.Meta -> {
          encodeSerializableElement(__desc, 68, Hoisted.defaultValueMetaSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ElementDefinition.DefaultValue {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        68 ->
          defaultValueMeta =
            decoder.decodeNullableSerializableElement(__desc, 68, Hoisted.defaultValueMetaSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.Fixed.Coding -> {
          encodeSerializableElement(__desc, 43, Hoisted.fixedCodingSer, __d.value)
        }
        is ElementDefinition.Fixed.ContactPoint -> {
          encodeSerializableElement(__desc, 44, Hoisted.fixedContactPointSer, __d.value)
        }
        is ElementDefinition.Fixed.Count -> {
          encodeSerializableElement(__desc, 45, Hoisted.fixedCountSer, __d.value)
        }
        is ElementDefinition.Fixed.Distance -> {
          encodeSerializableElement(__desc, 46, Hoisted.fixedDistanceSer, __d.value)
        }
        is ElementDefinition.Fixed.Duration -> {
          encodeSerializableElement(__desc, 47, Hoisted.fixedDurationSer, __d.value)
        }
        is ElementDefinition.Fixed.HumanName -> {
          encodeSerializableElement(__desc, 48, Hoisted.fixedHumanNameSer, __d.value)
        }
        is ElementDefinition.Fixed.Identifier -> {
          encodeSerializableElement(__desc, 49, Hoisted.fixedIdentifierSer, __d.value)
        }
        is ElementDefinition.Fixed.Money -> {
          encodeSerializableElement(__desc, 50, Hoisted.fixedMoneySer, __d.value)
        }
        is ElementDefinition.Fixed.Period -> {
          encodeSerializableElement(__desc, 51, Hoisted.fixedPeriodSer, __d.value)
        }
        is ElementDefinition.Fixed.Quantity -> {
          encodeSerializableElement(__desc, 52, Hoisted.fixedQuantitySer, __d.value)
        }
        is ElementDefinition.Fixed.Range -> {
          encodeSerializableElement(__desc, 53, Hoisted.fixedRangeSer, __d.value)
        }
        is ElementDefinition.Fixed.Ratio -> {
          encodeSerializableElement(__desc, 54, Hoisted.fixedRatioSer, __d.value)
        }
        is ElementDefinition.Fixed.Reference -> {
          encodeSerializableElement(__desc, 55, Hoisted.fixedReferenceSer, __d.value)
        }
        is ElementDefinition.Fixed.SampledData -> {
          encodeSerializableElement(__desc, 56, Hoisted.fixedSampledDataSer, __d.value)
        }
        is ElementDefinition.Fixed.Signature -> {
          encodeSerializableElement(__desc, 57, Hoisted.fixedSignatureSer, __d.value)
        }
        is ElementDefinition.Fixed.Timing -> {
          encodeSerializableElement(__desc, 58, Hoisted.fixedTimingSer, __d.value)
        }
        is ElementDefinition.Fixed.ContactDetail -> {
          encodeSerializableElement(__desc, 59, Hoisted.fixedContactDetailSer, __d.value)
        }
        is ElementDefinition.Fixed.Contributor -> {
          encodeSerializableElement(__desc, 60, Hoisted.fixedContributorSer, __d.value)
        }
        is ElementDefinition.Fixed.DataRequirement -> {
          encodeSerializableElement(__desc, 61, Hoisted.fixedDataRequirementSer, __d.value)
        }
        is ElementDefinition.Fixed.Expression -> {
          encodeSerializableElement(__desc, 62, Hoisted.fixedExpressionSer, __d.value)
        }
        is ElementDefinition.Fixed.ParameterDefinition -> {
          encodeSerializableElement(__desc, 63, Hoisted.fixedParameterDefinitionSer, __d.value)
        }
        is ElementDefinition.Fixed.RelatedArtifact -> {
          encodeSerializableElement(__desc, 64, Hoisted.fixedRelatedArtifactSer, __d.value)
        }
        is ElementDefinition.Fixed.TriggerDefinition -> {
          encodeSerializableElement(__desc, 65, Hoisted.fixedTriggerDefinitionSer, __d.value)
        }
        is ElementDefinition.Fixed.UsageContext -> {
          encodeSerializableElement(__desc, 66, Hoisted.fixedUsageContextSer, __d.value)
        }
        is ElementDefinition.Fixed.Dosage -> {
          encodeSerializableElement(__desc, 67, Hoisted.fixedDosageSer, __d.value)
        }
        is ElementDefinition.Fixed.Meta -> {
          encodeSerializableElement(__desc, 68, Hoisted.fixedMetaSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ElementDefinition.Fixed {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        43 ->
          fixedCoding =
            decoder.decodeNullableSerializableElement(__desc, 43, Hoisted.fixedCodingSer, null)
        44 ->
          fixedContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        45 ->
          fixedCount =
            decoder.decodeNullableSerializableElement(__desc, 45, Hoisted.fixedCountSer, null)
        46 ->
          fixedDistance =
            decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.fixedDistanceSer, null)
        47 ->
          fixedDuration =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.fixedDurationSer, null)
        48 ->
          fixedHumanName =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.fixedHumanNameSer, null)
        49 ->
          fixedIdentifier =
            decoder.decodeNullableSerializableElement(__desc, 49, Hoisted.fixedIdentifierSer, null)
        50 ->
          fixedMoney =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.fixedMoneySer, null)
        51 ->
          fixedPeriod =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.fixedPeriodSer, null)
        52 ->
          fixedQuantity =
            decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.fixedQuantitySer, null)
        53 ->
          fixedRange =
            decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.fixedRangeSer, null)
        54 ->
          fixedRatio =
            decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.fixedRatioSer, null)
        55 ->
          fixedReference =
            decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.fixedReferenceSer, null)
        56 ->
          fixedSampledData =
            decoder.decodeNullableSerializableElement(__desc, 56, Hoisted.fixedSampledDataSer, null)
        57 ->
          fixedSignature =
            decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.fixedSignatureSer, null)
        58 ->
          fixedTiming =
            decoder.decodeNullableSerializableElement(__desc, 58, Hoisted.fixedTimingSer, null)
        59 ->
          fixedContactDetail =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        60 ->
          fixedContributor =
            decoder.decodeNullableSerializableElement(__desc, 60, Hoisted.fixedContributorSer, null)
        61 ->
        ...
        62 ->
          fixedExpression =
            decoder.decodeNullableSerializableElement(__desc, 62, Hoisted.fixedExpressionSer, null)
        63 ->
          fixedParameterDefinition =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        67 ->
          fixedDosage =
            decoder.decodeNullableSerializableElement(__desc, 67, Hoisted.fixedDosageSer, null)
        68 ->
          fixedMeta =
            decoder.decodeNullableSerializableElement(__desc, 68, Hoisted.fixedMetaSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ElementDefinition.Pattern.Coding -> {
          encodeSerializableElement(__desc, 43, Hoisted.patternCodingSer, __d.value)
        }
        is ElementDefinition.Pattern.ContactPoint -> {
          encodeSerializableElement(__desc, 44, Hoisted.patternContactPointSer, __d.value)
        }
        is ElementDefinition.Pattern.Count -> {
          encodeSerializableElement(__desc, 45, Hoisted.patternCountSer, __d.value)
        }
        is ElementDefinition.Pattern.Distance -> {
          encodeSerializableElement(__desc, 46, Hoisted.patternDistanceSer, __d.value)
        }
        is ElementDefinition.Pattern.Duration -> {
          encodeSerializableElement(__desc, 47, Hoisted.patternDurationSer, __d.value)
        }
        is ElementDefinition.Pattern.HumanName -> {
          encodeSerializableElement(__desc, 48, Hoisted.patternHumanNameSer, __d.value)
        }
        is ElementDefinition.Pattern.Identifier -> {
          encodeSerializableElement(__desc, 49, Hoisted.patternIdentifierSer, __d.value)
        }
        is ElementDefinition.Pattern.Money -> {
          encodeSerializableElement(__desc, 50, Hoisted.patternMoneySer, __d.value)
        }
        is ElementDefinition.Pattern.Period -> {
          encodeSerializableElement(__desc, 51, Hoisted.patternPeriodSer, __d.value)
        }
        is ElementDefinition.Pattern.Quantity -> {
          encodeSerializableElement(__desc, 52, Hoisted.patternQuantitySer, __d.value)
        }
        is ElementDefinition.Pattern.Range -> {
          encodeSerializableElement(__desc, 53, Hoisted.patternRangeSer, __d.value)
        }
        is ElementDefinition.Pattern.Ratio -> {
          encodeSerializableElement(__desc, 54, Hoisted.patternRatioSer, __d.value)
        }
        is ElementDefinition.Pattern.Reference -> {
          encodeSerializableElement(__desc, 55, Hoisted.patternReferenceSer, __d.value)
        }
        is ElementDefinition.Pattern.SampledData -> {
          encodeSerializableElement(__desc, 56, Hoisted.patternSampledDataSer, __d.value)
        }
        is ElementDefinition.Pattern.Signature -> {
          encodeSerializableElement(__desc, 57, Hoisted.patternSignatureSer, __d.value)
        }
        is ElementDefinition.Pattern.Timing -> {
          encodeSerializableElement(__desc, 58, Hoisted.patternTimingSer, __d.value)
        }
        is ElementDefinition.Pattern.ContactDetail -> {
          encodeSerializableElement(__desc, 59, Hoisted.patternContactDetailSer, __d.value)
        }
        is ElementDefinition.Pattern.Contributor -> {
          encodeSerializableElement(__desc, 60, Hoisted.patternContributorSer, __d.value)
        }
        is ElementDefinition.Pattern.DataRequirement -> {
          encodeSerializableElement(__desc, 61, Hoisted.patternDataRequirementSer, __d.value)
        }
        is ElementDefinition.Pattern.Expression -> {
          encodeSerializableElement(__desc, 62, Hoisted.patternExpressionSer, __d.value)
        }
        is ElementDefinition.Pattern.ParameterDefinition -> {
          encodeSerializableElement(__desc, 63, Hoisted.patternParameterDefinitionSer, __d.value)
        }
        is ElementDefinition.Pattern.RelatedArtifact -> {
          encodeSerializableElement(__desc, 64, Hoisted.patternRelatedArtifactSer, __d.value)
        }
        is ElementDefinition.Pattern.TriggerDefinition -> {
          encodeSerializableElement(__desc, 65, Hoisted.patternTriggerDefinitionSer, __d.value)
        }
        is ElementDefinition.Pattern.UsageContext -> {
          encodeSerializableElement(__desc, 66, Hoisted.patternUsageContextSer, __d.value)
        }
        is ElementDefinition.Pattern.Dosage -> {
          encodeSerializableElement(__desc, 67, Hoisted.patternDosageSer, __d.value)
        }
        is ElementDefinition.Pattern.Meta -> {
          encodeSerializableElement(__desc, 68, Hoisted.patternMetaSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ElementDefinition.Pattern {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        43 ->
          patternCoding =
            decoder.decodeNullableSerializableElement(__desc, 43, Hoisted.patternCodingSer, null)
        44 ->
          patternContactPoint =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        45 ->
          patternCount =
            decoder.decodeNullableSerializableElement(__desc, 45, Hoisted.patternCountSer, null)
        46 ->
          patternDistance =
            decoder.decodeNullableSerializableElement(__desc, 46, Hoisted.patternDistanceSer, null)
        47 ->
          patternDuration =
            decoder.decodeNullableSerializableElement(__desc, 47, Hoisted.patternDurationSer, null)
        48 ->
          patternHumanName =
            decoder.decodeNullableSerializableElement(__desc, 48, Hoisted.patternHumanNameSer, null)
        49 ->
          patternIdentifier =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        50 ->
          patternMoney =
            decoder.decodeNullableSerializableElement(__desc, 50, Hoisted.patternMoneySer, null)
        51 ->
          patternPeriod =
            decoder.decodeNullableSerializableElement(__desc, 51, Hoisted.patternPeriodSer, null)
        52 ->
          patternQuantity =
            decoder.decodeNullableSerializableElement(__desc, 52, Hoisted.patternQuantitySer, null)
        53 ->
          patternRange =
            decoder.decodeNullableSerializableElement(__desc, 53, Hoisted.patternRangeSer, null)
        54 ->
          patternRatio =
            decoder.decodeNullableSerializableElement(__desc, 54, Hoisted.patternRatioSer, null)
        55 ->
          patternReference =
            decoder.decodeNullableSerializableElement(__desc, 55, Hoisted.patternReferenceSer, null)
        56 ->
          patternSampledData =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        57 ->
          patternSignature =
            decoder.decodeNullableSerializableElement(__desc, 57, Hoisted.patternSignatureSer, null)
        58 ->
          patternTiming =
            decoder.decodeNullableSerializableElement(__desc, 58, Hoisted.patternTimingSer, null)
        59 ->
        ...
        67 ->
          patternDosage =
            decoder.decodeNullableSerializableElement(__desc, 67, Hoisted.patternDosageSer, null)
        68 ->
          patternMeta =
            decoder.decodeNullableSerializableElement(__desc, 68, Hoisted.patternMetaSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
