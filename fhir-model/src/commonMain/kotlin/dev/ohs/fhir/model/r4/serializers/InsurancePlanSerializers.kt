...
internal object InsurancePlanSerializer : KSerializer<InsurancePlan> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("InsurancePlan") {
      ...
      element("ownedBy", Reference.serializer().descriptor, isOptional = true)
      element("administeredBy", Reference.serializer().descriptor, isOptional = true)
      element(
        "coverageArea",
        listSerialDescriptor(Reference.serializer().descriptor),
        isOptional = true,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: InsurancePlan) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "InsurancePlan")
