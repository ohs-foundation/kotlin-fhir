  ...
  private fun deserializeJson(decoder: CompositeDecoder): CoverageEligibilityResponse.Error {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        4 ->
          expression =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.expressionSer, null)
        5 ->
          _expression =
            decoder.decodeNullableSerializableElement(__desc, 5, Hoisted.expressionSer2, null)
        CompositeDecoder.DECODE_DONE -> break
...
internal object CoverageEligibilityResponseEventWhenSerializer :
  KSerializer<CoverageEligibilityResponse.Event.When> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CoverageEligibilityResponse.Event.When") {
      element("whenDateTime", KotlinString.serializer().descriptor, isOptional = true)
      element("_whenDateTime", Element.serializer().descriptor, isOptional = true)
      element("whenPeriod", Period.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CoverageEligibilityResponse.Event.When {
    val __desc = descriptor
    var whenDateTime: KotlinString? = null
    var _whenDateTime: Element? = null
    var whenPeriod: Period? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CoverageEligibilityResponse.Event.When: " + __i
          )
      }
    }
    return CoverageEligibilityResponse.Event.When.from(
      DateTime.of(FhirDateTime.fromString(whenDateTime), _whenDateTime),
      whenPeriod,
    )!!
  }
...
internal object CoverageEligibilityResponseServicedSerializer :
  KSerializer<CoverageEligibilityResponse.Serviced> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CoverageEligibilityResponse.Serviced") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CoverageEligibilityResponse.Serviced {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CoverageEligibilityResponse.Serviced: " + __i
          )
      }
    }
    return CoverageEligibilityResponse.Serviced.from(
...
internal object CoverageEligibilityResponseInsuranceItemBenefitAllowedSerializer :
  KSerializer<CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed") {
      element("allowedUnsignedInt", Int.serializer().descriptor, isOptional = true)
      element("_allowedUnsignedInt", Element.serializer().descriptor, isOptional = true)
      element("allowedString", KotlinString.serializer().descriptor, isOptional = true)
      element("_allowedString", Element.serializer().descriptor, isOptional = true)
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed: " +
              __i
          )
      }
    }
    return CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed.from(
      UnsignedInt.of(allowedUnsignedInt, _allowedUnsignedInt),
      R5String.of(allowedString, _allowedString),
      allowedMoney,
    )!!
...
internal object CoverageEligibilityResponseInsuranceItemBenefitUsedSerializer :
  KSerializer<CoverageEligibilityResponse.Insurance.Item.Benefit.Used> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("CoverageEligibilityResponse.Insurance.Item.Benefit.Used") {
      element("usedUnsignedInt", Int.serializer().descriptor, isOptional = true)
      element("_usedUnsignedInt", Element.serializer().descriptor, isOptional = true)
      element("usedString", KotlinString.serializer().descriptor, isOptional = true)
      element("_usedString", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is CoverageEligibilityResponse.Insurance.Item.Benefit.Used.Money -> {
          encodeSerializableElement(__desc, 4, Hoisted.usedMoneySer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          _usedUnsignedInt =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 -> usedString = decoder.decodeStringElement(__desc, 2)
        3 ->
          _usedString =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.elementSer, null)
        4 ->
          usedMoney =
            decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.usedMoneySer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
            "Unexpected index decoding CoverageEligibilityResponse.Insurance.Item.Benefit.Used: " +
              __i
          )
      }
    }
    return CoverageEligibilityResponse.Insurance.Item.Benefit.Used.from(
      UnsignedInt.of(usedUnsignedInt, _usedUnsignedInt),
      R5String.of(usedString, _usedString),
      usedMoney,
    )!!
...
internal object CoverageEligibilityResponseSerializer : KSerializer<CoverageEligibilityResponse> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): CoverageEligibilityResponse {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        17 -> event = decoder.decodeNullableSerializableElement(__desc, 17, Hoisted.eventSer, null)
        ...
        27 -> disposition = decoder.decodeStringElement(__desc, 27)
        28 ->
          _disposition =
            decoder.decodeNullableSerializableElement(__desc, 28, Hoisted.implicitRulesSer, null)
        29 ->
          insurer = decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.patientSer, null)
        30 ->
          insurance =
            decoder.decodeNullableSerializableElement(__desc, 30, Hoisted.insuranceSer, null)
        31 -> preAuthRef = decoder.decodeStringElement(__desc, 31)
        32 ->
          _preAuthRef =
            decoder.decodeNullableSerializableElement(__desc, 32, Hoisted.implicitRulesSer, null)
        33 -> form = decoder.decodeNullableSerializableElement(__desc, 33, Hoisted.formSer, null)
        34 -> error = decoder.decodeNullableSerializableElement(__desc, 34, Hoisted.errorSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException(
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: CoverageEligibilityResponse) {
    ...
    if (value.event.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 17, Hoisted.eventSer, value.event)
    ...
    ((value.disposition?.value))?.let { encoder.encodeStringElement(__desc, 27, it) }
    (value.disposition?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 28, Hoisted.implicitRulesSer, it)
    }
    (value.insurer)?.let { encoder.encodeSerializableElement(__desc, 29, Hoisted.patientSer, it) }
    if (value.insurance.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 30, Hoisted.insuranceSer, value.insurance)
    ((value.preAuthRef?.value))?.let { encoder.encodeStringElement(__desc, 31, it) }
    (value.preAuthRef?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 32, Hoisted.implicitRulesSer, it)
    }
    (value.form)?.let { encoder.encodeSerializableElement(__desc, 33, Hoisted.formSer, it) }
    if (value.error.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 34, Hoisted.errorSer, value.error)
  }
