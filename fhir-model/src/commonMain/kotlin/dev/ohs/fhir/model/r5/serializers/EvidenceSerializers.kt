  ...
  internal fun deserializeJson(
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        23 -> citeAsMarkdown = decoder.decodeStringElement(__desc, __i)
        24 ->
          _citeAsMarkdown =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        ...
        30 ->
          _date =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        31 -> approvalDate = decoder.decodeStringElement(__desc, __i)
        32 ->
          _approvalDate =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        33 -> lastReviewDate = decoder.decodeStringElement(__desc, __i)
        34 ->
          _lastReviewDate =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        ...
        43 -> purpose = decoder.decodeStringElement(__desc, __i)
        44 ->
          _purpose =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        ...
        50 -> description = decoder.decodeStringElement(__desc, __i)
        51 ->
          _description =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        52 -> assertion = decoder.decodeStringElement(__desc, __i)
        53 ->
          _assertion =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
  ...
  internal fun serializeJson(
    ...
    when (val __d = value.citeAs) {
      ...
      is Evidence.CiteAs.Reference -> {
        encoder.encodeSerializableElement(__desc, 22 + __off, Hoisted.citeAsReferenceSer, __d.value)
      }
      is Evidence.CiteAs.Markdown -> {
        ((__d.value.value))?.let { encoder.encodeStringElement(__desc, 23 + __off, it) }
        (__d.value.toElement())?.let {
    ...
    if (value.author.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 38 + __off, Hoisted.contactSer, value.author)
    if (value.editor.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 39 + __off, Hoisted.contactSer, value.editor)
    if (value.reviewer.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 40 + __off, Hoisted.contactSer, value.reviewer)
    if (value.endorser.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 41 + __off, Hoisted.contactSer, value.endorser)
    if (value.useContext.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 42 + __off, Hoisted.useContextSer, value.useContext)
    ((value.purpose?.value))?.let { encoder.encodeStringElement(__desc, 43 + __off, it) }
    ...
    ((value.description?.value))?.let { encoder.encodeStringElement(__desc, 50 + __off, it) }
    (value.description?.toElement())?.let {
      encoder.encodeSerializableElement(__desc, 51 + __off, Hoisted.implicitRulesSer, it)
    }
    ((value.assertion?.value))?.let { encoder.encodeStringElement(__desc, 52 + __off, it) }
    ...
    (value.synthesisType)?.let {
      encoder.encodeSerializableElement(__desc, 56 + __off, Hoisted.synthesisTypeSer, it)
    }
    ...
    if (value.statistic.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 58 + __off, Hoisted.statisticSer, value.statistic)
    if (value.certainty.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 59 + __off, Hoisted.certaintySer, value.certainty)
  }
