...
internal object LibrarySerializer : KSerializer<Library> {
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        24 ->
          _experimental =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        25 -> type = decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.typeSer, null)
        26 ->
  ...
  internal fun serializeJson(
    ...
    (value.type)?.let { encoder.encodeSerializableElement(__desc, 25 + __off, Hoisted.typeSer, it) }
    ...
    if (value.parameter.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 54 + __off, Hoisted.parameterSer, value.parameter)
    ...
    if (value.content.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 56 + __off, Hoisted.contentSer, value.content)
  }
