...
internal object DateSerializer : KSerializer<Date> {
  ...
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("Date") {
      ...
      element("value", FhirDateSerializer.descriptor)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: Date) {
    encoder.encodeStructure(descriptor) {
      ...
      encodeNullableSerializableElement(descriptor, 2, FhirDateSerializer, value.`value`)
    }
  }
    ...
    decoder.decodeStructure(descriptor) {
      ...
      while (true) {
        when (val index = decodeElementIndex(descriptor)) {
          ...
          2 -> `value` = decodeNullableSerializableElement(descriptor, 2, FhirDateSerializer)
