...
internal object SubstanceDefinitionCharacterizationSerializer :
  ...
  private fun deserializeJson(decoder: CompositeDecoder): SubstanceDefinition.Characterization {
    val __desc = descriptor
    var id: KotlinString? = null
    var extension: List<Extension>? = null
    var modifierExtension: List<Extension>? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        3 ->
          technique =
            decoder.decodeNullableSerializableElement(__desc, 3, Hoisted.techniqueSer, null)
        4 -> form = decoder.decodeNullableSerializableElement(__desc, 4, Hoisted.techniqueSer, null)
        ...
        7 -> `file` = decoder.decodeNullableSerializableElement(__desc, 7, Hoisted.fileSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else -> throw SerializationException("Unexpected index decoding Characterization: " + __i)
      }
    }
  ...
  private fun serializeJson(
    ...
    if (value.modifierExtension.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 2, Hoisted.extensionSer, value.modifierExtension)
    (value.technique)?.let {
      encoder.encodeSerializableElement(__desc, 3, Hoisted.techniqueSer, it)
    }
    (value.form)?.let { encoder.encodeSerializableElement(__desc, 4, Hoisted.techniqueSer, it) }
    ...
    if (value.`file`.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 7, Hoisted.fileSer, value.`file`)
  }
...
internal object SubstanceDefinitionMoietyAmountSerializer :
  KSerializer<SubstanceDefinition.Moiety.Amount> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceDefinition.Moiety.Amount") {
      element("amountQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("amountString", KotlinString.serializer().descriptor, isOptional = true)
      element("_amountString", Element.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubstanceDefinition.Moiety.Amount {
    val __desc = descriptor
    var amountQuantity: Quantity? = null
    var amountString: KotlinString? = null
    var _amountString: Element? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 -> amountString = decoder.decodeStringElement(__desc, 1)
        2 ->
          _amountString =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceDefinition.Moiety.Amount: " + __i
          )
      }
    }
    return SubstanceDefinition.Moiety.Amount.from(
      amountQuantity,
      R5String.of(amountString, _amountString),
    )!!
  }
...
internal object SubstanceDefinitionPropertyValueSerializer :
  KSerializer<SubstanceDefinition.Property.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceDefinition.Property.Value") {
      element("valueCodeableConcept", CodeableConcept.serializer().descriptor, isOptional = true)
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("valueDate", KotlinString.serializer().descriptor, isOptional = true)
      element("_valueDate", Element.serializer().descriptor, isOptional = true)
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubstanceDefinition.Property.Value {
    val __desc = descriptor
    var valueCodeableConcept: CodeableConcept? = null
    var valueQuantity: Quantity? = null
    var valueDate: KotlinString? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceDefinition.Property.Value: " + __i
          )
      }
    }
    return SubstanceDefinition.Property.Value.from(
      valueCodeableConcept,
      valueQuantity,
      Date.of(FhirDate.fromString(valueDate), _valueDate),
      R5Boolean.of(valueBoolean, _valueBoolean),
...
internal object SubstanceDefinitionRelationshipSubstanceDefinitionSerializer :
  KSerializer<SubstanceDefinition.Relationship.SubstanceDefinition> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceDefinition.Relationship.SubstanceDefinition") {
      element("substanceDefinitionReference", Reference.serializer().descriptor, isOptional = true)
      element(
        "substanceDefinitionCodeableConcept",
        CodeableConcept.serializer().descriptor,
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is SubstanceDefinition.Relationship.SubstanceDefinition.Reference -> {
          encodeSerializableElement(__desc, 0, Hoisted.substanceDefinitionReferenceSer, __d.value)
        }
        is SubstanceDefinition.Relationship.SubstanceDefinition.CodeableConcept -> {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceDefinition.Relationship.SubstanceDefinition: " + __i
          )
      }
    }
    return SubstanceDefinition.Relationship.SubstanceDefinition.from(
      substanceDefinitionReference,
      substanceDefinitionCodeableConcept,
    )!!
  }
...
internal object SubstanceDefinitionRelationshipAmountSerializer :
  KSerializer<SubstanceDefinition.Relationship.Amount> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceDefinition.Relationship.Amount") {
      element("amountQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("amountRatio", Ratio.serializer().descriptor, isOptional = true)
      element("amountString", KotlinString.serializer().descriptor, isOptional = true)
      element("_amountString", Element.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: SubstanceDefinition.Relationship.Amount) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is SubstanceDefinition.Relationship.Amount.Ratio -> {
          encodeSerializableElement(__desc, 1, Hoisted.amountRatioSer, __d.value)
        }
        is SubstanceDefinition.Relationship.Amount.String -> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubstanceDefinition.Relationship.Amount {
    val __desc = descriptor
    var amountQuantity: Quantity? = null
    var amountRatio: Ratio? = null
    var amountString: KotlinString? = null
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          amountRatio =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.amountRatioSer, null)
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceDefinition.Relationship.Amount: " + __i
          )
      }
    }
    return SubstanceDefinition.Relationship.Amount.from(
      amountQuantity,
      amountRatio,
      R5String.of(amountString, _amountString),
    )!!
...
internal object SubstanceDefinitionSerializer : KSerializer<SubstanceDefinition> {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubstanceDefinition {
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        25 ->
          characterization =
            decoder.decodeNullableSerializableElement(__desc, 25, Hoisted.characterizationSer, null)
        26 ->
          `property` =
            decoder.decodeNullableSerializableElement(__desc, 26, Hoisted.propertySer, null)
        27 ->
        ...
        28 ->
          molecularWeight =
            decoder.decodeNullableSerializableElement(__desc, 28, Hoisted.molecularWeightSer, null)
        29 ->
          structure =
            decoder.decodeNullableSerializableElement(__desc, 29, Hoisted.structureSer, null)
        30 -> code = decoder.decodeNullableSerializableElement(__desc, 30, Hoisted.codeSer, null)
        31 -> name = decoder.decodeNullableSerializableElement(__desc, 31, Hoisted.nameSer, null)
        32 ->
          relationship =
            decoder.decodeNullableSerializableElement(__desc, 32, Hoisted.relationshipSer, null)
        33 ->
          nucleicAcid =
            decoder.decodeNullableSerializableElement(
              __desc,
        ...
        36 ->
          sourceMaterial =
            decoder.decodeNullableSerializableElement(__desc, 36, Hoisted.sourceMaterialSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: SubstanceDefinition) {
    ...
    if (value.`property`.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 26, Hoisted.propertySer, value.`property`)
    (value.referenceInformation)?.let {
      encoder.encodeSerializableElement(__desc, 27, Hoisted.informationSourceSerInner, it)
    }
    ...
    (value.structure)?.let {
      encoder.encodeSerializableElement(__desc, 29, Hoisted.structureSer, it)
    }
    if (value.code.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 30, Hoisted.codeSer, value.code)
    if (value.name.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 31, Hoisted.nameSer, value.name)
    if (value.relationship.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 32, Hoisted.relationshipSer, value.relationship)
    (value.nucleicAcid)?.let {
      encoder.encodeSerializableElement(__desc, 33, Hoisted.informationSourceSerInner, it)
    }
    (value.polymer)?.let {
      encoder.encodeSerializableElement(__desc, 34, Hoisted.informationSourceSerInner, it)
    }
    (value.protein)?.let {
      encoder.encodeSerializableElement(__desc, 35, Hoisted.informationSourceSerInner, it)
    }
    (value.sourceMaterial)?.let {
      encoder.encodeSerializableElement(__desc, 36, Hoisted.sourceMaterialSer, it)
    }
  }
