...
internal object MedicinalProductSpecialDesignationIndicationSerializer :
  KSerializer<MedicinalProduct.SpecialDesignation.Indication> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicinalProduct.SpecialDesignation.Indication") {
      element(
        "indicationCodeableConcept",
        CodeableConcept.serializer().descriptor,
        isOptional = true,
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding MedicinalProduct.SpecialDesignation.Indication: " + __i
          )
      }
    }
    return MedicinalProduct.SpecialDesignation.Indication.from(
      indicationCodeableConcept,
      indicationReference,
    )!!
  }
...
internal object MedicinalProductSerializer : KSerializer<MedicinalProduct> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("MedicinalProduct") {
      ...
      element("type", CodeableConcept.serializer().descriptor, isOptional = true)
      element("domain", Coding.serializer().descriptor, isOptional = true)
      element(
      ...
      element("paediatricUseIndicator", CodeableConcept.serializer().descriptor, isOptional = true)
      element(
      ...
      element("contact", listSerialDescriptor(Reference.serializer().descriptor), isOptional = true)
      element(
        "clinicalTrial",
        listSerialDescriptor(Reference.serializer().descriptor),
        isOptional = true,
  ...
  private fun serializeJson(encoder: CompositeEncoder, `value`: MedicinalProduct) {
    val __desc = descriptor
    encoder.encodeStringElement(__desc, 0, "MedicinalProduct")
