...
internal object OidSerializer : KSerializer<Oid> {
  ...
  override fun deserialize(decoder: Decoder): Oid =
    decoder.decodeStructure(descriptor) {
      ...
      Oid(id = id, extension = extension, `value` = `value`)
    }
}
