...
public sealed class MedicationAdministrationSearchParam<T> : SearchParam {
  ...
  public data object Encounter : MedicationAdministrationSearchParam<Any>() {
  ...
  public data object PerformerDeviceCode : MedicationAdministrationSearchParam<Any>() {
  ...
  public data object ReasonGivenCode : MedicationAdministrationSearchParam<Any>() {
