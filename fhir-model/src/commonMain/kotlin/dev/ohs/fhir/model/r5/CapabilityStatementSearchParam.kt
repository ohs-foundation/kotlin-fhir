...
public sealed class CapabilityStatementSearchParam<T> : SearchParam {
  ...
  public data object Fhirversion : CapabilityStatementSearchParam<Any>() {
    ...
    public override val expression: String = "CapabilityStatement.fhirVersion"
  ...
  public data object Identifier : CapabilityStatementSearchParam<Any>() {
    public override val paramName: String = "identifier"

    public override val type: SearchParamType = SearchParamType.fromCode("token")

    public override val expression: String = "CapabilityStatement.identifier"
