...
public sealed class ServiceRequestSearchParam<T> : SearchParam {
  ...
  public data object Identifier : ServiceRequestSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
    ...
    public override fun extract(resource: ServiceRequest): List<dev.ohs.fhir.model.r4.Identifier> =
      resource.identifier
  }
  ...
  public data object Requisition : ServiceRequestSearchParam<dev.ohs.fhir.model.r4.Identifier>() {
