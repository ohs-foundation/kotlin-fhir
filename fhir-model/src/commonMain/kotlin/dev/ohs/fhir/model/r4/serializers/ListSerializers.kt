...
internal object ListEntrySerializer : KSerializer<R4List.Entry> {
  ...
  private fun deserializeInternal(decoder: CompositeDecoder): R4List.Entry {
  ...
  private fun serializeInternal(encoder: CompositeEncoder, `value`: R4List.Entry) {
    ...
    (value.item)?.let { encoder.encodeSerializableElement(descriptor, 8, Hoisted.itemSer, it) }
  }
