...
internal object SlotSerializer : KSerializer<Slot> {
  ...
  internal fun serializeInternal(
    ...
    (value.schedule)?.let {
      encoder.encodeSerializableElement(descriptor, 15 + descriptorOffset, Hoisted.scheduleSer, it)
    }
...
internal object SlotPolymorphicSerializer : KSerializer<Slot> {
  ...
  override fun deserialize(decoder: Decoder): Slot =
    decoder.decodeStructure(descriptor) { SlotSerializer.deserializeInternal(this, descriptor, 0) }
}
