...
internal object DeviceDispenseSerializer : KSerializer<DeviceDispense> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      ...
      when (__i - __off) {
        ...
        26 -> preparedDate = decoder.decodeStringElement(__desc, __i)
        27 ->
          _preparedDate =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        28 -> whenHandedOver = decoder.decodeStringElement(__desc, __i)
        29 ->
          _whenHandedOver =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        30 ->
        ...
        32 -> usageInstruction = decoder.decodeStringElement(__desc, __i)
        33 ->
          _usageInstruction =
            decoder.decodeNullableSerializableElement(__desc, __i, Hoisted.implicitRulesSer, null)
        34 ->
  ...
  internal fun serializeJson(
    ...
    (value.device)?.let {
      encoder.encodeSerializableElement(__desc, 17 + __off, Hoisted.statusReasonSer, it)
    }
    (value.subject)?.let {
    ...
    (value.quantity)?.let {
      encoder.encodeSerializableElement(__desc, 25 + __off, Hoisted.quantitySer, it)
    }
    ...
    ((value.usageInstruction?.value))?.let { encoder.encodeStringElement(__desc, 32 + __off, it) }
    ...
    if (value.eventHistory.isNotEmpty())
      encoder.encodeSerializableElement(__desc, 34 + __off, Hoisted.basedOnSer, value.eventHistory)
  }
...
internal object DeviceDispensePolymorphicSerializer : KSerializer<DeviceDispense> {
  ...
  override fun serialize(encoder: Encoder, `value`: DeviceDispense) {
    encoder.encodeStructure(descriptor) {
      DeviceDispenseSerializer.serializeJson(this, descriptor, 0, value)
    }
  }

  override fun deserialize(decoder: Decoder): DeviceDispense =
    decoder.decodeStructure(descriptor) {
      DeviceDispenseSerializer.deserializeJson(this, descriptor, 0)
    }
}
