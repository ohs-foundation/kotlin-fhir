...
internal object SubstanceSpecificationMoietyAmountSerializer :
  KSerializer<SubstanceSpecification.Moiety.Amount> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceSpecification.Moiety.Amount") {
      element("amountQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("amountString", KotlinString.serializer().descriptor, isOptional = true)
      element("_amountString", Element.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubstanceSpecification.Moiety.Amount {
    val __desc = descriptor
    var amountQuantity: Quantity? = null
    var amountString: KotlinString? = null
    var _amountString: Element? = null
      ...
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceSpecification.Moiety.Amount: " + __i
          )
      }
    }
    return SubstanceSpecification.Moiety.Amount.from(
      amountQuantity,
      R4String.of(amountString, _amountString),
    )!!
  }
...
internal object SubstanceSpecificationPropertyDefiningSubstanceSerializer :
  KSerializer<SubstanceSpecification.Property.DefiningSubstance> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceSpecification.Property.DefiningSubstance") {
      element("definingSubstanceReference", Reference.serializer().descriptor, isOptional = true)
      element(
        "definingSubstanceCodeableConcept",
        CodeableConcept.serializer().descriptor,
  ...
  override fun serialize(
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is SubstanceSpecification.Property.DefiningSubstance.Reference -> {
          encodeSerializableElement(__desc, 0, Hoisted.definingSubstanceReferenceSer, __d.value)
        }
        is SubstanceSpecification.Property.DefiningSubstance.CodeableConcept -> {
          encodeSerializableElement(
            __desc,
            1,
            Hoisted.definingSubstanceCodeableConceptSer,
            __d.value,
          )
        }
      }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceSpecification.Property.DefiningSubstance: " + __i
          )
      }
    }
    return SubstanceSpecification.Property.DefiningSubstance.from(
      definingSubstanceReference,
      definingSubstanceCodeableConcept,
    )!!
  }
  ...
  private object Hoisted {
    ...
    public val definingSubstanceCodeableConceptSer: KSerializer<CodeableConcept> =
      CodeableConcept.serializer()
  }
}

internal object SubstanceSpecificationPropertyAmountSerializer :
  KSerializer<SubstanceSpecification.Property.Amount> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceSpecification.Property.Amount") {
      element("amountQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("amountString", KotlinString.serializer().descriptor, isOptional = true)
      element("_amountString", Element.serializer().descriptor, isOptional = true)
    }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): SubstanceSpecification.Property.Amount {
    val __desc = descriptor
    var amountQuantity: Quantity? = null
    var amountString: KotlinString? = null
    var _amountString: Element? = null
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceSpecification.Property.Amount: " + __i
          )
      }
    }
    return SubstanceSpecification.Property.Amount.from(
      amountQuantity,
      R4String.of(amountString, _amountString),
    )!!
  }
...
internal object SubstanceSpecificationRelationshipSubstanceSerializer :
  KSerializer<SubstanceSpecification.Relationship.Substance> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceSpecification.Relationship.Substance") {
      element("substanceReference", Reference.serializer().descriptor, isOptional = true)
      element(
        "substanceCodeableConcept",
        CodeableConcept.serializer().descriptor,
  ...
  override fun serialize(encoder: Encoder, `value`: SubstanceSpecification.Relationship.Substance) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is SubstanceSpecification.Relationship.Substance.Reference -> {
          encodeSerializableElement(__desc, 0, Hoisted.substanceReferenceSer, __d.value)
        }
        is SubstanceSpecification.Relationship.Substance.CodeableConcept -> {
          encodeSerializableElement(__desc, 1, Hoisted.substanceCodeableConceptSer, __d.value)
        }
      }
    }
  }
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceSpecification.Relationship.Substance: " + __i
          )
      }
    }
    return SubstanceSpecification.Relationship.Substance.from(
      substanceReference,
      substanceCodeableConcept,
    )!!
  }
...
internal object SubstanceSpecificationRelationshipAmountSerializer :
  KSerializer<SubstanceSpecification.Relationship.Amount> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("SubstanceSpecification.Relationship.Amount") {
      element("amountQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("amountRange", Range.serializer().descriptor, isOptional = true)
      element("amountRatio", Ratio.serializer().descriptor, isOptional = true)
      element("amountString", KotlinString.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: SubstanceSpecification.Relationship.Amount) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is SubstanceSpecification.Relationship.Amount.Ratio -> {
          encodeSerializableElement(__desc, 2, Hoisted.amountRatioSer, __d.value)
        }
        is SubstanceSpecification.Relationship.Amount.String -> {
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        2 ->
          amountRatio =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.amountRatioSer, null)
        3 -> amountString = decoder.decodeStringElement(__desc, 3)
        4 ->
          _amountString =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding SubstanceSpecification.Relationship.Amount: " + __i
          )
      }
    }
    return SubstanceSpecification.Relationship.Amount.from(
      amountQuantity,
      amountRange,
      amountRatio,
      R4String.of(amountString, _amountString),
