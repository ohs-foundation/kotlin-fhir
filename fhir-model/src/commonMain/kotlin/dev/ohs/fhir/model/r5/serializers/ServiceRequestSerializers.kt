...
internal object ServiceRequestOrderDetailParameterValueSerializer :
  KSerializer<ServiceRequest.OrderDetail.Parameter.Value> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ServiceRequest.OrderDetail.Parameter.Value") {
      element("valueQuantity", Quantity.serializer().descriptor, isOptional = true)
      element("valueRatio", Ratio.serializer().descriptor, isOptional = true)
      element("valueRange", Range.serializer().descriptor, isOptional = true)
      element("valueBoolean", KotlinBoolean.serializer().descriptor, isOptional = true)
  ...
  override fun serialize(encoder: Encoder, `value`: ServiceRequest.OrderDetail.Parameter.Value) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ServiceRequest.OrderDetail.Parameter.Value.Ratio -> {
          encodeSerializableElement(__desc, 1, Hoisted.valueRatioSer, __d.value)
        }
        is ServiceRequest.OrderDetail.Parameter.Value.Range -> {
        ...
        is ServiceRequest.OrderDetail.Parameter.Value.CodeableConcept -> {
          encodeSerializableElement(__desc, 5, Hoisted.valueCodeableConceptSer, __d.value)
        }
        is ServiceRequest.OrderDetail.Parameter.Value.String -> {
        ...
        is ServiceRequest.OrderDetail.Parameter.Value.Period -> {
          encodeSerializableElement(__desc, 8, Hoisted.valuePeriodSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        1 ->
          valueRatio =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.valueRatioSer, null)
        2 ->
          valueRange =
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ServiceRequest.OrderDetail.Parameter.Value: " + __i
          )
      }
    }
    return ServiceRequest.OrderDetail.Parameter.Value.from(
      valueQuantity,
      valueRatio,
      valueRange,
      R5Boolean.of(valueBoolean, _valueBoolean),
...
internal object ServiceRequestQuantitySerializer : KSerializer<ServiceRequest.Quantity> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ServiceRequest.Quantity") {
    ...
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        is ServiceRequest.Quantity.Quantity -> {
          encodeSerializableElement(__desc, 0, Hoisted.quantityQuantitySer, __d.value)
        }
        is ServiceRequest.Quantity.Ratio -> {
          encodeSerializableElement(__desc, 1, Hoisted.quantityRatioSer, __d.value)
        }
        is ServiceRequest.Quantity.Range -> {
          encodeSerializableElement(__desc, 2, Hoisted.quantityRangeSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ServiceRequest.Quantity {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 ->
          quantityQuantity =
            decoder.decodeNullableSerializableElement(__desc, 0, Hoisted.quantityQuantitySer, null)
        1 ->
          quantityRatio =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.quantityRatioSer, null)
        2 ->
          quantityRange =
            decoder.decodeNullableSerializableElement(__desc, 2, Hoisted.quantityRangeSer, null)
        CompositeDecoder.DECODE_DONE -> break
        else ->
          throw SerializationException("Unexpected index decoding ServiceRequest.Quantity: " + __i)
      }
    }
    return ServiceRequest.Quantity.from(quantityQuantity, quantityRatio, quantityRange)!!
  }
...
internal object ServiceRequestOccurrenceSerializer : KSerializer<ServiceRequest.Occurrence> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ServiceRequest.Occurrence") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ServiceRequest.Occurrence {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ServiceRequest.Occurrence: " + __i
          )
      }
    }
    return ServiceRequest.Occurrence.from(
...
internal object ServiceRequestAsNeededSerializer : KSerializer<ServiceRequest.AsNeeded> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ServiceRequest.AsNeeded") {
  ...
  internal fun deserializeJson(decoder: CompositeDecoder): ServiceRequest.AsNeeded {
    val __desc = descriptor
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException("Unexpected index decoding ServiceRequest.AsNeeded: " + __i)
      }
    }
    return ServiceRequest.AsNeeded.from(
...
internal object ServiceRequestPatientInstructionInstructionSerializer :
  KSerializer<ServiceRequest.PatientInstruction.Instruction> {
  override val descriptor: SerialDescriptor =
    buildClassSerialDescriptor("ServiceRequest.PatientInstruction.Instruction") {
      element("instructionMarkdown", KotlinString.serializer().descriptor, isOptional = true)
      element("_instructionMarkdown", Element.serializer().descriptor, isOptional = true)
      element("instructionReference", Reference.serializer().descriptor, isOptional = true)
    }
  ...
  override fun serialize(encoder: Encoder, `value`: ServiceRequest.PatientInstruction.Instruction) {
    encoder.encodeStructure(descriptor) {
      ...
      when (val __d = value) {
        ...
        is ServiceRequest.PatientInstruction.Instruction.Reference -> {
          encodeSerializableElement(__desc, 2, Hoisted.instructionReferenceSer, __d.value)
        }
      }
    }
  }
  ...
  internal fun deserializeJson(
    ...
    while (true) {
      when (val __i = decoder.decodeElementIndex(__desc)) {
        0 -> instructionMarkdown = decoder.decodeStringElement(__desc, 0)
        1 ->
          _instructionMarkdown =
            decoder.decodeNullableSerializableElement(__desc, 1, Hoisted.elementSer, null)
        2 ->
        ...
        CompositeDecoder.DECODE_DONE -> break
          ...
          throw SerializationException(
            "Unexpected index decoding ServiceRequest.PatientInstruction.Instruction: " + __i
          )
      }
    }
    return ServiceRequest.PatientInstruction.Instruction.from(
      Markdown.of(instructionMarkdown, _instructionMarkdown),
      instructionReference,
    )!!
  }
